...
<head>
    ...
    <style>
        * {
        ...
        /* النافبار الموحد - يظهر على الهاتف فقط */
        .navbar-gradient {
        ...
        /* Register Container - شاشة كاملة على الديسكتوب */
        .register-wrapper {
            height: 100vh;
            display: flex;
            width: 100%;
        ...
        /* ─── تصميم الهاتف: نفس تسجيل الدخول بالضبط ─── */
        ...
        .register-mobile-welcome .welcome-icon {
            position: absolute;
            top: 1.25rem;
            left: 1.25rem;
            width: 3rem;
    ...
    <div class="register-wrapper">
        ...
        <div class="register-mobile-wrap">
            <div class="register-mobile-welcome">
                ...
                <p class="welcome-desc">أنشئ حسابك وابدأ رحلتك التعليمية مع Mindlytics ومتابعة كورساتك وإنجازاتك</p>
            </div>
                    ...
                    <form action="{{ route('register') }}" method="POST">
                        ...
                        <div class="input-wrap">
                            ...
                            <div class="relative">
                                ...
                                <button type="button" @click="showPasswordConfirm = !showPasswordConfirm" class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"><i x-show="!showPasswordConfirm" class="fas fa-eye text-sm"></i><i x-show="showPasswordConfirm" class="fas fa-eye-slash text-sm"></i></button>
                            </div>
                        </div>

                        <div class="flex items-start gap-2 mb-4">
                            <input type="checkbox" id="terms_m" required class="mt-0.5 h-4 w-4 text-blue-600 rounded">
                            <label for="terms_m" class="text-xs text-gray-700">أوافق على <a href="#" class="text-blue-600 underline">شروط الاستخدام</a> و <a href="#" class="text-blue-600 underline">سياسة الخصوصية</a></label>
                        </div>
