...
@section('title', 'مؤشرات الشركة (Real‑time)')
...
<div class="p-4 md:p-6 space-y-6" style="background:#f8fafc;min-height:100vh;" x-data="accountingInsights()">
    <div class="flex flex-wrap items-center justify-between gap-3">
        ...
        <div class="flex gap-2">
            <a href="{{ route('admin.accounting.hub') }}" class="px-4 py-2 rounded-xl bg-white border border-gray-200 text-sm font-semibold hover:bg-gray-50">
