...
@section('title', 'تفاصيل مراجعة المسار')
@section('header', 'تفاصيل مراجعة المسار')
...
<div class="space-y-6">
    <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
        <div class="flex justify-between items-start mb-6">
            ...
            <a href="{{ route('admin.learning-path-reviews.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded-lg font-medium transition-colors">
                رجوع
            </a>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <div class="space-y-2 text-sm">
                    <div><span class="text-gray-600">اسم المسار:</span> <span class="font-medium text-gray-900 mr-2">{{ $review->learningPath->name ?? '-' }}</span></div>
                </div>
            </div>
        </div>
        ...
        <div class="border-t border-gray-200 pt-6">
            <form action="{{ route('admin.learning-path-reviews.update', $review) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mb-4">
