                ...
                <div class="xl:col-span-2 space-y-6">
                    <div class="bg-white rounded-3xl shadow-xl border border-gray-100/60 overflow-hidden">
                        ...
                        <div class="p-6 sm:p-8 space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-2">
                                    <label class="block text-sm font-semibold text-gray-700">الفرع</label>
                                    <select name="branch_id"
                                            class="w-full rounded-2xl border border-gray-200 bg-white/70 px-4 py-3 text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition">
                                        <option value="">الافتراضي (حسب إعدادات المنصة)</option>
                                    ...
                                    <p class="text-xs text-gray-500">يحدد ظهور الكورس على النطاق الفرعي أو النطاق المخصص لهذا الفرع.</p>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="number" name="price" id="course_price" value="{{ old('price', 0) }}" min="0" step="0.01"
                                           class="w-full rounded-2xl border border-gray-200 bg-white/70 px-4 py-3 text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="number" name="discount_amount" id="course_discount" value="{{ old('discount_amount', 0) }}" min="0" step="0.01"
                                           class="w-full rounded-2xl border border-gray-200 bg-white/70 px-4 py-3 text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition"
                            ...
                            <div class="md:col-span-2 space-y-2">
                                ...
                                <textarea name="hook" rows="3" maxlength="500"
                                          ...
                                          placeholder="جملة قوية قصيرة تجذب الطالب في أول الصفحة — مش وصف طويل.">{{ old('hook') }}</textarea>
                            ...
                            <div class="md:col-span-2 rounded-2xl border border-indigo-100 bg-indigo-50/40 p-5 space-y-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <textarea name="hook_en" rows="3" maxlength="500" dir="ltr"
                                              class="w-full rounded-2xl border border-gray-200 bg-white px-4 py-3 text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition"
                                              placeholder="Short powerful hook for the hero">{{ old('hook_en') }}</textarea>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <textarea name="description_en" rows="4" dir="ltr"
                                              class="w-full rounded-2xl border border-gray-200 bg-white px-4 py-3 text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition"
                                              placeholder="Course description in English">{{ old('description_en') }}</textarea>
                    ...
                    <div class="bg-white rounded-3xl shadow-xl border border-gray-100/60 overflow-hidden">
                        ...
                        <div class="p-6 sm:p-8 space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <textarea name="what_you_learn" rows="3"
                                              class="w-full rounded-2xl border border-gray-200 bg-white/70 px-4 py-3 text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition"
                                              placeholder="كل نقطة في سطر — المهارات والمخرجات بعد إنهاء الكورس">{{ old('what_you_learn') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="rounded-2xl border border-sky-100 bg-sky-50/50 p-5 space-y-4">
