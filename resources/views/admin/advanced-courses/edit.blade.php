                        ...
                        <div class="p-6 sm:p-8 space-y-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select name="branch_id"
                                        ...
                                        @foreach($branches ?? [] as $branch)
                                            <option value="{{ $branch->id }}" {{ (string) old('branch_id', $advancedCourse->branch_id ?? '') === (string) $branch->id ? 'selected' : '' }}>
                            ...
                            <div class="md:col-span-2 space-y-2">
                                ...
                                <p class="mt-1 text-xs text-gray-500">
                                    يُعرض في صفحة الكورس العامة. مدعوم: YouTube (بما فيها Shorts)، Vimeo، <strong>Bunny</strong> — رابط تضمين <code class="text-xs">mediadelivery.net/embed/...</code> أو رابط تشغيل، أو رابط مباشر لملف <code class="text-xs">.mp4</code> / <code class="text-xs">.m3u8</code> من CDN.
                                </p>
