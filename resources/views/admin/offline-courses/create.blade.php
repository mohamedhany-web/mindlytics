            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="space-y-4">
                    <label class="inline-flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="public_booking_enabled" value="1" {{ old('public_booking_enabled') ? 'checked' : '' }}
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="datetime-local" name="booking_opens_at" value="{{ old('booking_opens_at') }}"
                                   class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">نهاية الحجز</label>
                            <input type="datetime-local" name="booking_closes_at" value="{{ old('booking_closes_at') }}"
                                   class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                        </div>
                    </div>
