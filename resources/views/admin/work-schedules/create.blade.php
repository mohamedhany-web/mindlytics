...
@section('title', 'إضافة موعد عمل')
@section('header', 'إضافة موعد عمل')
...
<div class="space-y-6">
    ...
    <form method="post" action="{{ route('admin.work-schedules.store') }}" class="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
        @csrf
