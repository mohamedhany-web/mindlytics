        ...
        <ul class="space-y-2">
            ...
            <li x-data="{ open: {{ $salesMenuOpen ? 'true' : 'false' }} }">
                ...
                <ul x-show="open" x-transition x-cloak class="admin-sidebar-sub">
                    ...
                    <li>
                        <a href="{{ route('admin.sales.interest-types.index') }}"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white {{ request()->routeIs('admin.sales.interest-types.*') ? 'bg-emerald-600/30 text-white font-semibold border-r-2 border-emerald-400' : '' }}">
                            <i class="fas fa-heart w-4"></i>
                            <span>أنواع الاهتمام</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.sales.specialties.index') }}"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white {{ request()->routeIs('admin.sales.specialties.*') ? 'bg-emerald-600/30 text-white font-semibold border-r-2 border-emerald-400' : '' }}">
                            <i class="fas fa-user-graduate w-4"></i>
                            <span>تخصصات السيلز</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.sales.distribution.index') }}"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white {{ request()->routeIs('admin.sales.distribution.*') ? 'bg-emerald-600/30 text-white font-semibold border-r-2 border-emerald-400' : '' }}">
                            <i class="fas fa-share-alt w-4"></i>
                            <span>لوحة التوزيع</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.sales.org-chart.index') }}"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white {{ request()->routeIs('admin.sales.org-chart.*') ? 'bg-emerald-600/30 text-white font-semibold border-r-2 border-emerald-400' : '' }}">
                            <i class="fas fa-sitemap w-4"></i>
                            <span>هيكل السيلز</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.sales.schedule-calendar.index') }}"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white {{ request()->routeIs('admin.sales.schedule-calendar.*') ? 'bg-emerald-600/30 text-white font-semibold border-r-2 border-emerald-400' : '' }}">
                            <i class="fas fa-calendar-week w-4"></i>
                            <span>تقويم الشيفت</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.sales.shifts.index') }}"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white {{ request()->routeIs('admin.sales.shifts.*') ? 'bg-emerald-600/30 text-white font-semibold border-r-2 border-emerald-400' : '' }}">
                            <i class="fas fa-users-between-lines w-4"></i>
                            <span>شيفتات وقنوات المبيعات</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('admin.sales.sales-teams.index') }}"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white {{ request()->routeIs('admin.sales.sales-teams.*') ? 'bg-emerald-600/30 text-white font-semibold border-r-2 border-emerald-400' : '' }}">
                            <i class="fas fa-users-cog w-4"></i>
                            <span>فرق المبيعات</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.sales.team-daily-reports.index') }}"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white {{ request()->routeIs('admin.sales.team-daily-reports.*') ? 'bg-emerald-600/30 text-white font-semibold border-r-2 border-emerald-400' : '' }}">
                            <i class="fas fa-clipboard-check w-4"></i>
                            <span>تقارير فرق المبيعات</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('admin.sales.day-blocks.index') }}"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white {{ request()->routeIs('admin.sales.day-blocks.*') ? 'bg-emerald-600/30 text-white font-semibold border-r-2 border-emerald-400' : '' }}">
                            <i class="fas fa-clock w-4"></i>
                            <span>جدول يوم السيلز (Blocks)</span>
                        </a>
                    </li>
                    <li>
            ...
            @endphp
            <li x-data="{ open: {{ $whatsappMenuOpen ? 'true' : 'false' }} }" class="relative">
                <button type="button" @click="open = !open" :aria-expanded="open"
                ...
                <a href="{{ route('admin.whatsapp.inbox') }}"
                   ...
                   class="adm-compact-nav hidden items-center justify-center px-3 py-3 rounded-xl transition-all duration-300 {{ request()->routeIs('admin.whatsapp.inbox*') ? 'bg-emerald-600 text-white shadow-lg' : 'text-slate-300 hover:bg-slate-700/50 hover:text-white' }}">
                ...
                <ul x-show="open" x-transition x-cloak class="admin-sidebar-sub">
                    ...
                    <li>
                        <a href="{{ route('admin.whatsapp.excel-campaign') }}"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white {{ request()->routeIs('admin.whatsapp.excel-campaign*') ? 'bg-emerald-600/30 text-white font-semibold border-r-2 border-emerald-400' : '' }}">
                            <i class="fas fa-file-excel w-4"></i>
                            <span>دعوة جروب من Excel</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('admin.whatsapp.reports') }}"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white {{ request()->routeIs('admin.whatsapp.reports') ? 'bg-emerald-600/30 text-white font-semibold border-r-2 border-emerald-400' : '' }}">
            ...
            @endphp
            <li x-data="{ open: {{ $metaSocialMenuOpen ? 'true' : 'false' }} }" class="relative">
                <button type="button" @click="open = !open" :aria-expanded="open"
                        class="adm-full-nav flex items-center justify-between w-full px-4 py-3 rounded-xl hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white group">
                    <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.meta-social.inbox.index') }}"
                   title="محادثات السوشيال"
                   class="adm-compact-nav hidden items-center justify-center px-3 py-3 rounded-xl transition-all duration-300 {{ request()->routeIs('admin.meta-social.inbox.*') ? 'bg-sky-600 text-white shadow-lg' : 'text-slate-300 hover:bg-slate-700/50 hover:text-white' }}">
                    <i class="fab fa-meta w-5"></i>
                </a>
                <ul x-show="open" x-transition x-cloak class="admin-sidebar-sub">
                    <li>
                        <a href="{{ route('admin.meta-social.index') }}"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white {{ request()->routeIs('admin.meta-social.index') ? 'bg-sky-600/30 text-white font-semibold border-r-2 border-sky-400' : '' }}">
                            <i class="fas fa-tachometer-alt w-4"></i>
                    ...
                    <li>
                        <a href="{{ route('admin.meta-social.settings') }}"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white {{ request()->routeIs('admin.meta-social.settings*') ? 'bg-sky-600/30 text-white font-semibold border-r-2 border-sky-400' : '' }}">
                            <i class="fas fa-plug w-4"></i>
                            <span>ربط Meta</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('admin.meta-social.inbox.index') }}"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white {{ request()->routeIs('admin.meta-social.inbox.*') ? 'bg-sky-600/30 text-white font-semibold border-r-2 border-sky-400' : '' }}">
                            <i class="fas fa-inbox w-4"></i>
            ...
            <li x-data="{ open: {{ $systemManagementOpen ? 'true' : 'false' }} }">
                ...
                <ul x-show="open" x-transition x-cloak class="admin-sidebar-sub">
                    ...
                    <li>
                        <a href="{{ route('admin.platform-errors.index') }}" 
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white {{ request()->routeIs('admin.platform-errors.*') ? 'bg-rose-600/30 text-white font-semibold shadow-md border-r-2 border-rose-400' : '' }}">
            ...
            <li x-data="{ open: {{ $marketingOpen ? 'true' : 'false' }} }">
                ...
                <ul x-show="open" x-transition x-cloak class="admin-sidebar-sub">
                    <li>
                        <a href="{{ route('admin.marketing-regions.index') }}"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white {{ request()->routeIs('admin.marketing-regions.*') ? 'bg-blue-600/30 text-white font-semibold shadow-md border-r-2 border-blue-500' : '' }}">
                            <i class="fas fa-globe-africa w-4"></i>
                            <span>المناطق / الخريطة</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('admin.marketing-course-reviews.index') }}"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white {{ request()->routeIs('admin.marketing-course-reviews.*') ? 'bg-blue-600/30 text-white font-semibold shadow-md border-r-2 border-blue-500' : '' }}">
                            <i class="fas fa-comments w-4"></i>
                            <span>ريفيوهات الكورسات</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.marketing-customer-surveys.index') }}"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white {{ request()->routeIs('admin.marketing-customer-surveys.*') ? 'bg-blue-600/30 text-white font-semibold shadow-md border-r-2 border-blue-500' : '' }}">
                            <i class="fas fa-clipboard-question w-4"></i>
                            <span>استبيان العملاء</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('admin.referral-programs.index') }}" 
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white {{ request()->routeIs('admin.referral-programs.*') || request()->routeIs('admin.workshop-promo-codes.*') ? 'bg-blue-600/30 text-white font-semibold shadow-md border-r-2 border-blue-500' : '' }}">
            ...
            <li x-data="{ open: {{ $contentManagementOpen ? 'true' : 'false' }} }">
                ...
                <ul x-show="open" x-transition x-cloak class="admin-sidebar-sub">
                    ...
                    <li>
                        <a href="{{ route('admin.sales-diploma-board.index') }}"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white {{ request()->routeIs('admin.sales-diploma-board.*') ? 'bg-emerald-600/30 text-white font-semibold shadow-md border-r-2 border-emerald-500' : '' }}">
                            <i class="fas fa-graduation-cap w-4"></i>
                            <span>توصيف الدبلومات</span>
                        </a>
                    </li>
                    <li>
            ...
            <li x-data="{ open: {{ $employeesOpen ? 'true' : 'false' }} }">
                ...
                <ul x-show="open" x-transition x-cloak class="admin-sidebar-sub">
                    ...
                    <li>
                        <a href="{{ route('admin.montage-requests.index') }}"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white {{ request()->routeIs('admin.montage-requests.*') ? 'bg-cyan-600/30 text-white font-semibold border-r-2 border-cyan-400' : '' }}">
                            <i class="fas fa-film w-4"></i>
                            <span>طلبات محرر الفيديو</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.media.org-chart.index') }}"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white {{ request()->routeIs('admin.media.org-chart.*') ? 'bg-cyan-600/30 text-white font-semibold border-r-2 border-cyan-400' : '' }}">
                            <i class="fas fa-sitemap w-4"></i>
                            <span>هيكل قسم الميديا</span>
                        </a>
                    </li>
                    <li>
