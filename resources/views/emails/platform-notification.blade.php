    ...
    <div style="max-width:640px;margin:0 auto;padding:24px;">
        <div style="background:#ffffff;border:1px solid #e5e7eb;border-radius:16px;overflow:hidden;">
            <div style="padding:18px 20px;background:linear-gradient(135deg,#0ea5e9,#2563eb);color:#fff;">
                <div style="font-size:16px;font-weight:700;line-height:1.4;">{{ $titleText }}</div>
            </div>
            <div style="padding:18px 20px;color:#111827;">
                <div style="font-size:14px;line-height:1.8;white-space:pre-wrap;">{{ $messageText }}</div>
                ...
                <div style="margin-top:18px;color:#6b7280;font-size:12px;line-height:1.6;">
                    تم إرسال هذه الرسالة تلقائياً من منصة {{ config('app.name', 'Mindlytics') }}.
                </div>
            </div>
        </div>
    </div>
