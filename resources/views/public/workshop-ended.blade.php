...
<head>
    ...
    <title>انتهت الورشة — {{ $workshop->title }} | Mindlytics</title>
...
<body class="bg-gradient-to-b from-slate-900 via-slate-950 to-slate-900 min-h-screen flex items-center justify-center px-4 py-12">
    <div class="max-w-lg w-full text-center">
        ...
        <a href="{{ url('/') }}" class="inline-flex items-center gap-2 rounded-xl bg-slate-800 hover:bg-slate-700 border border-slate-600 px-6 py-3 text-sm font-semibold text-white transition-colors">
