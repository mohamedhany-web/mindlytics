...
<head>
    ...
    <title>حجز مجموعة أوفلاين — {{ $group->name }} | Mindlytics</title>
                    ...
                    <div class="lg:col-span-2">
                        <div class="course-card p-6 md:p-8">
                            ...
                            @else
                                ...
                                <form action="{{ route('public.offline-groups.book', $group->public_slug) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                                    @csrf
                                    <div>
