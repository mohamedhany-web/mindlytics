...
<div class="p-4 sm:p-6 lg:p-8 space-y-6">
    ...
    <section id="shift" class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 sm:p-6 space-y-4 scroll-mt-4">
        ...
        <div class="rounded-xl border border-violet-200 bg-violet-50/70 p-4 text-sm text-violet-950 space-y-2">
            <p class="font-bold">الحضور: أونلاين / أوفلاين / Hybrid</p>
            <ul class="list-disc list-inside space-y-1 text-violet-900/90">
                ...
                <li><strong>أوفلاين:</strong> لازم تكون في المكتب → «طلب إذن الحضور» → موافقة المدير.</li>
                <li><strong>Hybrid:</strong> بعض الأيام أوفلاين (موافقة مدير) وبعضها أونلاين — حسب جدولك في الأدمن.</li>
                <li>قد يختلف ميعاد الحضور/الانصراف من يوم ليوم حسب الجدول الأسبوعي.</li>
            </ul>
        </div>
    </section>
