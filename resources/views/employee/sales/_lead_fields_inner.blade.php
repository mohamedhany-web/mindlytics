...
<div>
    ...
    @if($lead ?? null)
        ...
        <p class="text-xs text-amber-700 mt-1">تغيير المرحلة من نموذج Pipeline فقط (خطوة بخطوة + ملاحظات).</p>
    @endif
...
<div>
    <label class="block text-sm font-medium text-gray-700 mb-1">متابعة تالية <span class="text-red-500">*</span></label>
...
<div>
    <label class="block text-sm font-medium text-gray-700 mb-1">الإجراء التالي (Next Action) <span class="text-red-500">*</span></label>
    <select name="follow_up_channel" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500">
    ...
    <p class="text-xs text-gray-500 mt-1">إلزامي لأي Lead مفتوح. عند الخسارة/الإغلاق غير مطلوب.</p>
</div>
<div>
