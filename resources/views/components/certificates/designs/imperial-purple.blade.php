{{-- Auto-generated from certification/08-imperial-purple.html — do not edit by hand lightly --}}
@php
...
<link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,600;0,700;0,800;1,600;1,700&family=Cormorant+Garamond:ital,wght@0,400;0,600;1,400&family=Great+Vibes&display=swap" rel="stylesheet">
<style>
:root{
  --display:"Playfair Display",Georgia,serif; --body:"Cormorant Garamond",Georgia,serif; --script:"Great Vibes",cursive;
  --page-bg:linear-gradient(140deg,#3d1a63 0%,#26103f 58%,#4a2072 100%); --panel-bg:linear-gradient(180deg,#fffdfa,#f4eefa); --panel-inset:32px;
  --content-pad:54px 100px 34px;
  --ink:#37175c; --muted:#5c3d82; --accent:#c9a227; --accent-2:#f6e39a;
  --title-color:#37175c; --title-size:62px; --title-weight:800;
  --title-tracking:.155em;
  --name-font:"Playfair Display",Georgia,serif; --name-color:#37175c; --name-size:70px;
  ...
  --script-size:46px; --sign-color:#37175c;
...
<div class="cert-shell" dir="ltr" lang="en">
  ...
  <svg class="ornaments" viewBox="0 0 1122 793" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
      ...
      <g id="c"><path d="M 44 330 C 44 140 140 44 330 44 C 210 74 128 150 108 330 Z" fill="url(#oA)"/><path d="M 92 300 C 96 190 176 108 292 96 C 214 132 152 196 136 300 Z" fill="url(#oB)" opacity=".85"/><circle cx="356" cy="66" r="9" fill="var(--orn-2)"/><circle cx="66" cy="356" r="9" fill="var(--orn-2)"/><path d="M 384 40 C 300 40 240 96 232 176" fill="none" stroke="var(--orn-2)" stroke-width="2.4"/></g>
    </defs>
