{{-- Auto-generated from certification/05-midnight-champagne.html — do not edit by hand lightly --}}
@php
...
:root{
  ...
  --page-bg:radial-gradient(ellipse at 50% 30%,#22262e 0%,#12151a 62%,#0a0c10 100%); --panel-bg:transparent; --panel-inset:0px;
  --content-pad:80px 120px 56px;
  --ink:#efe6d2; --muted:#bdb49f; --accent:#e2cd93; --accent-2:#fff6dd;
  --title-color:#f4e9cf; --title-size:60px; --title-weight:800;
  --title-tracking:.155em;
  --name-font:"Playfair Display",Georgia,serif; --name-color:#f6e3ab; --name-size:72px;
  --name-weight:700; --name-tracking:0;
  --rule-bg:linear-gradient(90deg,transparent,#e2cd93,transparent); --rule-w:912px; --dot:radial-gradient(circle at 35% 30%,#fff3cc,#a98f4a); --dot-show:block;
  --ribbon-w:470px; --ribbon-h:60px; --ribbon-bg:linear-gradient(100deg,#5d4c26,#e2cd93 35%,#c9ac66 55%,#f3e6bd 80%,#5d4c26);
  ...
  --eyebrow-size:35px; --eyebrow-color:#1b1710;
  --eyebrow-tracking:.01em; --eyebrow-shadow:0 1px 2px rgba(80,58,8,.5);
  --script-size:44px; --sign-color:#efe6d2;
  --orn-1:#7a6432; --orn-2:#e2cd93; --orn-3:#fff6dd;
  --seal-1:#7a6432; --seal-2:#d8c185; --seal-3:#fff6dd;
}
