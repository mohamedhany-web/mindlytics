{{-- Auto-generated from certification/03-burgundy-academy.html — do not edit by hand lightly --}}
@php
...
<link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,600;0,700;1,600&family=EB+Garamond:ital,wght@0,400;0,600;0,700;1,400&family=Mrs+Saint+Delafield&display=swap" rel="stylesheet">
<style>
:root{
  --display:"Cormorant Garamond",Georgia,serif; --body:"EB Garamond",Georgia,serif; --script:"Mrs Saint Delafield",cursive;
  --page-bg:linear-gradient(140deg,#6b1230 0%,#4d0c22 60%,#75142f 100%); --panel-bg:linear-gradient(180deg,#fffdf8,#f6efe6); --panel-inset:34px;
  --content-pad:60px 110px 34px;
  --ink:#5a1128; --muted:#7a3348; --accent:#d8a06a; --accent-2:#f7ddc2;
  --title-color:#5a1128; --title-size:66px; --title-weight:800;
  --title-tracking:.155em;
  --name-font:"Cormorant Garamond",Georgia,serif; --name-color:#5a1128; --name-size:74px;
  --name-weight:700; --name-tracking:0;
  --rule-bg:linear-gradient(90deg,#b8794a,#e6bb8d,#b8794a); --rule-w:912px; --dot:radial-gradient(circle at 35% 30%,#f2cfa8,#a86a3c); --dot-show:block;
  --ribbon-w:470px; --ribbon-h:60px; --ribbon-bg:linear-gradient(100deg,#8a4a2a,#e6bb8d 30%,#d18a55 55%,#f0cfae 78%,#8a4a2a);
  ...
  --script-size:52px; --sign-color:#5a1128;
  --orn-1:#8a5a34; --orn-2:#d8a06a; --orn-3:#f7ddc2;
  --seal-1:#8a4a2a; --seal-2:#d59a68; --seal-3:#fbe6d2;
}
...
<div class="cert-shell" dir="ltr" lang="en">
  ...
  <svg class="ornaments" viewBox="0 0 1122 793" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <rect x="30" y="30" width="1062" height="733" fill="none" stroke="var(--orn-2)" stroke-width="2.5"/><rect x="46" y="46" width="1030" height="701" fill="none" stroke="var(--orn-1)" stroke-width="6" opacity=".9"/><rect x="62" y="62" width="998" height="669" fill="none" stroke="var(--orn-2)" stroke-width="1.2"/><path d="M 64.4 27.6 L 56.0 46.0 L 64.4 64.4 L 46.0 56.0 L 27.6 64.4 L 36.0 46.0 L 27.6 27.6 L 46.0 36.0 Z" fill="url(#oA)"/> <path d="M 1094.4 27.6 L 1086.0 46.0 L 1094.4 64.4 L 1076.0 56.0 L 1057.6 64.4 L 1066.0 46.0 L 1057.6 27.6 L 1076.0 36.0 Z" fill="url(#oA)"/> <path d="M 64.4 728.6 L 56.0 747.0 L 64.4 765.4 L 46.0 757.0 L 27.6 765.4 L 36.0 747.0 L 27.6 728.6 L 46.0 737.0 Z" fill="url(#oA)"/> <path d="M 1094.4 728.6 L 1086.0 747.0 L 1094.4 765.4 L 1076.0 757.0 L 1057.6 765.4 L 1066.0 747.0 L 1057.6 728.6 L 1076.0 737.0 Z" fill="url(#oA)"/>
  </svg>
