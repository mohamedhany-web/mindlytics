{{-- Auto-generated from certification/04-ivory-minimal.html — do not edit by hand lightly --}}
@php
...
<link href="https://fonts.googleapis.com/css2?family=Marcellus&family=Josefin+Sans:wght@300;400;600&family=Sacramento&display=swap" rel="stylesheet">
<style>
:root{
  --display:"Marcellus",Georgia,serif; --body:"Josefin Sans",system-ui,sans-serif; --script:"Sacramento",cursive;
  --page-bg:#f3f1ea; --panel-bg:transparent; --panel-inset:0px;
  --content-pad:86px 130px 60px;
  --ink:#22262b; --muted:#5c6169; --accent:#a89563; --accent-2:#e6dcc0;
  --title-color:#22262b; --title-size:50px; --title-weight:400;
  --title-tracking:.38em;
  --name-font:"Marcellus",Georgia,serif; --name-color:#22262b; --name-size:66px;
  --name-weight:400; --name-tracking:.01em;
  --rule-bg:linear-gradient(90deg,transparent,#2a2f35,transparent); --rule-w:620px; --dot:#2a2f35; --dot-show:none;
  --ribbon-w:auto; --ribbon-h:auto; --ribbon-bg:transparent;
  --ribbon-clip:none; --ribbon-border:none; --ribbon-shadow:none;
  --eyebrow-font:"Josefin Sans",sans-serif; --eyebrow-style:normal; --eyebrow-weight:400;
  --eyebrow-size:19px; --eyebrow-color:#8a7a4e;
  --eyebrow-tracking:.42em; --eyebrow-shadow:none;
  --script-size:44px; --sign-color:#22262b;
  --orn-1:#c8b98c; --orn-2:#a89563; --orn-3:#e6dcc0;
  --seal-1:#8a7a4e; --seal-2:#c8b98c; --seal-3:#efe7cf;
}
...
.eyebrow span{text-transform:uppercase}.panel::after{display:none}.eyebrow{margin-top:18px;padding:9px 0}
...
<div class="cert-shell" dir="ltr" lang="en">
  ...
  <svg class="ornaments" viewBox="0 0 1122 793" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <rect x="52" y="52" width="1018" height="689" fill="none" stroke="var(--orn-2)" stroke-width="1.4"/><rect x="52" y="52" width="120" height="10" fill="var(--orn-2)"/><rect x="52" y="52" width="10" height="120" fill="var(--orn-2)"/><rect x="950" y="731" width="120" height="10" fill="var(--orn-2)"/><rect x="1060" y="621" width="10" height="120" fill="var(--orn-2)"/>
  </svg>
