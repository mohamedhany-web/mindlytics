{{-- Auto-generated from certification/10-mindlytics-modern.html — do not edit by hand lightly --}}
@php
...
<link href="https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,500;9..144,700&family=Karla:wght@400;500;700&family=Sacramento&display=swap" rel="stylesheet">
<style>
:root{
  --display:"Fraunces",Georgia,serif; --body:"Karla",system-ui,sans-serif; --script:"Sacramento",cursive;
  --page-bg:#ffffff; --panel-bg:transparent; --panel-inset:0px;
  --content-pad:70px 96px 50px 300px;
  --ink:#10312a; --muted:#4a6560; --accent:#0b6d4e; --accent-2:#8fd0b4;
  --title-color:#0b6d4e; --title-size:46px; --title-weight:700;
  --title-tracking:.2em;
  --name-font:"Fraunces",Georgia,serif; --name-color:#10312a; --name-size:62px;
  --name-weight:700; --name-tracking:0;
  --rule-bg:linear-gradient(90deg,#0b6d4e,#8fd0b4,transparent); --rule-w:720px; --dot:#0b6d4e; --dot-show:none;
  --ribbon-w:360px; --ribbon-h:50px; --ribbon-bg:linear-gradient(100deg,#0b6d4e,#12996d);
  --ribbon-clip:none; --ribbon-border:none; --ribbon-shadow:0 6px 16px rgba(11,109,78,.25);
  --eyebrow-font:"Karla",sans-serif; --eyebrow-style:normal; --eyebrow-weight:700;
  --eyebrow-size:20px; --eyebrow-color:#fff;
  --eyebrow-tracking:.2em; --eyebrow-shadow:none;
  --script-size:44px; --sign-color:#10312a;
  --orn-1:#0b6d4e; --orn-2:#12996d; --orn-3:#8fd0b4;
  --seal-1:#0b6d4e; --seal-2:#37b189; --seal-3:#d8f2e6;
}
...
.content{align-items:flex-start;text-align:left}.title{text-transform:uppercase}.eyebrow span{text-transform:uppercase}.rule{margin-left:0}.footer{grid-template-columns:1fr 220px 1fr}.panel::after{display:none}
...
<div class="cert-shell" dir="ltr" lang="en">
  ...
  <svg class="ornaments" viewBox="0 0 1122 793" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <path d="M 0 0 L 168 0 L 216 396 L 168 793 L 0 793 Z" fill="url(#oA)"/><path d="M 0 0 L 42 0 L 82 396 L 42 793 L 0 793 Z" fill="var(--orn-2)" opacity=".35"/><rect x="1064" y="60" width="4" height="673" fill="var(--orn-2)" opacity=".6"/>
  </svg>
