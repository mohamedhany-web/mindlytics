        ...
        <div class="mb-6">
            <div class="text-center mb-4">
                <span class="text-sm text-slate-500">
                    بطاقة <span x-text="currentIndex + 1"></span> من <?php echo e(count($flashcards)); ?>
            ...
            <div class="flex items-center justify-center gap-4">
                ...
                <button @click="nextCard()" 
                        :disabled="currentIndex >= <?php echo e(count($flashcards) - 1); ?>"
                        class="px-4 py-2 bg-slate-200 hover:bg-slate-300 disabled:opacity-50 text-slate-700 rounded-xl font-semibold transition-colors">
...
function flashcardsHandler() {
    return {
        currentIndex: 0,
        isFlipped: false,
        flashcards: <?php echo json_encode($flashcards, 15, 512) ?>,
...
<?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/student/learning-patterns/types/flashcards.blade.php ENDPATH**/ ?>