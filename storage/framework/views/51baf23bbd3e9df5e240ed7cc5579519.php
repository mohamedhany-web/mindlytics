<div class="bg-white rounded-2xl border-2 border-gray-200 p-6 shadow-lg" 
    ...
    <?php if(isset($pattern->pattern_data['problem_description'])): ?>
        <div class="mb-6">
            ...
            <div class="bg-gray-50 rounded-xl p-4 whitespace-pre-wrap"><?php echo e($pattern->pattern_data['problem_description']); ?></div>
        </div>
    <?php endif; ?>
    
    <?php if(isset($pattern->pattern_data['input_example'])): ?>
        <div class="mb-6">
            <h4 class="font-bold text-[#1C2C39] mb-2">مثال الإدخال</h4>
            <div class="bg-gray-50 rounded-xl p-4 font-mono text-sm"><?php echo e($pattern->pattern_data['input_example']); ?></div>
        </div>
    <?php endif; ?>
    
    <?php if(isset($pattern->pattern_data['output_example'])): ?>
        <div class="mb-6">
            <h4 class="font-bold text-[#1C2C39] mb-2">مثال الإخراج المتوقع</h4>
            <div class="bg-gray-50 rounded-xl p-4 font-mono text-sm"><?php echo e($pattern->pattern_data['output_example']); ?></div>
        </div>
    <?php endif; ?>
    ...
    <?php if(isset($pattern->pattern_data['starter_code'])): ?>
        <div class="mt-4">
...
function codeChallengeHandler() {
    return {
        ...
        loadStarterCode() {
            <?php if(isset($pattern->pattern_data['starter_code'])): ?>
                this.attemptData.code = <?php echo json_encode($pattern->pattern_data['starter_code'], 15, 512) ?>;
            <?php endif; ?>
        }
    };
}
</script>
<?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/student/learning-patterns/types/code_challenge.blade.php ENDPATH**/ ?>