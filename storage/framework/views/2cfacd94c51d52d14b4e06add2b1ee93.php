...
<section class="rounded-xl border border-emerald-200 bg-gradient-to-br from-emerald-50/80 to-white p-4 sm:p-5 space-y-4 h-full">
    <div class="flex flex-wrap items-start justify-between gap-3">
        ...
        <?php if($waConfigured): ?>
            ...
            <?php else: ?>
                <span class="text-[10px] px-2 py-1 rounded-full bg-rose-100 text-rose-800 font-bold"><?php echo e($waConnectionMeta['label'] ?? 'غير متصل'); ?></span>
            <?php endif; ?>
        <?php else: ?>
    ...
    <?php if(!$waConfigured): ?>
        <p class="text-xs text-rose-700 bg-rose-50 border border-rose-200 rounded-lg px-3 py-2">
            ...
            <a href="<?php echo e(route('admin.whatsapp.settings')); ?>" class="font-bold underline">ربط Meta WhatsApp</a>
    ...
    <?php elseif(!$waCanSend): ?>
        <div class="text-xs text-rose-800 bg-rose-50 border border-rose-200 rounded-lg px-3 py-2 space-y-2">
            <p>
                <strong>يجب ربط WhatsApp Business أولاً</strong> — <?php echo e($waConnectionMeta['label'] ?? 'غير متصل'); ?>
