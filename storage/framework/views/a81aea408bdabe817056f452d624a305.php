...
<div class="w-full max-w-full space-y-6">
    <nav class="flex flex-wrap items-center gap-x-2 gap-y-1 text-sm text-slate-500" aria-label="مسار التنقل">
        <a href="<?php echo e(route('dashboard')); ?>" class="hover:text-teal-700 font-medium">لوحة التحكم</a>
        <span class="text-slate-300" aria-hidden="true">/</span>
        <a href="<?php echo e(route($sg . '.index')); ?>" class="hover:text-teal-700 font-medium"><?php echo e(($channel ?? 'offline') === 'online' ? 'كورساتي الأونلاين' : 'كورساتي الأوفلاين'); ?></a>
        <span class="text-slate-300" aria-hidden="true">/</span>
