...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (form) {
        ...
        form.addEventListener('submit', function() {
            var type = document.getElementById('question_type').value;
            var allIds = ['correct_answer_multiple_choice', 'correct_answer_true_false', 'correct_answer_fill_blank', 'correct_answer_short_answer', 'correct_answer_essay'];
            var typeToId = {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/instructor/question-banks/show.blade.php ENDPATH**/ ?>