        ...
        <div class="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
                ...
                <p class="mt-3 text-white/80 max-w-2xl">
                    <?php echo e($courseModeLabel); ?> — <?php echo e($agreement->display_course_title); ?> — بدأت في <?php echo e(optional($agreement->start_date)->format('Y-m-d')); ?>. تتبع أدناه جدول الأقساط والمبالغ المستحقة.
                </p>
            </div>
