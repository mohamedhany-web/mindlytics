<?php $__env->startSection('title', __('student.oc_resources_page_title', ['title' => $offlineCourse->title])); ?>
    ...
    <header class="oc-chrome">
        <div>
            <nav class="oc-crumb" aria-label="<?php echo e(__('student.oc_breadcrumb')); ?>">
                ...
                <span aria-hidden="true">/</span>
                <span style="color:var(--ml-ink);font-weight:700"><?php echo e(__('student.oc_resources')); ?></span>
            </nav>
            <h1><?php echo e(__('student.oc_resources')); ?></h1>
...
<div class="space-y-6">
    <div class="mb-0">
        <a href="<?php echo e(route(($studentRouteGroup ?? 'student.offline-courses') . '.show', $offlineCourse)); ?>" class="oc-btn oc-btn-quiet" style="min-height:36px">
            ...
            <?php echo e(__('student.oc_back_to_course')); ?>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="min-w-0">
                    <h1 class="text-xl font-bold text-gray-900 flex items-center gap-2">
                        ...
                        <?php echo e(__('student.oc_resources_heading', ['channel' => $channelLabel, 'title' => $offlineCourse->title])); ?>

                    </h1>
                    <p class="text-sm text-gray-500 mt-1">
                        <?php echo e(__('student.oc_resources_intro')); ?>
                ...
                <form method="GET" class="flex flex-col sm:flex-row gap-2 sm:items-center">
                    <div class="relative">
                        ...
                        <input
                            ...
                            placeholder="<?php echo e(__('student.oc_search_resources_placeholder')); ?>"
                    ...
                    <button class="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-[#2f7f7d] text-white text-sm font-semibold hover:bg-[#2f7f7d]">
                        ...
                        <?php echo e(__('student.oc_apply')); ?>
        ...
        <?php if(! $hasGeneral && ! $hasLectures): ?>
            <div class="p-12 text-center text-gray-500">
                ...
                <p><?php echo e(__('student.oc_no_resources')); ?></p>
            </div>
        <?php else: ?>
            <?php if($hasGeneral): ?>
                <div class="p-4 sm:p-5 border-b border-gray-100 bg-gray-50/40">
                    <h2 class="font-bold text-gray-900 flex items-center gap-2">
                        ...
                        <?php echo e(__('student.oc_general_resources')); ?>

                    </h2>
                    <p class="text-sm text-gray-600 mt-1"><?php echo e(__('student.oc_general_resources_desc')); ?></p>
                </div>
                                    ...
                                    <?php if($resource->type === 'link' && $resource->url): ?>
                                        <a href="<?php echo e($resource->url); ?>" target="_blank" rel="noopener"
                                           class="inline-flex items-center justify-center gap-2 w-full px-4 py-2.5 bg-[#2f7f7d] text-white rounded-xl font-semibold hover:bg-[#2f7f7d]">
                                            ...
                                            <?php echo e(__('student.oc_open_link')); ?>
                                            ...
                                            <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a href="<?php echo e(offline_course_resource_file_url($file)); ?>"
                                                   ...
                                                   class="group inline-flex items-center gap-2 w-full max-w-full px-3 py-2 rounded-xl bg-teal-50 text-teal-800 text-sm font-semibold hover:bg-teal-100 border border-teal-100">
                                                    ...
                                                    <span class="truncate min-w-0"><?php echo e($file['name'] ?? __('student.oc_download')); ?></span>
                                                </a>
            ...
            <?php if($hasLectures): ?>
                <div class="p-4 sm:p-5 border-t border-gray-100 bg-white">
                    <h2 class="font-bold text-gray-900 flex items-center gap-2">
                        ...
                        <?php echo e(__('student.oc_by_lectures')); ?>

                    </h2>
                    <p class="text-sm text-gray-600 mt-1"><?php echo e(__('student.oc_lectures_pick_resources')); ?></p>
                </div>
                        ...
                        <details class="group">
                                ...
                                <div class="min-w-0">
                                    <div class="flex items-center gap-2 flex-wrap">
                                        ...
                                        <span class="text-xs px-2 py-1 rounded-full bg-teal-50 text-teal-800">
                                            <?php echo e(__('student.oc_resource_count', ['count' => $resourcesForLecture->count()])); ?>
                            ...
                            <div class="px-4 sm:px-5 pb-5">
                                <?php if($resourcesForLecture->isEmpty()): ?>
                                    <div class="text-sm text-gray-500 py-3"><?php echo e(__('student.oc_no_lecture_resources')); ?></div>
                                <?php else: ?>
                                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
