...
<div class="p-3 sm:p-4 md:p-6 space-y-4 sm:space-y-6" style="background: #f8fafc; min-height: 100vh;">
        ...
        <?php if(!empty($pacingStats)): ?>
            <div class="mx-5 mb-5 rounded-xl bg-sky-50 border border-sky-200 px-4 py-3 text-sm text-sky-900">
                ...
                <p class="mt-1 text-sky-800/90">
                    ...
                    تأخير <?php echo e(config('whatsapp.pacing.min_delay_seconds', 5)); ?>–<?php echo e(config('whatsapp.pacing.max_delay_seconds', 14)); ?> ث ·
                    استراحة كل <?php echo e(config('whatsapp.pacing.pause_every', 20)); ?> رسالة
                </p>
                <p class="mt-2 text-xs text-sky-700">
                    <a href="<?php echo e(route('admin.whatsapp.docs')); ?>#anti-ban" class="font-semibold underline">اقرأ دليل تجنب الحظر</a>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6">
        ...
        <section class="<?php echo e($waSectionClass); ?>">
            ...
            <div class="p-5 space-y-5">
                ...
                <?php if(!empty($status['last_error']) && !$isConnected): ?>
                    <div class="rounded-xl bg-rose-50 border border-rose-200 px-4 py-3 text-sm text-rose-800">
                        <span class="font-semibold">خطأ الاتصال:</span> <?php echo e($status['last_error']); ?>
                ...
                <div class="flex flex-wrap gap-2 pt-1">
                    ...
                    <form method="POST" action="<?php echo e(route('admin.whatsapp.logout')); ?>" onsubmit="return confirm('قطع اتصال الواتساب؟ ستحتاج QR أو رمز ربط جديد.');">
                        <?php echo csrf_field(); ?>
        ...
        <section class="<?php echo e($waSectionClass); ?>" x-data="whatsappConnect()" x-init="init()">
            ...
            <div class="p-5">
                ...
                <template x-if="!connected && mode === 'qr'">
                    <div>
                        ...
                        <button type="button" @click="refreshQr()" class="mt-4 w-full <?php echo e($waBtnDark); ?>">
                ...
                <template x-if="!connected && mode === 'pairing'">
                    <div>
                        ...
                        <form @submit.prevent="requestPairing()" class="space-y-3 mb-4">
                            <div>
                                <label class="<?php echo e($waLabelClass); ?>">رقم الواتساب (مع كود الدولة)</label>
                            ...
                            <button type="submit" class="w-full <?php echo e($waBtnPrimary); ?>" :disabled="loading || !pairingPhone.trim()">
                                <i class="fas fa-key"></i>
                        ...
                        <button type="button" @click="refreshPairing()" class="mt-4 w-full <?php echo e($waBtnDark); ?>">
                            <i class="fas fa-redo"></i>
    ...
    <section class="<?php echo e($waSectionClass); ?>">
        ...
        <div class="p-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
            ...
            <a href="<?php echo e(route('admin.whatsapp.docs')); ?>" class="group rounded-xl border border-slate-200 p-4 hover:border-violet-300 hover:shadow-md transition-all bg-white">
...
function whatsappConnect() {
    ...
    const statusUrl = <?php echo json_encode(route('admin.whatsapp.status'), 15, 512) ?>;
    const qrUrl = <?php echo json_encode(route('admin.whatsapp.qr'), 15, 512) ?>;
    const pairingGetUrl = <?php echo json_encode(route('admin.whatsapp.pairing'), 15, 512) ?>;
    const pairingPostUrl = <?php echo json_encode(route('admin.whatsapp.pairing.request'), 15, 512) ?>;
    const repairUrl = <?php echo json_encode(route('admin.whatsapp.start'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/whatsapp/index.blade.php ENDPATH**/ ?>