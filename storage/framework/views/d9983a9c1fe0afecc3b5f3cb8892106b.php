    ...
    <section class="dashboard-card rounded-2xl card-hover-effect border-2 border-slate-200/80 shadow-xl overflow-hidden mb-6" style="background: linear-gradient(135deg, rgba(255, 255, 255, 0.98) 0%, rgba(248, 250, 252, 0.96) 100%);">
        <div class="px-6 py-4 border-b border-slate-200 bg-slate-50/90">
            ...
            <p class="text-xs text-slate-600 mt-2 leading-relaxed max-w-4xl">
                ...
                <?php if($centralAcademyBranchId): ?>
                    <span class="font-mono text-indigo-700">(المعرّف <?php echo e($centralAcademyBranchId); ?>)</span>
                <?php endif; ?>
            ...
            <table class="min-w-full text-sm text-slate-800">
                ...
                <tbody class="divide-y divide-slate-100">
                    <?php $__currentLoopData = $branchesOperationalOverview; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="hover:bg-slate-50/90 transition-colors <?php echo e($isCentral ? 'bg-indigo-50/40' : ''); ?>">
                            ...
                            <td class="px-4 py-3 font-mono text-xs" dir="ltr"><?php echo e($bRow->slug); ?></td>
                            <td class="px-4 py-3 text-center tabular-nums font-bold"><?php echo e(number_format($bRow->users_count)); ?></td>
                            ...
                            <td class="px-4 py-3 text-center">
                                <a href="<?php echo e(route('admin.branches.show', $bRow)); ?>" class="inline-flex items-center gap-1 text-blue-600 hover:text-blue-800 font-bold text-xs">
