...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
        ...
        <form method="POST" action="<?php echo e(route('admin.online-enrollments.quick-activate')); ?>" class="space-y-4"
              x-data="quickActivateForm(<?php echo \Illuminate\Support\Js::from($courses->map(fn($c) => [
                  'id' => $c->id,
                ...
                <select name="advanced_course_id" id="quick_course" x-model="courseId" @change="onCourseChange()"
                    ...
                    <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($course->id); ?>" <?php echo e(old('advanced_course_id') == $course->id ? 'selected' : ''); ?>>
                            <?php echo e($course->title); ?> (<?php echo e(number_format($course->effectivePrice(), 0)); ?> ج.م<?php if($course->hasCourseDiscount()): ?> — كان <?php echo e(number_format($course->originalPrice(), 0)); ?><?php endif; ?>)
                        </option>
...
unset($__errorArgs, $__bag); ?>
        ...
        function quickActivateForm(courses) {
            ...
            return {
                courseId: '<?php echo e(old('advanced_course_id', '')); ?>',
                listPrice: 0,
                discount: Number('<?php echo e(old('discount_amount', 0)); ?>') || 0,
                finalPrice: Number('<?php echo e(old('final_price', '')); ?>') || 0,
                activateAsFree: <?php echo e(old('activate_as_free') ? 'true' : 'false'); ?>,
                paymentMethod: '<?php echo e(old('payment_method', 'cash')); ?>',
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <a href="<?php echo e(route('admin.online-enrollments.export', request()->query())); ?>"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="mr-4">
                                        ...
                                        <?php if($enrollment->hide_from_instructor): ?>
