...
<?php $__env->startSection('title', 'طلبات حجز الكورسات الأونلاين'); ?>
<?php $__env->startSection('header', 'طلبات حجز الكورسات الأونلاين'); ?>
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
        <form method="get" class="flex flex-wrap gap-4 items-end">
            ...
            <a href="<?php echo e(route('admin.online-course-bookings.index')); ?>" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg text-sm">إعادة تعيين</a>
        </form>
    </div>
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50/80">
                            ...
                            <td class="px-4 py-3 text-gray-600 text-xs"><?php echo e($b->requestedGroup->name ?? '—'); ?></td>
                            <td class="px-4 py-3 text-gray-600"><?php echo e($b->payment_method === 'wallet' ? 'محفظة' : 'تحويل'); ?></td>
                            <td class="px-4 py-3">
                            ...
                            <td class="px-4 py-3">
                                <a href="<?php echo e(route('admin.online-course-bookings.show', $b)); ?>" class="text-blue-600 hover:text-blue-800 font-medium">تفاصيل</a>
                            </td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr><td colspan="8" class="px-4 py-12 text-center text-gray-500">لا توجد طلبات.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/online-course-bookings/index.blade.php ENDPATH**/ ?>