                    ...
                    <tr class="hover:bg-slate-50/80 transition-colors">
                        ...
                        <td class="px-4 py-3 text-sm">
                            <div class="flex flex-wrap items-center gap-2">
                                <?php if($ws->is_active): ?>
                                    <form action="<?php echo e(route('admin.workshops.deactivate', $ws)); ?>" method="POST" onsubmit="return confirm('إيقاف الورشة؟ سيظهر الرابط العام أن الورشة انتهت ولن يُقبل تسجيل جديد.');">
                                        <?php echo csrf_field(); ?>
                                ...
                                <?php else: ?>
                                    <form action="<?php echo e(route('admin.workshops.activate', $ws)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/workshops/index.blade.php ENDPATH**/ ?>