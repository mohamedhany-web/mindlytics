...
<div class="p-3 sm:p-6 space-y-6" style="background:#f8fafc;min-height:100vh;">
    ...
    <div class="max-w-4xl mx-auto rounded-2xl bg-white border border-slate-200 shadow-sm p-6 sm:p-8">
            <h1 class="text-xl font-black text-slate-900 mb-6">تعديل برنامج الإحالات: <?php echo e($referralProgram->name); ?></h1>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/referral-programs/edit.blade.php ENDPATH**/ ?>