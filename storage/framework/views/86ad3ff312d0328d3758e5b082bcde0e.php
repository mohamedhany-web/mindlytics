        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">إجمالي: <strong><?php echo e($salesSnapshot['total']); ?></strong> — نشط: <strong><?php echo e($salesSnapshot['active']); ?></strong> — متابعات اليوم: <strong><?php echo e($salesSnapshot['followups_today']); ?></strong><?php if(($salesSnapshot['followups_overdue'] ?? 0) > 0): ?> — <span class="text-rose-600 font-semibold">متأخر: <?php echo e($salesSnapshot['followups_overdue']); ?></span><?php endif; ?></p>
                </div>
            </div>
            <div class="flex flex-wrap gap-2">
                <a href="<?php echo e(route('employee.sales.dashboard')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold transition-colors">
                    <i class="fas fa-handshake"></i> مركز المبيعات
                </a>
                <a href="<?php echo e(route('employee.sales.leads.index')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white border-2 border-emerald-200 text-emerald-800 text-sm font-semibold hover:bg-emerald-50 transition-colors">
...
<?php echo $__env->make('layouts.employee', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/employee/dashboard.blade.php ENDPATH**/ ?>