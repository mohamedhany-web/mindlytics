...
<div class="max-w-7xl mx-auto space-y-6 pb-10">
    <div class="flex flex-wrap items-center justify-between gap-3">
        ...
        <div class="flex gap-2">
            <?php if(!empty($whatsappInboxUrl)): ?>
                <a href="<?php echo e($whatsappInboxUrl); ?>" class="px-4 py-2 bg-emerald-600 text-white rounded-lg text-sm font-medium hover:bg-emerald-700">
                    <i class="fab fa-whatsapp ml-1"></i>
                    <?php echo e($whatsappConversation ? 'فتح المحادثة' : 'بدء واتساب'); ?>
