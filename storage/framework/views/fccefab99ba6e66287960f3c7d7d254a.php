...
<div class="los-sidebar">
    <div class="los-sidebar-brand relative">
        <button type="button"
                ...
                aria-label="<?php echo e(__('common.close_menu')); ?>">
    ...
    <div class="los-side-progress" aria-label="<?php echo e(__('common.overall_progress')); ?>">
        <div class="row">
            <span><?php echo e(__('student.progress')); ?></span>
            <span style="color:var(--ml-teal-deep)"><?php echo e($totalProgress); ?><?php echo e(app()->getLocale() === 'ar' ? '٪' : '%'); ?></span>
        </div>
    ...
    <nav class="los-nav sidebar-scroll" aria-label="<?php echo e(__('common.learning_nav')); ?>">
