...
<?php $__env->startSection('title', 'توثيق الواتساب - Mindlytics'); ?>
...
<div class="p-3 sm:p-4 md:p-6 space-y-4 sm:space-y-6" style="background: #f8fafc; min-height: 100vh;">
    ...
    <?php echo $__env->make('admin.whatsapp._nav', ['active' => 'docs'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <section class="<?php echo e($waSectionClass); ?>" id="overview">
    ...
    <section class="<?php echo e($waSectionClass); ?>" id="connection">
        <div class="px-5 py-4 border-b border-slate-200">
        ...
        <div class="p-5 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="rounded-xl border border-emerald-200 bg-emerald-50/50 p-4">
                ...
                <ol class="list-decimal list-inside mt-3 text-sm text-slate-700 space-y-1.5">
                    <li>افتح <a href="<?php echo e(route('admin.whatsapp.index')); ?>" class="text-emerald-700 underline">لوحة الواتساب</a></li>
...
pm2 restart mindlytics-whatsapp</pre>
    ...
    <section class="<?php echo e($waSectionClass); ?>" id="env">
        <div class="px-5 py-4 border-b border-slate-200">
        ...
        <div class="p-5 overflow-x-auto">
            <table class="w-full text-sm border-collapse">
                ...
                <tbody class="font-mono text-xs dir-ltr text-left">
                    ...
                    <tr><td class="border px-3 py-2">WHATSAPP_MAX_PER_HOUR</td><td class="border px-3 py-2 font-sans text-right">حد الساعة</td><td class="border px-3 py-2"><?php echo e($maxHour); ?></td></tr>
                    <tr><td class="border px-3 py-2">WHATSAPP_MAX_PER_DAY</td><td class="border px-3 py-2 font-sans text-right">حد اليوم</td><td class="border px-3 py-2"><?php echo e($maxDay); ?></td></tr>
                </tbody>
            </table>
    ...
    <section class="<?php echo e($waSectionClass); ?>" id="anti-ban">
        <div class="px-5 py-4 border-b border-slate-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div class="rounded-xl border border-slate-200 p-4 bg-white">
                    ...
                    <ul class="mt-2 space-y-1 text-sm">
                        <li>الإرسال الآمن: <strong><?php echo e($pacingEnabled ? 'مفعّل' : 'معطّل'); ?></strong></li>
                        <li>حد الساعة: <strong><?php echo e($maxHour); ?></strong> رسالة</li>
                        <li>حد اليوم: <strong><?php echo e($maxDay); ?></strong> رسالة</li>
                        <li>تأخير بين الرسائل: <strong><?php echo e($minDelay); ?>–<?php echo e($maxDelay); ?></strong> ثانية</li>
                        <li>استراحة كل <strong><?php echo e($pauseEvery); ?></strong> رسالة</li>
                        <li>ساعات العمل فقط: <strong><?php echo e($businessOnly ? 'نعم' : 'لا'); ?></strong></li>
                    </ul>
                </div>
                <div class="rounded-xl border border-slate-200 p-4 bg-white">
    ...
    <section class="<?php echo e($waSectionClass); ?>" id="api">
        <div class="px-5 py-4 border-b border-slate-200">
    ...
    <section class="<?php echo e($waSectionClass); ?>" id="queue">
        <div class="px-5 py-4 border-b border-slate-200">
    ...
    <section class="<?php echo e($waSectionClass); ?>" id="troubleshooting">
        <div class="px-5 py-4 border-b border-slate-200">
            <h3 class="text-lg font-bold text-slate-900">استكشاف الأخطاء</h3>
        </div>
        <div class="p-5 text-sm text-slate-700 space-y-3">
            <div><strong>تعذّر الاتصال بالجسر</strong> — تحقق من الرابط والتوكن في <a href="<?php echo e(route('admin.whatsapp.settings')); ?>" class="underline">إعدادات الربط</a> ومن أن VPS يعمل.</div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/whatsapp/docs.blade.php ENDPATH**/ ?>