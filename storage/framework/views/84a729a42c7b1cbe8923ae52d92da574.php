                ...
                <div class="bg-white border border-gray-100 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden flex flex-col">
                    <div class="relative h-48 bg-gradient-to-br from-sky-500 to-indigo-600 flex items-center justify-center">
                        ...
                        <div class="absolute top-4 right-4 space-y-2 text-right">
                            <?php if($course->effectivePrice() > 0 && !$course->is_free): ?>
                                <span class="inline-flex flex-col items-end px-3 py-1 rounded-lg bg-emerald-500 text-white text-sm font-bold shadow-lg">
                                    <?php if($course->hasCourseDiscount()): ?>
                                        <span class="text-[11px] line-through opacity-80"><?php echo e(number_format($course->originalPrice(), 0)); ?> ج.م</span>
                                    <?php endif; ?>
                                    <span><?php echo e(number_format($course->effectivePrice(), 0)); ?> ج.م</span>
                                </span>
                            <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mindly tics\Mindlytics\resources\views\student\subjects\courses.blade.php ENDPATH**/ ?>