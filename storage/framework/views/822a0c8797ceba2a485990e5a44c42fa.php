                        ...
                        <div class="flex items-center text-sm text-gray-600">
                            <?php if($course->effectivePrice() > 0): ?>
                                ...
                                <?php if($course->hasCourseDiscount()): ?>
                                    <span class="text-gray-400 line-through font-medium ml-1"><?php echo e(number_format($course->originalPrice())); ?></span>
                                    <span class="text-gray-900 font-medium"><?php echo e(number_format($course->effectivePrice())); ?> ج.م</span>
                                <?php else: ?>
                                    <span class="text-gray-900 font-medium"><?php echo e(number_format($course->effectivePrice())); ?> ج.م</span>
                                <?php endif; ?>
                            <?php else: ?>
