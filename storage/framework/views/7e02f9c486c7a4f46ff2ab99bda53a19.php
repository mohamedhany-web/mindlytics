                ...
                <tbody class="divide-y divide-slate-100">
                    <?php $__empty_1 = true; $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="hover:bg-blue-50/40 transition-colors <?php echo e($loop->even ? 'bg-slate-50/30' : 'bg-white'); ?>">
                            ...
                            <td class="px-3 py-3 align-middle text-center">
                                <a href="<?php echo e(route('admin.invoices.show', $invoice)); ?>" class="inline-flex h-9 w-9 items-center justify-center rounded-xl border border-slate-200 bg-white text-blue-600 hover:bg-blue-50 hover:border-blue-200 transition-colors" title="عرض التفاصيل">
