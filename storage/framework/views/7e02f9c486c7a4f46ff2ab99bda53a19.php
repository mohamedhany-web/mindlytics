...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <?php $__currentLoopData = $statCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <a href="<?php echo e(route('admin.invoices.index', $card['filter'])); ?>" class="dashboard-stat-card rounded-2xl border-2 <?php echo e($theme['border']); ?> bg-gradient-to-br <?php echo e($theme['bg']); ?> p-5 shadow-lg hover:shadow-xl transition-shadow block">
                ...
                <p class="text-xs font-medium <?php echo e($theme['desc']); ?>"><?php echo e($card['desc']); ?></p>
            </a>
