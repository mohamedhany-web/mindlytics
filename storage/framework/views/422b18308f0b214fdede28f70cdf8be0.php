...
<div class="space-y-4">
    ...
    <div class="bg-emerald-50 border border-emerald-200 rounded-xl p-4 flex flex-wrap items-center justify-between gap-3">
        ...
        <a href="<?php echo e(route('admin.sales.whatsapp-groups.create', ['crm_group' => $group->id])); ?>" class="inline-flex px-4 py-2 bg-emerald-600 text-white rounded-lg text-xs font-semibold">إنشاء مجموعة واتساب</a>
    </div>
