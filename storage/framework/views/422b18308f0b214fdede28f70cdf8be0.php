...
<div class="space-y-4">
    ...
    <div class="bg-white border border-emerald-200/60 rounded-xl p-4 flex flex-wrap items-center justify-between gap-3 shadow-sm">
        ...
        <a href="<?php echo e(route('admin.sales.whatsapp-groups.create', ['crm_group' => $group->id])); ?>" class="inline-flex items-center gap-1 px-4 py-2 bg-slate-800 hover:bg-slate-900 text-white rounded-lg text-xs font-semibold">إنشاء مجموعة واتساب</a>
    </div>
