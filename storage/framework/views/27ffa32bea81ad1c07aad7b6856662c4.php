...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/mindlytics-los.css')); ?>?v=4">
    ...
    <div class="flex h-screen overflow-hidden">
        <?php if(auth()->guard()->check()): ?>
            ...
            <aside class="student-sidebar los-sidebar-bridge flex-shrink-0 fixed lg:static inset-y-0 z-50 lg:z-auto
                          <?php echo e($studentRtl ? 'right-0' : 'left-0'); ?>

                          transition-transform duration-150 ease-out lg:!translate-x-0
                          <?php echo e($studentRtl ? 'translate-x-full' : '-translate-x-full'); ?>"
                   :class="sidebarOpen ? 'translate-x-0' : '<?php echo e($studentRtl ? 'translate-x-full' : '-translate-x-full'); ?>'">
                ...
                <header class="los-topnav student-header los-topnav-bridge flex-shrink-0">
                    <div class="flex items-center gap-2 flex-1 min-w-0">
                        <button type="button" @click="sidebarOpen = !sidebarOpen"
                                class="lg:hidden los-icon-btn flex-shrink-0" aria-label="<?php echo e(__('common.menu')); ?>">
                            <i class="fas fa-bars text-sm"></i>
                        </button>

                        <button type="button" data-los-open-palette class="los-topnav-search flex-1" aria-label="<?php echo e(__('common.quick_search')); ?>">
                            <i class="fas fa-magnifying-glass text-xs" style="color:var(--ml-teal)"></i>
                            <span class="truncate hidden sm:inline"><?php echo e(__('common.search_or_jump')); ?></span>
                            <span class="truncate sm:hidden"><?php echo e(__('common.search')); ?></span>
                    ...
                    <div class="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
                        ...
                        ?>
                        <div class="los-progress-pill" title="<?php echo e(__('common.learning_progress')); ?>">
                            <span><?php echo e($navProgress); ?><?php echo e($studentRtl ? '٪' : '%'); ?></span>
                            <span class="bar" aria-hidden="true"><i style="width:<?php echo e(min(100,$navProgress)); ?>%"></i></span>
                        </div>

                        <a href="<?php echo e(route('dashboard')); ?>#los-ai" class="los-icon-btn is-ai" title="<?php echo e(__('common.ai_guide')); ?>" aria-label="<?php echo e(__('common.ai_guide')); ?>">
                            <i class="fas fa-wand-magic-sparkles text-sm"></i>
                        </a>
                        <a href="<?php echo e(route('calendar')); ?>" class="los-icon-btn hidden sm:inline-flex" title="<?php echo e(__('student.calendar')); ?>" aria-label="<?php echo e(__('student.calendar')); ?>">
...
<?php endif; ?>
                        ...
                        <div class="relative" x-data="window.__navNotifications()">
                            <button type="button" @click="toggle()" class="los-icon-btn relative" aria-label="<?php echo e(__('student.notifications')); ?>">
                            ...
                            <div x-show="open" @click.away="open = false" x-transition
                                ...
                                <div class="p-3 border-b border-gray-100 flex items-center justify-between gap-2" style="background:rgba(73,164,162,0.08)">
                                    <h3 class="font-bold text-sm text-gray-900"><?php echo e(__('student.notifications')); ?></h3>
                                    <button type="button" class="text-xs font-bold" style="color:var(--ml-teal-deep)"
                                            @click="markAllRead()" x-show="unreadCount > 0"><?php echo e(__('student.mark_all_read')); ?></button>
                                </div>
                                <div class="max-h-80 overflow-y-auto">
                                    <template x-if="loading"><div class="p-5 text-center text-sm text-gray-500"><?php echo e(__('common.loading')); ?></div></template>
                                    <template x-if="!loading && items.length === 0">
                                        <div class="p-6 text-center text-sm text-gray-500"><?php echo e(__('student.no_notifications')); ?></div>
                                    </template>
                                ...
                                <div class="p-3 border-t border-gray-100">
                                    <a href="<?php echo e(route('notifications')); ?>" class="text-xs font-bold" style="color:var(--ml-teal-deep)"><?php echo e(__('common.all_notifications')); ?></a>
                                </div>
                            </div>
                        </div>

                        <div class="relative" x-data="{ open: false }">
                            <button type="button" @click="open = !open" class="los-icon-btn" style="width:auto;padding:0 8px;gap:8px" aria-label="<?php echo e(__('common.account')); ?>">
                            ...
                            <div x-show="open" @click.away="open = false" x-transition
                                ...
                                <div class="p-1.5">
                                    <a href="<?php echo e(route('profile')); ?>" class="dropdown-item gap-2 px-3 py-2 rounded-lg text-sm"><?php echo e(__('student.profile')); ?></a>
                                    <a href="<?php echo e(route('settings')); ?>" class="dropdown-item gap-2 px-3 py-2 rounded-lg text-sm"><?php echo e(__('student.settings')); ?></a>
                                    <hr class="my-1 border-gray-100">
                                    <form method="POST" action="<?php echo e(route('logout')); ?>">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit" class="w-full dropdown-item gap-2 px-3 py-2 rounded-lg text-sm text-red-600 text-start"><?php echo e(__('auth.logout')); ?></button>
                                    </form>
                                </div>
                            </div>
                        </div>
    ...
    <?php if(auth()->guard()->check()): ?>
        ...
        <button type="button" class="los-fab-ai" data-los-open-palette aria-label="<?php echo e(__('common.command_palette_fab')); ?>" title="Ctrl K">
