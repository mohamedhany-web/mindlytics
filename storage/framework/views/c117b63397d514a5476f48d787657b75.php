<?php $__env->startSection('title', 'كورساتي الأوفلاين - Mindlytics'); ?>
<?php $__env->startSection('header', 'كورساتي الأوفلاين'); ?>
        ...
        <form method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <select name="status" id="status" class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-slate-800 focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 transition-colors">
                    ...
                    <option value="completed" <?php echo e(request('status') == 'completed' ? 'selected' : ''); ?>>منتهي</option>
                </select>
            </div>
