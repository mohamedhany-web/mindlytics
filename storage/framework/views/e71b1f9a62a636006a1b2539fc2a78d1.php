    ...
    <div class="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
        ...
        <div class="px-5 py-6 sm:px-6 space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="rounded-xl border border-slate-100 bg-white p-4">
                    <p class="text-xs font-semibold text-slate-500 mb-1"><?php echo e(__('instructor.processed_at')); ?></p>
            ...
            <div class="rounded-xl border border-amber-100 bg-amber-50/50 p-4">
                <p class="text-xs font-bold text-amber-800 uppercase tracking-wide mb-2"><?php echo e(__('instructor.admin_notes_label')); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/instructor/withdrawals/show.blade.php ENDPATH**/ ?>