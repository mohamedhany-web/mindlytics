            ...
            <ul class="divide-y divide-slate-100">
                <?php $__empty_1 = true; $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <li class="px-5 py-3 flex items-center justify-between gap-3">
                        <div>
                            <p class="font-semibold text-slate-900"><?php echo e($member->user->name ?? '—'); ?></p>
                            <p class="text-xs text-slate-500"><?php echo e($member->user->email ?? ''); ?></p>
                        </div>
                        <a href="<?php echo e(route('employee.sales-manager.attendance.employee', $member->user_id)); ?>" class="text-xs text-emerald-700 font-semibold hover:underline">الحضور</a>
                    </li>
