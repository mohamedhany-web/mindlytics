        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div class="flex-1 min-w-0">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <?php if($course->is_scholarship_only): ?>
            ...
            <div class="flex flex-wrap items-center gap-2 shrink-0">
                <?php if($course->is_scholarship_only && $course->scholarshipProgram): ?>
                    <a href="<?php echo e(route('instructor.scholarships.show', $course->scholarshipProgram)); ?>" class="inline-flex items-center gap-2 px-4 py-2.5 bg-violet-600 hover:bg-violet-700 text-white rounded-xl font-semibold transition-colors">
