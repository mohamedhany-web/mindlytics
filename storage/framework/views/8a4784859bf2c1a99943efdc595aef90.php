...
<div class="space-y-6">
            ...
            <div class="px-4 pb-4">
                <p class="text-xs text-slate-600 bg-slate-50 border border-slate-200 rounded-xl px-3 py-2">
                    ...
                    <?php if($selectedRep): ?>
                        ...
                        <?php if(!empty($employeeReport) && !empty($employeeReport['group_filter_label'])): ?>
                            · المجموعة: <strong><?php echo e($employeeReport['group_filter_label']); ?></strong>
                        <?php endif; ?>
                    <?php else: ?>
            ...
            <form method="get"
                ...
                <div class="lg:col-span-2">
                    ...
                    <select name="lead_scope"
                        ...
                        <option value="in_groups" <?php if(($leadScope ?? 'touched') === 'in_groups'): echo 'selected'; endif; ?>>كل Leads داخل مجموعات العملاء المسندة</option>
                ...
                <div class="lg:col-span-2" x-show="userId" x-cloak>
                    ...
                    <select name="group_id"
                        ...
                        <?php $__currentLoopData = $repGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($g->id); ?>" <?php if((string)($groupId ?? '') === (string)$g->id): echo 'selected'; endif; ?>><?php echo e($g->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                ...
                <div class="lg:col-span-4 flex flex-wrap items-center gap-2 pt-1">
                    ...
                    <button type="submit"
                            formaction="<?php echo e(route('admin.sales.reports.pdf')); ?>"
                            formmethod="get"
                            :disabled="!userId"
    ...
    <?php if($hasPreview): ?>
        ...
        <?php if($selectedRep && $periodReport && !empty($employeeReport)): ?>
            <?php echo $__env->make('admin.sales.reports._employee-detail', ['employeeReport' => $employeeReport, 'selectedRep' => $selectedRep], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            ...
                            <?php $__currentLoopData = $repSummaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr class="hover:bg-slate-50">
                                    <td class="px-4 py-3 font-semibold text-slate-900">
                                        <a href="<?php echo e(route('admin.sales.reports.employee', ['user_id' => $row['user']->id, 'date_from' => $start->format('Y-m-d'), 'date_to' => $end->format('Y-m-d'), 'lead_scope' => 'in_groups'])); ?>"
