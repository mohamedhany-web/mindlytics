...
<?php $__env->startSection('title', 'تقارير الواتساب'); ?>
    ...
    <section class="rounded-2xl bg-white border border-slate-200 shadow-sm overflow-hidden">
        <div class="px-4 py-4 bg-slate-50 border-b border-slate-200 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="<?php echo e(route('admin.whatsapp.inbox')); ?>" class="inline-flex items-center gap-2 px-3 py-2 text-sm font-semibold text-slate-700 rounded-xl border border-slate-300 hover:bg-slate-50">
        ...
        <form method="get" class="p-4 border-b border-slate-100 flex flex-wrap items-end gap-3">
            <div>
                ...
                <input type="date" name="from" value="<?php echo e($from->format('Y-m-d')); ?>" class="rounded-lg border-slate-200 text-sm">
            </div>
            <div>
                <label class="block text-xs font-bold text-slate-600 mb-1">إلى</label>
                <input type="date" name="to" value="<?php echo e($to->format('Y-m-d')); ?>" class="rounded-lg border-slate-200 text-sm">
            </div>
                ...
                <?php $__currentLoopData = $statCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
                        <div class="flex items-center justify-between gap-2">
                            <div class="min-w-0">
                                <p class="text-[10px] font-semibold text-slate-600 truncate"><?php echo e($card['label']); ?></p>
                                <p class="text-lg font-black text-slate-900 tabular-nums"><?php echo e($card['value']); ?></p>
                            </div>
                            <div class="w-9 h-9 rounded-lg <?php echo e($card['bg']); ?> flex items-center justify-center <?php echo e($card['text']); ?> shrink-0">
    ...
    <?php if($report['ready'] ?? false): ?>
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
            <section class="rounded-2xl bg-white border border-slate-200 shadow-sm p-5">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $report['agent_performance'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="border-b border-slate-50">
                                    <td class="py-2 font-medium"><?php echo e($row['name']); ?></td>
                                    <td class="py-2 tabular-nums"><?php echo e($row['conversations']); ?></td>
                                    <td class="py-2 tabular-nums"><?php echo e($row['replies']); ?></td>
                                    <td class="py-2 tabular-nums"><?php echo e($row['open']); ?></td>
                                </tr>
            ...
            <section class="rounded-2xl bg-white border border-slate-200 shadow-sm p-5">
                ...
                <div class="space-y-2">
                    <?php $__empty_1 = true; $__currentLoopData = $report['by_status'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex items-center justify-between text-sm rounded-lg bg-slate-50 px-3 py-2">
                            <span><?php echo e($row['label']); ?></span>
                            <span class="font-bold tabular-nums"><?php echo e($row['total']); ?></span>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <section class="rounded-2xl bg-white border border-slate-200 shadow-sm p-5">
                ...
                <div class="space-y-2">
                    <?php $__empty_1 = true; $__currentLoopData = $report['pipeline_breakdown'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <section class="rounded-2xl bg-white border border-slate-200 shadow-sm p-5">
                ...
                <div class="flex flex-wrap gap-2">
                    <?php $__empty_1 = true; $__currentLoopData = $report['top_tags'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <span class="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-amber-50 border border-amber-200 text-xs font-semibold text-amber-900">
                            <?php echo e($tag['name']); ?> <span class="text-amber-600">(<?php echo e($tag['total']); ?>)</span>
                        </span>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <section class="rounded-2xl bg-white border border-slate-200 shadow-sm p-5">
            ...
            <div class="space-y-3">
                <?php $__empty_1 = true; $__currentLoopData = $report['recent_events'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex gap-3 text-sm border-b border-slate-50 pb-2">
                        ...
                        <div>
                            ...
                            <?php if($event['description']): ?>
                                <p class="text-slate-600 text-xs"><?php echo e($event['description']); ?></p>
                            <?php endif; ?>
                            <p class="text-[10px] text-slate-400 mt-0.5">
                                <?php echo e($event['performer'] ? $event['performer'] . ' · ' : ''); ?><?php echo e($event['at']); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mindly tics\Mindlytics\resources\views\admin\whatsapp\reports\index.blade.php ENDPATH**/ ?>