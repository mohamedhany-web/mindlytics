    ...
    <section class="rounded-2xl bg-white border border-slate-200 shadow-sm overflow-hidden print:hidden" data-print-hide>
        <div class="px-4 py-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <h2 class="text-xl font-black text-slate-900 tracking-tight"><?php echo e($invoice->invoice_number); ?></h2>
            </div>
            <div class="flex flex-wrap items-center gap-2">
                <a href="<?php echo e(route('admin.invoices.edit', $invoice)); ?>" class="inline-flex items-center gap-2 rounded-xl border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50">
                ...
                <a href="<?php echo e(route('admin.invoices.index')); ?>" class="inline-flex items-center gap-2 rounded-xl border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50">
                        ...
                        <table class="min-w-full text-sm">
                            ...
                            <tbody class="divide-y divide-slate-100">
                                <?php $__currentLoopData = $invoice->payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-slate-50/80">
                                        <td class="px-4 py-3 font-mono font-semibold text-slate-900"><?php echo e($payment->payment_number); ?></td>
