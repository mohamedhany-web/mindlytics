    ...
    <section class="rounded-2xl bg-white border border-slate-200 shadow-sm overflow-hidden">
        <div class="px-5 py-6 border-b border-slate-100 flex flex-wrap items-start justify-between gap-4">
            <div>
                ...
                <h1 class="text-2xl font-black text-slate-900"><?php echo e($referralProgram->name); ?></h1>
                <?php if($referralProgram->description): ?>
                    <p class="text-sm text-slate-600 mt-1"><?php echo e($referralProgram->description); ?></p>
                <?php endif; ?>
            </div>
            <div class="flex gap-2">
                <a href="<?php echo e(route('admin.referral-programs.edit', $referralProgram)); ?>" class="px-4 py-2 rounded-xl bg-amber-500 text-white text-sm font-bold hover:bg-amber-600"><i class="fas fa-edit ml-1"></i> تعديل</a>
                <a href="<?php echo e(route('admin.referral-programs.index')); ?>" class="px-4 py-2 rounded-xl bg-slate-100 text-slate-700 text-sm font-semibold">رجوع</a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/referral-programs/show.blade.php ENDPATH**/ ?>