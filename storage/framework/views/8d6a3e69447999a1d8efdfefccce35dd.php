    ...
    <section class="rounded-2xl bg-white border border-slate-200 shadow-lg overflow-hidden">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 px-6 pb-6">
            <div class="rounded-xl border border-emerald-200 bg-emerald-50 p-4">
                ...
                <p class="text-xl font-black text-emerald-900 mt-1"><?php echo e(number_format($stats['from_revenue_amount'] ?? 0, 2)); ?> ج.م</p>
            </div>
            <div class="rounded-xl border border-amber-200 bg-amber-50 p-4">
                <p class="text-xs font-semibold text-amber-800">من جيب الشركة (تمويل ذاتي)</p>
                <p class="text-xl font-black text-amber-900 mt-1"><?php echo e(number_format($stats['out_of_pocket_amount'] ?? 0, 2)); ?> ج.م</p>
                <p class="text-[11px] text-amber-700 mt-1">هذا الشهر: <?php echo e(number_format($stats['this_month_pocket'] ?? 0, 2)); ?> ج.م</p>
            </div>
        </div>
    </section>
    <?php endif; ?>
            ...
            <table class="w-full">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase"><?php echo e(__('مصدر التمويل')); ?></th>
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-xs">
                            <?php if(($expense->funding_source ?? 'revenue') === 'out_of_pocket'): ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/expenses/index.blade.php ENDPATH**/ ?>