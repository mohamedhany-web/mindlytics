            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <span class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-bold border-2
                        ...
                        <?php elseif($employeeTask->task_type === 'design'): ?> bg-fuchsia-50 text-fuchsia-800 border-fuchsia-200
                        <?php elseif($employeeTask->task_type === 'design_moderator_delivery'): ?> bg-indigo-50 text-indigo-800 border-indigo-200
                            ...
                            <?php $__currentLoopData = $deliverables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $deliverable): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="border-b border-gray-100 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="py-3 px-3 text-sm max-w-[220px]">
                                        ...
                                        <?php elseif($deliverable->publicFileUrl()): ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/employee-tasks/show.blade.php ENDPATH**/ ?>