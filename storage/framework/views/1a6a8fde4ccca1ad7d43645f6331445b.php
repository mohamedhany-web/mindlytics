                    ...
                    <div class="flex flex-wrap gap-2">
                        <?php $__currentLoopData = $employeeJobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="inline-flex items-center gap-2 rounded-lg border border-violet-100 bg-violet-50/50 px-3 py-1.5 text-xs">
                                <input type="checkbox" name="employee_job_ids[]" value="<?php echo e($job->id); ?>" class="rounded border-gray-300 text-violet-600">
                                <span class="font-semibold text-gray-800"><?php echo e($job->name); ?></span>
                            </label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                        ...
                        <div class="flex flex-wrap items-start justify-between gap-3">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <?php endif; ?>
                                    <?php if($plat->employeeJobs->isNotEmpty()): ?>
                                        <div class="flex flex-wrap gap-1 mt-2">
                                            <?php $__currentLoopData = $plat->employeeJobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span class="inline-flex px-2 py-0.5 rounded-md text-[10px] font-bold bg-violet-100 text-violet-800 border border-violet-200"><?php echo e($job->name); ?></span>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        <?php $__currentLoopData = $employeeJobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="inline-flex items-center gap-2 rounded-lg border px-2 py-1 text-xs">
                                                <input type="checkbox" name="employee_job_ids[]" value="<?php echo e($job->id); ?>" class="rounded" <?php if($plat->employeeJobs->contains('id', $job->id)): echo 'checked'; endif; ?>>
                                                <?php echo e($job->name); ?>
            ...
            <form method="post" action="<?php echo e(route('employee.marketing-plans.events.store', $plan)); ?>" class="grid grid-cols-1 md:grid-cols-12 gap-3 rounded-xl border border-slate-200 bg-slate-50/50 p-4">
                ...
                <div class="md:col-span-4">
                    ...
                    <select name="content_type" required class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm">
                        <?php $__currentLoopData = \App\Services\MarketingPlanEventAutomationService::contentTypeLabels(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($k); ?>" <?php if($k === 'post'): echo 'selected'; endif; ?>><?php echo e($l); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <?php $__empty_1 = true; $__currentLoopData = $plan->calendarEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="align-top hover:bg-slate-50/80">
                                ...
                                <td class="px-3 py-2 text-xs font-medium"><?php echo e($contentTypes[$ev->content_type] ?? $ev->content_type ?? '—'); ?></td>
                                <td class="px-3 py-2">
                                    <?php if($ev->platform): ?>
                                ...
                                <td class="px-3 py-2 text-xs"><?php echo e($ev->assignee?->name ?? '—'); ?></td>
                                <td class="px-3 py-2 text-xs">
                                    <?php if($ev->employeeTask): ?>
                                        <a href="<?php echo e(route('employee.tasks.show', $ev->employeeTask)); ?>" class="text-violet-700 font-bold">#<?php echo e($ev->employeeTask->id); ?></a>
                                    <?php else: ?> — <?php endif; ?>
                                </td>
                                <td class="px-3 py-2 text-xs">
                                ...
                                <td class="px-3 py-2 whitespace-nowrap">
                                    <details>
                                        ...
                                        <form method="post" action="<?php echo e(route('employee.marketing-plans.events.update', [$plan, $ev])); ?>" class="mt-2 space-y-2 p-3 bg-white border border-gray-200 rounded-lg min-w-[240px]">
                                            ...
                                            <label class="flex items-center gap-1 text-xs"><input type="checkbox" name="requires_confirmation" value="1" <?php if($ev->requires_confirmation): echo 'checked'; endif; ?> class="rounded"> يتطلب تأكيد تنفيذ</label>
...
<?php echo $__env->make('layouts.employee', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mindly tics\Mindlytics\resources\views\employee\marketing-plans\show.blade.php ENDPATH**/ ?>