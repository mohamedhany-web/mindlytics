...
<div class="p-4 md:p-6 space-y-6" style="background:#f8fafc;min-height:100vh;">
    ...
    <div class="rounded-2xl border border-gray-200 bg-white shadow-sm p-5 space-y-4">
        <div class="flex flex-wrap items-center justify-between gap-3">
            ...
            <span class="text-xs text-gray-500">قياس الالتزام بعد التنبيه (اليوم)</span>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div class="rounded-xl border border-indigo-200 bg-indigo-50/60 p-4">
                <p class="text-xs font-bold text-indigo-700">إشعارات مرسلة اليوم</p>
                <p class="text-2xl font-black text-indigo-900 tabular-nums"><?php echo e((int) ($reminderMonitoringSummary['sent_today_total'] ?? 0)); ?></p>
            </div>
            ...
            <table class="min-w-[900px] w-full text-sm">
                <thead>
                    <tr class="bg-slate-100 text-slate-700">
                        ...
                        <th class="px-3 py-2 text-center">تم التنبيه اليوم</th>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = ($reminderMonitoringRows ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td class="px-3 py-2 text-center">
                                <?php if(($row['sent_today'] ?? 0) > 0): ?>
                                    <span class="inline-flex px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-700 text-xs font-bold">نعم</span>
                                <?php else: ?>
                                    <span class="inline-flex px-2 py-0.5 rounded-full bg-slate-100 text-slate-600 text-xs font-bold">لا</span>
                                <?php endif; ?>
                            </td>
