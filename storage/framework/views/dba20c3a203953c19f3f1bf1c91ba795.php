                    ...
                    <div>
                        ...
                        <select name="branch_id"
                            ...
                            <?php $__currentLoopData = $branches ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($branch->id); ?>" <?php echo e((string) old('branch_id', $defaultBranchId ?? '') === (string) $branch->id ? 'selected' : ''); ?>><?php echo e($branch->name); ?> <?php if($branch->slug): ?> (<?php echo e($branch->slug); ?>) <?php endif; ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="space-y-4">
                    <label class="inline-flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="public_booking_enabled" value="1" <?php echo e(old('public_booking_enabled') ? 'checked' : ''); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="datetime-local" name="booking_opens_at" value="<?php echo e(old('booking_opens_at')); ?>"
                                   class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">نهاية الحجز</label>
                            <input type="datetime-local" name="booking_closes_at" value="<?php echo e(old('booking_closes_at')); ?>"
                                   class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                        </div>
                    </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <label class="inline-flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="student_online_portal_enabled" value="1" <?php echo e(old('student_online_portal_enabled') ? 'checked' : ''); ?>
                ...
                <label class="inline-flex items-center gap-2 cursor-pointer mt-4">
                    <input type="checkbox" name="online_only" value="1" <?php echo e(old('online_only') ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/offline-courses/create.blade.php ENDPATH**/ ?>