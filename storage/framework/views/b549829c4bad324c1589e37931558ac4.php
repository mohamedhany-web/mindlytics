            ...
            <div class="grid sm:grid-cols-2 gap-3 mt-3 text-sm">
                ...
                <div class="rounded-xl border border-sky-200 bg-sky-50/50 p-4 sm:col-span-2">
                    ...
                    <div class="flex flex-wrap items-center gap-2 mt-1">
                        <code id="sm-oauth-redirect-uri" class="flex-1 min-w-0 text-xs dir-ltr break-all bg-white px-3 py-2 rounded-lg border border-sky-200"><?php echo e($config['oauth_redirect_url'] ?? ''); ?></code>
                        ...
                        <li>
                            ...
                            <ul class="list-disc list-inside mr-4 mt-1 text-xs text-slate-600 space-y-1">
                                ...
                                <li>Valid OAuth Redirect URIs — أضف بالضبط:
                                    <code class="block dir-ltr text-xs bg-amber-50 border border-amber-200 rounded-lg px-3 py-2 mt-1 break-all"><?php echo e($config['oauth_redirect_url'] ?? ''); ?></code>
                                </li>
