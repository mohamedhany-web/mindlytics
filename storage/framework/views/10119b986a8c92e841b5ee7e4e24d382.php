    ...
    <div class="bg-gradient-to-br from-violet-500 via-violet-600 to-sky-600 rounded-3xl shadow-xl text-white p-8 relative overflow-hidden">
        ...
        <div class="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <div class="flex flex-wrap gap-3 justify-end">
                <a href="<?php echo e(route('admin.installments.agreements.index')); ?>" class="inline-flex items-center gap-2 px-5 py-3 rounded-2xl bg-white/15 text-white font-semibold border border-white/30 hover:bg-white/25 transition-all">
                    <i class="fas fa-arrow-right"></i>
                    الاتفاقيات
                </a>
                <a href="<?php echo e(route('admin.installments.agreements.create')); ?>" class="inline-flex items-center gap-2 px-5 py-3 rounded-2xl bg-white text-violet-700 font-semibold shadow-lg hover:shadow-xl transition-all">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/installments/agreements/manual-booking.blade.php ENDPATH**/ ?>