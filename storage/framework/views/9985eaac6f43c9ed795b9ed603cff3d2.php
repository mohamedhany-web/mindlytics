                                ...
                                <div class="space-y-2">
                                    ...
                                    <select name="branch_id"
                                        ...
                                        <?php $__currentLoopData = $branches ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($branch->id); ?>" <?php echo e((string) old('branch_id', $defaultBranchId ?? '') === (string) $branch->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <textarea name="description_en" rows="4" dir="ltr"
                                              class="w-full rounded-2xl border border-gray-200 bg-white px-4 py-3 text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition"
                                              placeholder="Course description in English"><?php echo e(old('description_en')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/advanced-courses/create.blade.php ENDPATH**/ ?>