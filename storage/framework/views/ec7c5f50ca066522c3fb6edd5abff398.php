                        ...
                        <div class="space-y-2 flex-1">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <?php if($track->branch): ?>
                                        <p class="text-xs text-sky-600 font-medium mt-1"><i class="fas fa-code-branch ml-1"></i><?php echo e($track->branch->name); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/academic-years/index.blade.php ENDPATH**/ ?>