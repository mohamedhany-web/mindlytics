                        ...
                        <div class="space-y-2 flex-1">
                            ...
                            <?php if($user->branch): ?>
                                <p class="text-slate-900">
                                    <a href="<?php echo e(route('admin.branches.show', $user->branch)); ?>" class="text-blue-600 hover:underline font-semibold"><?php echo e($user->branch->name); ?></a>
                                    <span class="text-slate-500 text-sm mr-1">(<?php echo e($user->branch->slug); ?>)</span>
                                </p>
                            <?php else: ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/users/show.blade.php ENDPATH**/ ?>