<div class="bg-white rounded-2xl border-2 border-gray-200 p-6 shadow-lg"
    ...
    <?php if(isset($pattern->pattern_data['code_example'])): ?>
        <div class="mb-6">
            ...
            <div class="bg-gray-900 text-green-400 rounded-xl p-4 font-mono text-sm overflow-x-auto">
                <pre><?php echo e($pattern->pattern_data['code_example']); ?></pre>
            </div>
        </div>
    <?php endif; ?>
    
    <?php if(isset($pattern->pattern_data['explanation'])): ?>
        <div class="mb-6">
            ...
            <div class="bg-blue-50 border-r-4 border-blue-500 rounded-xl p-4 whitespace-pre-wrap">
                <?php echo e($pattern->pattern_data['explanation']); ?>
...
function snippetHandler() {
    return {
        ...
        init() {
            ...
            <?php if(isset($pattern->pattern_data['code_example'])): ?>
                this.originalCode = <?php echo json_encode($pattern->pattern_data['code_example'], 15, 512) ?>;
...
<?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/student/learning-patterns/types/code_snippet.blade.php ENDPATH**/ ?>