...
<div class="w-full space-y-6">
    ...
    <?php echo $__env->make('admin.scholarships._header', [
        ...
        'icon' => 'fas fa-edit',
        'actions' => '<a href="' . route('admin.scholarships.programs.show', $program) . '" class="' . $schBtnSecondary . '"><i class="fas fa-arrow-right"></i><span>رجوع للتفاصيل</span></a>',
    ], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <section class="<?php echo e($schSectionClass); ?> w-full">
