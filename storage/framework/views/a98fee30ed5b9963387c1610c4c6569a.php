<?php $__env->startSection('title', $pageTitle . ' — Mindlytics Community'); ?>
...
<div class="w-full min-h-screen p-3 sm:p-4 md:p-6 lg:p-8 space-y-4 sm:space-y-6" style="background: #f8fafc;">
        ...
        <div class="relative z-10 flex flex-col xl:flex-row xl:items-start gap-8">
            <div class="flex items-start gap-5 min-w-0 flex-1">
                <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl flex items-center justify-center shadow-xl shrink-0"
                    ...
                    <i class="fas fa-<?php echo e($icon); ?> text-white text-2xl sm:text-3xl"></i>
                </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 w-full">
        <a href="<?php echo e(route('admin.mobile-app.edit')); ?>" class="rounded-2xl p-5 sm:p-6 border-2 border-blue-200/50 shadow-lg hover:shadow-xl hover:border-blue-300/70 transition-all duration-300 block group"
    ...
    <div class="rounded-2xl border-2 border-slate-200/80 bg-white p-5 sm:p-6 shadow-lg w-full">
        ...
        <div class="flex flex-wrap gap-2 sm:gap-3">
            <a href="<?php echo e(route('admin.mobile-app.notifications')); ?>" class="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-violet-50 hover:border-violet-200 hover:text-violet-900 transition-colors <?php echo e(request()->routeIs('admin.mobile-app.notifications') ? 'bg-violet-100 border-violet-300 text-violet-900' : ''); ?>"><i class="fas fa-bell text-violet-600"></i> إشعارات</a>
            ...
            <a href="<?php echo e(route('admin.mobile-app.links')); ?>" class="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-violet-50 hover:border-violet-200 hover:text-violet-900 transition-colors <?php echo e(request()->routeIs('admin.mobile-app.links') ? 'bg-violet-100 border-violet-300 text-violet-900' : ''); ?>"><i class="fas fa-link text-indigo-600"></i> الروابط</a>
            <a href="<?php echo e(route('admin.mobile-app.appearance')); ?>" class="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-violet-50 hover:border-violet-200 hover:text-violet-900 transition-colors <?php echo e(request()->routeIs('admin.mobile-app.appearance') ? 'bg-violet-100 border-violet-300 text-violet-900' : ''); ?>"><i class="fas fa-palette text-pink-600"></i> المظهر</a>
            <a href="<?php echo e(route('admin.mobile-app.edit')); ?>" class="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-violet-50 hover:border-violet-200 hover:text-violet-900 transition-colors <?php echo e(request()->routeIs('admin.mobile-app.edit') ? 'bg-violet-100 border-violet-300 text-violet-900' : ''); ?>"><i class="fas fa-home text-blue-600"></i> الصفحة الرئيسية</a>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/mobile-app/section-placeholder.blade.php ENDPATH**/ ?>