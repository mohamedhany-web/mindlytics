        ...
        <ul class="space-y-2">
            ...
            <li x-data="{ open: <?php echo e($salesMenuOpen ? 'true' : 'false'); ?> }">
                ...
                <ul x-show="open" x-transition x-cloak class="admin-sidebar-sub">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.sales.sales-teams.index')); ?>"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white <?php echo e(request()->routeIs('admin.sales.sales-teams.*') ? 'bg-emerald-600/30 text-white font-semibold border-r-2 border-emerald-400' : ''); ?>">
                            <i class="fas fa-users-cog w-4"></i>
                            <span>فرق المبيعات</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('admin.sales.team-daily-reports.index')); ?>"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white <?php echo e(request()->routeIs('admin.sales.team-daily-reports.*') ? 'bg-emerald-600/30 text-white font-semibold border-r-2 border-emerald-400' : ''); ?>">
                    ...
                    <li>
                        <?php $pendingWinApprovals = \App\Models\SalesLead::pendingWinApproval()->count(); ?>
                        <a href="<?php echo e(route('admin.sales.win-approvals.index')); ?>"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white <?php echo e(request()->routeIs('admin.sales.win-approvals.*') ? 'bg-emerald-600/30 text-white font-semibold border-r-2 border-emerald-400' : ''); ?>">
                            <i class="fas fa-trophy w-4"></i>
                            <span class="flex-1">موافقة صفقات Win</span>
                            <?php if($pendingWinApprovals > 0): ?>
                                <span class="text-[10px] font-black bg-amber-500 text-white px-1.5 py-0.5 rounded-full min-w-[1.25rem] text-center"><?php echo e($pendingWinApprovals); ?></span>
                            <?php endif; ?>
                        </a>
                    </li>
                    <li>
            ...
            <li x-data="{ open: <?php echo e($whatsappMenuOpen ? 'true' : 'false'); ?> }" class="relative">
                ...
                <ul x-show="open" x-transition x-cloak class="admin-sidebar-sub">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.whatsapp.excel-campaign')); ?>"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white <?php echo e(request()->routeIs('admin.whatsapp.excel-campaign*') ? 'bg-emerald-600/30 text-white font-semibold border-r-2 border-emerald-400' : ''); ?>">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.whatsapp.reports')); ?>"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white <?php echo e(request()->routeIs('admin.whatsapp.reports') ? 'bg-emerald-600/30 text-white font-semibold border-r-2 border-emerald-400' : ''); ?>">
            ...
            <li x-data="{ open: <?php echo e($scholarshipsMenuOpen ? 'true' : 'false'); ?> }">
                ...
                <ul x-show="open" x-transition x-cloak class="admin-sidebar-sub">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.scholarships.groups.index')); ?>"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white <?php echo e(request()->routeIs('admin.scholarships.groups.*') ? 'bg-violet-600/30 text-white font-semibold border-r-2 border-violet-400' : ''); ?>">
                            <i class="fas fa-layer-group w-4"></i>
            ...
            <li x-data="{ open: <?php echo e($employeesOpen ? 'true' : 'false'); ?> }">
                ...
                <ul x-show="open" x-transition x-cloak class="admin-sidebar-sub">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.work-schedules.index')); ?>"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white <?php echo e(request()->routeIs('admin.work-schedules.*') ? 'bg-indigo-600/30 text-white font-semibold border-r-2 border-indigo-400' : ''); ?>">
                            <i class="fas fa-clock w-4"></i>
                            <span>مواعيد العمل</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('admin.employee-attendance.index')); ?>"
                           @click="if (window.innerWidth < 1024) { $dispatch('close-sidebar'); }"
                           class="flex items-center gap-2 px-4 py-2 text-sm rounded-lg hover:bg-slate-700/50 transition-all duration-300 text-slate-300 hover:text-white <?php echo e(request()->routeIs('admin.employee-attendance.*') ? 'bg-teal-600/30 text-white font-semibold border-r-2 border-teal-400' : ''); ?>">
