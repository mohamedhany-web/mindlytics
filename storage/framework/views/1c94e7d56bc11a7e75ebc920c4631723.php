<?php $__env->startSection('title', __('student.portfolio_create_title')); ?>
...
<div class="oc">
    <header class="oc-chrome">
        <div>
            <nav class="oc-crumb" aria-label="<?php echo e(__('student.portfolio_create_title')); ?>">
                <a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('student.learning_center')); ?></a>
                <span aria-hidden="true">/</span>
                <a href="<?php echo e(route('student.portfolio.index')); ?>"><?php echo e(__('student.my_projects_title')); ?></a>
                <span aria-hidden="true">/</span>
                <span style="color:var(--ml-ink);font-weight:700"><?php echo e(__('student.portfolio_create_title')); ?></span>
            </nav>
            <h1><?php echo e(__('student.portfolio_create_title')); ?></h1>
            <p class="sub"><?php echo e(__('student.portfolio_create_subtitle')); ?></p>
        </div>
    </header>
    ...
    <section class="oc-panel" style="margin-bottom:16px">
        <p class="oc-label"><i class="fas fa-lightbulb" style="color:var(--ml-teal-deep);margin-inline-end:6px"></i><?php echo e(__('student.portfolio_ideas_title')); ?></p>
        <p style="margin:0;font-size:12px;color:var(--ml-muted);line-height:1.55"><?php echo e(__('student.portfolio_ideas_hint')); ?></p>
        <div class="pf-ideas">
            <?php $__currentLoopData = $ideas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idea): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <span><?php echo e($idea); ?></span>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </section>

    <section class="oc-panel">
        <p class="oc-label"><?php echo e(__('student.portfolio_form_heading')); ?></p>
        <form action="<?php echo e(route('student.portfolio.store')); ?>" method="POST" enctype="multipart/form-data" class="pf-form">
            <?php echo csrf_field(); ?>

            <div class="field">
                <label for="pf-title"><?php echo e(__('student.portfolio_title_label')); ?> <span class="req">*</span></label>
                <input id="pf-title" type="text" name="title" value="<?php echo e(old('title')); ?>" required
                       placeholder="<?php echo e(__('student.portfolio_title_placeholder')); ?>">
            </div>

            <div class="field">
                <label><?php echo e(__('student.portfolio_type_label')); ?></label>
                <div class="pf-types">
                    <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $meta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="pf-type">
                            <input type="radio" name="project_type" value="<?php echo e($value); ?>" <?php echo e(old('project_type') == $value ? 'checked' : ''); ?>>
                            <span class="box">
            ...
            <div class="field">
                <label for="pf-desc"><?php echo e(__('student.portfolio_desc_label')); ?></label>
                <textarea id="pf-desc" name="description" rows="3"
                          placeholder="<?php echo e(__('student.portfolio_desc_placeholder')); ?>"><?php echo e(old('description')); ?></textarea>
            </div>

            <div class="pf-grid-4" style="margin-bottom:14px">
                <div class="field" style="margin:0">
                    <label for="pf-github"><i class="fab fa-github" style="margin-inline-end:4px"></i><?php echo e(__('student.portfolio_github_label')); ?></label>
                    <input id="pf-github" type="url" name="github_url" value="<?php echo e(old('github_url')); ?>" placeholder="https://github.com/...">
                </div>
                <div class="field" style="margin:0">
                    <label for="pf-live"><?php echo e(__('student.portfolio_live_url_label')); ?></label>
                    <input id="pf-live" type="url" name="project_url" value="<?php echo e(old('project_url')); ?>" placeholder="https://demo.example.com">
                </div>
                <div class="field" style="margin:0">
                    <label for="pf-path">
                        <?php echo e(__('student.portfolio_path_label')); ?>

                        <span class="hint"><?php echo e(__('student.portfolio_path_hint')); ?></span>
                    </label>
                    <select id="pf-path" name="academic_year_id">
                        <option value=""><?php echo e(__('student.portfolio_path_placeholder')); ?></option>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <option value="" disabled><?php echo e(__('student.portfolio_path_empty')); ?></option>
                        <?php endif; ?>
                    </select>
                </div>
                <div class="field" style="margin:0">
                    <label for="pf-course">
                        <?php echo e(__('student.portfolio_course_label')); ?>

                        <span class="hint"><?php echo e(__('student.portfolio_path_hint')); ?></span>
                    </label>
                    <select id="pf-course" name="advanced_course_id">
                        <option value=""><?php echo e(__('student.portfolio_course_placeholder')); ?></option>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <option value="" disabled><?php echo e(__('student.portfolio_course_empty')); ?></option>
                        <?php endif; ?>
                    </select>
                </div>
            </div>
            ...
            <div class="field">
                <label for="portfolio-images">
                    <?php echo e(__('student.portfolio_images_label')); ?>

                    <span class="hint"><?php echo e(__('student.portfolio_images_hint')); ?></span>
                </label>
                <div class="pf-drop">
                    <input type="file" name="images[]" accept="image/*" multiple id="portfolio-images" data-max="5">
                    <p class="hint" style="margin:8px 0 0" id="images-hint"><?php echo e(__('student.portfolio_images_select')); ?></p>
                </div>
            </div>

            <div class="pf-actions">
                <a href="<?php echo e(route('student.portfolio.index')); ?>" class="oc-btn oc-btn-quiet"><?php echo e(__('student.portfolio_cancel')); ?></a>
                <button type="submit" class="oc-btn">
                    <i class="fas fa-upload text-xs"></i> <?php echo e(__('student.portfolio_submit')); ?>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var msgSelect = <?php echo json_encode(__('student.portfolio_images_select'), 15, 512) ?>;
    var msgSelected = <?php echo json_encode(__('student.portfolio_images_selected'), 15, 512) ?>;
    var msgTrimmed = <?php echo json_encode(__('student.portfolio_images_trimmed'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.student-dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mindly tics\Mindlytics\resources\views\student\portfolio\create.blade.php ENDPATH**/ ?>