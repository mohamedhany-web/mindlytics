...
<?php $__env->startSection('title', 'تعديل الورشة'); ?>
...
<div class="p-6 lg:p-8">
    <div class="mb-6">
        <h1 class="text-2xl font-black text-slate-900 flex items-center gap-2">
            ...
            <span>تعديل الورشة: <?php echo e($workshop->title); ?></span>
        </h1>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        <form method="POST" action="<?php echo e(route('admin.workshops.update', $workshop)); ?>" class="px-5 py-6 sm:px-8 lg:px-10 space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="space-y-2">
                    ...
                    <input type="text" id="title" name="title" value="<?php echo e(old('title', $workshop->title)); ?>"
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" id="location" name="location" value="<?php echo e(old('location', $workshop->location)); ?>"
                           class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/70 focus:border-blue-500"
                ...
                <div class="space-y-2">
                    ...
                    <input type="url" id="whatsapp_group_link" name="whatsapp_group_link"
                           value="<?php echo e(old('whatsapp_group_link', $workshop->whatsapp_group_link ?? '')); ?>"
                           class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/70 focus:border-blue-500"
                           placeholder="https://chat.whatsapp.com/..." dir="ltr">
                    <p class="text-xs text-slate-500">يُستخدم في قوالب ترحيب الورشة. الصق الرابط كما هو — يُزال تلقائياً أي جزء مثل <code dir="ltr">?mode=gi_t</code> قبل إرسال القالب لـ Meta.</p>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <label class="inline-flex items-center gap-2 text-sm text-slate-700">
                        <input type="checkbox" name="is_active" value="1" class="rounded border-slate-300 text-blue-600 focus:ring-blue-500"
                               <?php echo e(old('is_active', $workshop->is_active) ? 'checked' : ''); ?>>
                ...
                <div class="space-y-2">
                    ...
                    <select id="mode" name="mode"
                            class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/70 focus:border-blue-500">
                        <option value="online" <?php echo e(old('mode', $workshop->mode) === 'online' ? 'selected' : ''); ?>>أونلاين (عن بُعد)</option>
                        <option value="offline" <?php echo e(old('mode', $workshop->mode) === 'offline' ? 'selected' : ''); ?>>في المكان (أوفلاين)</option>
                        <option value="both" <?php echo e(old('mode', $workshop->mode) === 'both' ? 'selected' : ''); ?>>إتاحة الاختيار (أونلاين أو أوفلاين)</option>
                    </select>
                ...
                <div class="space-y-2">
                    ...
                    <input type="datetime-local" id="starts_at" name="starts_at"
                           value="<?php echo e(old('starts_at', optional($workshop->starts_at)->format('Y-m-d\TH:i'))); ?>"
                           class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/70 focus:border-blue-500">
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <input type="datetime-local" id="ends_at" name="ends_at"
                           value="<?php echo e(old('ends_at', optional($workshop->ends_at)->format('Y-m-d\TH:i'))); ?>"
                           class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/70 focus:border-blue-500">
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" id="max_seats" name="max_seats" value="<?php echo e(old('max_seats', $workshop->max_seats)); ?>" min="0"
                           class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/70 focus:border-blue-500">
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" id="seats_online" name="seats_online" value="<?php echo e(old('seats_online', $workshop->seats_online)); ?>" min="0"
                           class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/70 focus:border-blue-500">
                ...
                <div class="space-y-2">
                    ...
                    <input type="number" id="seats_offline" name="seats_offline" value="<?php echo e(old('seats_offline', $workshop->seats_offline)); ?>" min="0"
                           class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/70 focus:border-blue-500">
            ...
            <div class="space-y-2">
                ...
                <textarea id="description" name="description" rows="5"
                          ...
                          placeholder="اكتب هنا محاور الورشة، المتطلبات، الأدوات التي سيحتاجها الطالب، وسطر عن المدرب."><?php echo e(old('description', $workshop->description)); ?></textarea>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mindly tics\Mindlytics\resources\views\admin\workshops\edit.blade.php ENDPATH**/ ?>