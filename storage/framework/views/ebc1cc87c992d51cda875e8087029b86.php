        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full py-16 lg:py-20">
            <div class="text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center fade-in-up" style="animation-delay: 0.5s;">
                    ...
                    <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center justify-center gap-2 bg-white text-purple-600 px-8 py-4 rounded-full font-bold text-base border-2 border-purple-600 hover:bg-purple-50 transition-all duration-300">
                        <i class="fas fa-home"></i>
                        <span><?php echo e(__('errors.back_dashboard')); ?></span>
                    </a>
                    <?php else: ?>
                    <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center justify-center gap-2 bg-white text-purple-600 px-8 py-4 rounded-full font-bold text-base border-2 border-purple-600 hover:bg-purple-50 transition-all duration-300">
                        <i class="fas fa-user-plus"></i>
                        <span>صفحة التسجيل</span>
                    </a>
                    <a href="<?php echo e(url('/')); ?>" class="inline-flex items-center justify-center gap-2 bg-white text-slate-600 px-8 py-4 rounded-full font-bold text-base border-2 border-slate-200 hover:bg-slate-50 transition-all duration-300">
                        <i class="fas fa-home"></i>
                        <span>الرئيسية</span>
                    </a>
                    <?php endif; ?>
...
<?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/errors/429.blade.php ENDPATH**/ ?>