...
<section class="hero-careers min-h-[38vh] flex items-center relative pt-24 pb-14 lg:pt-28 lg:pb-16">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <a href="<?php echo e(route('careers.index')); ?>" class="inline-flex items-center gap-2 text-blue-100 hover:text-white text-sm font-semibold mb-5 transition-colors">
        ...
        <?php if($meta !== []): ?>
            <div class="flex flex-wrap gap-2">
                <?php if($job->department): ?>
                    <span class="job-meta-pill"><i class="fas fa-building"></i><?php echo e($job->department); ?></span>
                <?php endif; ?>
                <?php if($job->location): ?>
                    <span class="job-meta-pill"><i class="fas fa-map-marker-alt"></i><?php echo e($job->location); ?></span>
                <?php endif; ?>
                <?php if($job->employment_type): ?>
                    <span class="job-meta-pill"><i class="fas fa-clock"></i><?php echo e($job->employment_type); ?></span>
                <?php endif; ?>
            </div>
        <?php endif; ?>
    </div>
        ...
        <div class="grid lg:grid-cols-12 gap-8 items-start">
            ...
            <div class="lg:col-span-7">
                ...
                <div class="bg-white rounded-2xl shadow-md border-2 border-slate-100 overflow-hidden" x-data="{ cvName: '', attachCount: 0 }">
                    ...
                    <form method="post" action="<?php echo e(route('careers.apply', $job)); ?>" enctype="multipart/form-data" class="p-6 space-y-5">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="grid sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input name="email" type="email" value="<?php echo e(old('email')); ?>" placeholder="name@email.com" class="careers-input">
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            <textarea name="cover_letter" rows="4" placeholder="لماذا ترغب بالانضمام لهذه الوظيفة؟" class="careers-input resize-y min-h-[100px]"><?php echo e(old('cover_letter')); ?></textarea>
                        </div>
            ...
            <aside class="lg:col-span-5 space-y-6">
                        ...
                        <div class="space-y-4 text-sm text-slate-700 leading-relaxed">
                            <?php if($job->description): ?>
                                <div>
                                    ...
                                    <div class="whitespace-pre-line"><?php echo nl2br(e($job->description)); ?></div>
                                </div>
                            <?php endif; ?>
                            <?php if($job->requirements): ?>
                                <div class="pt-4 border-t border-slate-100">
                                    <p class="text-xs font-bold text-slate-500 uppercase tracking-wide mb-2">المتطلبات</p>
                                    <div class="whitespace-pre-line"><?php echo nl2br(e($job->requirements)); ?></div>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <div class="rounded-2xl border-2 border-blue-100 bg-gradient-to-br from-blue-50 to-white p-5">
                    ...
                    <a href="<?php echo e(route('public.contact')); ?>" class="inline-flex items-center gap-2 mt-3 text-sm font-bold text-blue-700 hover:text-blue-900">
                        صفحة التواصل
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mindly tics\Mindlytics\resources\views\careers\show.blade.php ENDPATH**/ ?>