        ...
        <form id="accessVisibilityForm" onsubmit="saveAccessVisibility(event)">
            ...
            <div id="accessVisibleStudentsWrap" class="hidden mb-4">
                ...
                <div class="max-h-48 overflow-y-auto rounded-xl border border-slate-200 p-3 space-y-2 bg-slate-50">
                    <?php $__empty_1 = true; $__currentLoopData = ($scholarshipStudents ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <label class="flex items-center gap-2 p-2 rounded-lg bg-white border border-slate-200 cursor-pointer hover:border-sky-300">
                            <input type="checkbox" class="access-student-cb w-4 h-4 text-sky-600 rounded border-slate-300" value="<?php echo e($student->id); ?>">
                            <span class="text-sm text-slate-800"><?php echo e($student->name); ?><?php if($student->email): ?> <span class="text-xs text-slate-500">— <?php echo e($student->email); ?></span><?php endif; ?></span>
                        </label>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div id="accessVisibleGroupsWrap" class="hidden mb-4">
                ...
                <div class="max-h-48 overflow-y-auto rounded-xl border border-slate-200 p-3 space-y-2 bg-slate-50">
                    <?php $__empty_1 = true; $__currentLoopData = ($scholarshipGroups ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <label class="flex items-center gap-2 p-2 rounded-lg bg-white border border-slate-200 cursor-pointer hover:border-indigo-300">
                            <input type="checkbox" class="access-group-cb w-4 h-4 text-indigo-600 rounded border-slate-300" value="<?php echo e($group->id); ?>">
                            <span class="text-sm text-slate-800"><?php echo e($group->name); ?> <span class="text-xs text-slate-500">(<?php echo e($group->members_count ?? $group->members()->count()); ?> طالب)</span></span>
                        </label>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
function saveAccessVisibility(e) {
    ...
    const url = type === 'section'
        ...
        : `/instructor/curriculum-items/${id}/visibility`;
