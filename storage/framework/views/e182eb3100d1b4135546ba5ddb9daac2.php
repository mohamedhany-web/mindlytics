            ...
            <?php $__currentLoopData = $assignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="rounded-xl bg-white border border-slate-200 shadow-sm hover:border-sky-300 hover:shadow-md transition-all p-5 h-full flex flex-col">
                    ...
                    <div class="space-y-1.5 text-sm text-slate-500 mb-4">
                        ...
                        <?php if(!empty($assignment->course?->code)): ?>
                            <div><i class="fas fa-hashtag text-slate-400 ml-1"></i> <span class="font-semibold text-slate-700">كود الكورس:</span> <?php echo e($assignment->course->code); ?></div>
                        <?php endif; ?>
                        <?php if(!empty($assignment->course?->academicSubject?->name)): ?>
                            <div><i class="fas fa-layer-group text-indigo-500 ml-1"></i> <span class="font-semibold text-slate-700">المادة:</span> <?php echo e($assignment->course->academicSubject->name); ?></div>
                        <?php endif; ?>
                        <?php if(!empty($assignment->lesson?->title)): ?>
                        ...
                        <?php if($assignment->due_date): ?>
                            <div><i class="fas fa-calendar text-slate-400 ml-1"></i> <?php echo e($assignment->due_date->format('Y/m/d')); ?></div>
                        <?php endif; ?>
                        <div><i class="fas fa-file-upload text-violet-500 ml-1"></i> <?php echo e($assignment->submissions_count); ?> <?php echo e(__('instructor.submission_single')); ?></div>
                        <div><i class="fas fa-star text-amber-500 ml-1"></i> <?php echo e($assignment->max_score); ?> <?php echo e(__('instructor.score_marks')); ?></div>
                    </div>

                    <div class="mt-auto grid grid-cols-2 gap-2">
                        <a href="<?php echo e(route('instructor.assignments.show', $assignment)); ?>" class="inline-flex items-center justify-center gap-2 px-3 py-2 bg-sky-500 hover:bg-sky-600 text-white rounded-xl font-semibold text-sm transition-colors">
                            <i class="fas fa-eye"></i> <?php echo e(__('common.view')); ?>

                        </a>
                        <a href="<?php echo e(route('instructor.assignments.submissions', $assignment)); ?>" class="inline-flex items-center justify-center gap-2 px-3 py-2 bg-violet-500 hover:bg-violet-600 text-white rounded-xl font-semibold text-sm transition-colors">
                            <i class="fas fa-list"></i> <?php echo e(__('instructor.submissions')); ?>

                        </a>
                    </div>
                    <form method="POST" action="<?php echo e(route('instructor.assignments.destroy', $assignment)); ?>" class="mt-2">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/instructor/assignments/index.blade.php ENDPATH**/ ?>