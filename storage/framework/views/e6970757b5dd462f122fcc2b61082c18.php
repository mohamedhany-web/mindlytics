                    ...
                    <div class="flex items-center mb-6 p-4 bg-gradient-to-r from-sky-50 to-blue-50 rounded-xl border border-sky-100">
                        ...
                        <div class="mr-4 flex-1">
                            ...
                            <div class="text-sm text-gray-600 flex items-center gap-2">
                                ...
                                <span><?php echo e($message->user->role === 'student' ? __('طالب') : __('ولي أمر')); ?></span>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/messages/show.blade.php ENDPATH**/ ?>