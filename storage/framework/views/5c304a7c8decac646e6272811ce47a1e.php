            ...
            <div class="flex flex-wrap justify-between items-start gap-4">
                <div>
                    ...
                    <div class="flex flex-wrap gap-4 mt-2 text-sm text-gray-600">
                        ...
                        <?php endif; ?>
                        <span><i class="fas fa-calendar-check text-teal-500 ml-1"></i> <?php echo e($group->sessions_count ?? $group->sessions->count()); ?> جلسة — <span class="text-gray-500">موحّدة للقناتين</span></span>
                    </div>
                    <?php
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        <div class="rounded-xl border-2 border-emerald-200 bg-emerald-50/60 p-4">
                            ...
                            <p class="text-sm text-gray-800">
                                مسجّلون: <strong><?php echo e($group->offline_enrollments_count ?? 0); ?></strong>
                                — السعة: <strong><?php echo e($group->current_students ?? 0); ?>/<?php echo e($group->max_students); ?></strong>
                            </p>
                            <p class="text-xs text-gray-600 mt-1">حجز عبر الرابط: معلق <?php echo e($pendBook); ?> · متاح <?php echo e($effRem); ?></p>
                            <div class="mt-3 flex flex-wrap gap-2">
                                <a href="<?php echo e(route('admin.offline-courses.enrollments.index', [$offlineCourse, 'channel' => 'offline'])); ?>" class="text-xs font-semibold text-blue-700 hover:underline">تسجيلات الحضور</a>
                                <a href="<?php echo e(route('admin.offline-course-bookings.index', ['offline_course_id' => $offlineCourse->id])); ?>" class="text-xs font-semibold text-amber-800 hover:underline">حجوزات أوفلاين</a>
                            </div>
                        </div>
                        <div class="rounded-xl border-2 border-indigo-200 bg-indigo-50/60 p-4">
                            ...
                            <p class="text-sm text-gray-800">
                                مسجّلون: <strong><?php echo e($group->online_enrollments_count ?? 0); ?></strong>
                                — السعة: <strong><?php echo e($group->current_students_online ?? 0); ?>/<?php echo e($group->max_students_online); ?></strong>
                            </p>
                            <p class="text-xs text-gray-600 mt-1">حجز أونلاين: معلق <?php echo e($pendBookOnline); ?> · متاح <?php echo e($effRemOnline); ?></p>
                            <div class="mt-3 flex flex-wrap gap-2">
                                <a href="<?php echo e(route('admin.offline-courses.enrollments.index', [$offlineCourse, 'channel' => 'online'])); ?>" class="text-xs font-semibold text-indigo-800 hover:underline">تسجيلات الأونلاين</a>
                                <a href="<?php echo e(route('admin.online-course-bookings.index', ['offline_course_id' => $offlineCourse->id])); ?>" class="text-xs font-semibold text-amber-800 hover:underline">حجوزات أونلاين</a>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/offline-courses/groups/index.blade.php ENDPATH**/ ?>