                                    ...
                                    <button type="button" @click="selectSuggestedTemplate(tpl)"
                                        ...
                                        <div class="flex items-start justify-between gap-3">
                                            <div class="min-w-0">
                                                ...
                                                <p class="text-[11px] text-slate-500 mt-1" x-text="tpl.help || ''"></p>
                                            </div>
                            ...
                            <div x-show="selectedSuggested" x-cloak class="mt-4 rounded-2xl border border-slate-200 bg-white p-4 space-y-3">
                                <div class="flex items-start justify-between gap-3">
                                    <div class="min-w-0">
                                        ...
                                        <p class="text-[11px] text-slate-500 mt-1" x-text="selectedSuggested?.help || ''"></p>
                                    </div>
                                ...
                                <p class="text-[10px] text-slate-500">
                                    المتغيرات تُكتب بهذا الشكل: <code class="bg-slate-100 px-1 rounded"><?php echo e('{{name); ?>'}}</code>
                                </p>
                            </div>
                        </div>
                    </div>
