...
<div class="cs"
    ...
    <header class="cs-chrome cs-reveal">
        <div>
            <nav class="cs-crumb" aria-label="<?php echo e(__('student.mc_breadcrumb')); ?>">
        ...
        <div class="cs-signals" aria-label="<?php echo e(__('student.mc_course_status')); ?>">
            <span class="cs-signal cs-signal-live"><?php echo e(__('student.mc_active')); ?></span>
            <span class="cs-signal"><?php echo e(__('student.mc_completed_of', ['done' => $completedLessons, 'total' => $totalLessons])); ?></span>
            <span class="cs-signal cs-signal-hot"><?php echo e(__('student.mc_points', ['count' => number_format((float) ($coursePoints ?? 0), 0)])); ?></span>
        </div>
    </header>

    <section class="cs-stage cs-reveal" style="--reveal-delay:50ms" aria-label="<?php echo e(__('student.mc_continue_aria')); ?>">
        <div class="cs-stage-body">
            <div class="cs-eyebrow">
                <?php echo e(__('student.mc_next_step')); ?>

                <em><?php echo e($nextLessonTitle ? __('student.mc_kind_lesson') : __('student.mc_kind_curriculum')); ?></em>
            </div>
            <h2><?php echo e($nextLessonTitle ?? __('student.mc_start_journey')); ?></h2>
            <p class="cs-copy">
                <?php if($nextLessonTitle): ?>
                    <?php echo e(__('student.mc_resume_progress', ['pct' => $progress])); ?>

                <?php else: ?>
                    <?php echo e($course->description ? \Illuminate\Support\Str::limit(strip_tags($course->description), 140) : __('student.mc_curriculum_ready')); ?>

                <?php endif; ?>
            </p>
            <div class="cs-meter" role="progressbar" aria-valuenow="<?php echo e((int) $progress); ?>" aria-valuemin="0" aria-valuemax="100" aria-label="<?php echo e(__('student.mc_course_progress')); ?>">
                <i style="width:<?php echo e(min(100, (float) $progress)); ?>%"></i>
            </div>
            <div class="cs-stage-actions">
                <a class="cs-btn" href="<?php echo e($learnUrl); ?>">
                    <i class="fas fa-play text-xs"></i>
                    <?php echo e($progress > 0 ? __('student.continue_learning') : __('student.mc_start_learning')); ?>

                </a>
                <a class="cs-btn cs-btn-quiet" href="<?php echo e(route('my-courses.index')); ?>"><?php echo e(__('student.mc_back_to_courses')); ?></a>
            </div>
        </div>
        <div class="cs-cover" aria-hidden="true">
            ...
            <?php else: ?>
                <div class="ph">
                    ...
                    <span style="font-size:12px;font-weight:700"><?php echo e(__('student.mc_course_label')); ?></span>
                </div>
            <?php endif; ?>
            <span class="pct"><?php echo e($progress); ?><?php echo e(app()->getLocale() === 'ar' ? '٪' : '%'); ?></span>
        </div>
    </section>

    <div class="cs-pulse cs-reveal" style="--reveal-delay:90ms" aria-label="<?php echo e(__('student.mc_progress_summary')); ?>">
        <div>
            <span class="lbl"><?php echo e(__('student.mc_progress')); ?></span>
            <span class="val teal"><?php echo e($progress); ?><?php echo e(app()->getLocale() === 'ar' ? '٪' : '%'); ?></span>
        </div>
        <div>
            <span class="lbl"><?php echo e(__('student.mc_lessons_done')); ?></span>
            <span class="val"><?php echo e($completedLessons); ?> / <?php echo e($totalLessons); ?></span>
        </div>
        <div>
            <span class="lbl"><?php echo e(__('student.mc_points_label')); ?></span>
    ...
    <div class="cs-split cs-reveal" style="--reveal-delay:120ms">
        <section class="cs-panel" aria-label="<?php echo e(__('student.mc_about_aria')); ?>">
            <p class="cs-label"><?php echo e(__('student.mc_about')); ?></p>
            <p class="body"><?php echo e($course->description ?: __('student.mc_no_description')); ?></p>
        </section>
        <aside class="cs-panel" aria-label="<?php echo e(__('student.mc_info_aria')); ?>">
            <p class="cs-label"><?php echo e(__('student.mc_details')); ?></p>
            <ul class="cs-facts">
                <li>
                    <span class="k"><i class="fas fa-layer-group"></i> <?php echo e(__('student.mc_level')); ?></span>
                    <span class="v"><?php echo e($course->level ?? '—'); ?></span>
                </li>
                <li>
                    <span class="k"><i class="fas fa-clock"></i> <?php echo e(__('student.mc_duration')); ?></span>
                    <span class="v"><?php echo e(__('student.mc_hours', ['count' => $course->duration_hours ?? '—'])); ?></span>
                </li>
                <li>
                    <span class="k"><i class="fas fa-user-tie"></i> <?php echo e(__('student.mc_instructor')); ?></span>
    ...
    <section class="cs-curriculum cs-reveal" style="--reveal-delay:160ms" aria-label="<?php echo e(__('student.mc_curriculum_aria')); ?>">
        <p class="cs-label"><?php echo e(__('student.mc_curriculum')); ?></p>
            ...
            <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="cs-section">
                    <div class="cs-section-h">
                        ...
                        <span><?php echo e(__('student.mc_items_count', ['count' => $visibleItems->count()])); ?></span>
                    </div>
                                        ...
                                        <span class="t">
                                            ...
                                            <small>
                                                ...
                                                <?php if($item instanceof \App\Models\CourseLesson && $item->duration_minutes): ?>
                                                    · <?php echo e(__('student.mc_minutes', ['count' => $item->duration_minutes])); ?>

                                                <?php endif; ?>
                                            </small>
                                        </span>
                                        <span class="go"><?php echo e($isCompleted ? __('student.mc_review') : __('student.mc_open')); ?></span>
                                    </a>
                                </li>
                            <?php else: ?>
                                <li>
                                    <div class="cs-item <?php echo e($rowClass); ?>">
                                        ...
                                        <span class="t">
                                            <strong><?php echo e($item->title); ?></strong>
                                            <small><?php echo e(__('student.mc_locked_until_prev', ['kind' => $kind])); ?></small>
                                        </span>
                                    </div>
                                </li>
                            <?php endif; ?>
        ...
        <?php elseif($course->lessons->count() > 0): ?>
            <div class="cs-section">
                <div class="cs-section-h">
                    <strong><?php echo e(__('student.mc_lessons')); ?></strong>
                            ...
                            <li>
                                <a class="cs-item <?php echo e($rowClass); ?>" href="<?php echo e(route('my-courses.learn', $course)); ?>?lesson=<?php echo e($lesson->id); ?>">
                                    ...
                                    <span class="t">
                                        ...
                                        <small><?php echo e(__('student.mc_lesson_minutes', ['count' => $lesson->duration_minutes ?? 0])); ?></small>
                                    </span>
                                    <span class="go"><?php echo e($isCompleted ? __('student.mc_review') : __('student.mc_open')); ?></span>
                                </a>
                            </li>
                        <?php else: ?>
                            <li>
                                <div class="cs-item <?php echo e($rowClass); ?>">
                                    ...
                                    <span class="t">
                                        <strong><?php echo e($lesson->title); ?></strong>
                                        <small><?php echo e(__('student.mc_lesson_locked')); ?></small>
                                    </span>
                                </div>
                            </li>
                        <?php endif; ?>
        ...
        <?php else: ?>
            <div class="cs-empty"><?php echo e(__('student.mc_no_curriculum')); ?></div>
        <?php endif; ?>
    </section>
        ...
        <div class="curriculum-wrapper">
                ...
                <div class="controls">
                    <div class="flex items-center gap-4 flex-1">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-sm text-gray-600"><?php echo e($course->academicYear->name ?? __('student.mc_unspecified')); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="action-buttons">
                        <button @click="showSettings = !showSettings" 
                                ...
                                class="btn-control"
                                title="<?php echo e(__('student.mc_settings_title')); ?>">
                            <i class="fas fa-cog"></i>
                            <span class="hidden md:inline"><?php echo e(__('student.mc_settings')); ?></span>
                        </button>
                        <button @click="toggleFullscreen()" class="btn-control">
                            <i class="fas fa-expand"></i>
                            <span class="hidden md:inline"><?php echo e(__('student.mc_fullscreen')); ?></span>
                        </button>
                        <button @click="focusMode = false" class="btn-control btn-close">
                            <i class="fas fa-times"></i>
                            <span class="hidden md:inline"><?php echo e(__('student.mc_close')); ?></span>
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-1 overflow-hidden relative" style="width: 100%;">
                ...
                <div class="focus-main-content" style="width: 100%; flex: 1;">
                    ...
                    <div class="focus-main-content-wrapper">
                        ...
                        <div x-show="!selectedLesson" class="empty-content-state">
                            <i class="fas fa-graduation-cap"></i>
                            <h3 class="text-xl font-black text-gray-900 mb-2 mt-4"><?php echo e(__('student.mc_welcome_to', ['title' => $course->localized('title')])); ?></h3>
                            <p class="text-sm text-gray-600"><?php echo e(__('student.mc_pick_lesson')); ?></p>
                        </div>
                ...
                <div class="focus-sidebar" :class="{ 'closed': sidebarClosed, 'open': sidebarOpen }">
                    <button @click="sidebarClosed = true" class="sidebar-close-btn" title="<?php echo e(__('student.mc_close_sidebar')); ?>">
                        <i class="fas fa-times"></i>
                    </button>
                    <div class="focus-sidebar-header">
                        <div class="flex items-center justify-between mb-3">
                            <h3 class="text-white font-black text-lg"><?php echo e(__('student.mc_full_curriculum')); ?></h3>
                        ...
                        <div class="search-box relative">
                            <input type="text" 
                                   x-model="searchQuery"
                                   placeholder="<?php echo e(__('student.mc_search_lessons')); ?>"
                            ...
                            <div class="absolute <?php echo e(app()->getLocale() === 'ar' ? 'left-2' : 'right-2'); ?> top-1/2 transform -translate-y-1/2 text-gray-400">
                    ...
                    <div class="focus-sidebar-content">
                                            ...
                                            <div class="flex items-start gap-3">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    ...
                                                    <div class="curriculum-item-meta">
                                                        <?php if($item instanceof \App\Models\CourseLesson): ?>
                                                            <span><i class="fas fa-video me-1"></i> <?php echo e(__('student.mc_kind_lesson')); ?></span>
                                                            <?php if($item->duration_minutes): ?>
                                                                <span><i class="fas fa-clock me-1"></i> <?php echo e(__('student.mc_minutes', ['count' => $item->duration_minutes])); ?></span>
                                                            <?php endif; ?>
                                                        <?php elseif($item instanceof \App\Models\Assignment): ?>
                                                            <span><i class="fas fa-tasks me-1"></i> <?php echo e(__('student.mc_kind_assignment')); ?></span>
                                                            <?php if($item->due_date): ?>
                                                                <span><i class="fas fa-calendar me-1"></i> <?php echo e($item->due_date->format('Y/m/d')); ?></span>
                                                            <?php endif; ?>
                                                        <?php elseif($item instanceof \App\Models\AdvancedExam || $item instanceof \App\Models\Exam): ?>
                                                            <span><i class="fas fa-clipboard-check me-1"></i> <?php echo e(__('student.mc_kind_exam')); ?></span>
                                                            <?php if($item->start_date): ?>
                                                                <span><i class="fas fa-calendar me-1"></i> <?php echo e($item->start_date->format('Y/m/d')); ?></span>
                                                            <?php endif; ?>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                        ...
                        <?php else: ?>
                            ...
                            <div class="curriculum-section-header">
                                ...
                                <?php echo e(__('student.mc_lessons_count', ['count' => $totalLessons])); ?>
                                ...
                                <div class="curriculum-item <?php echo e($isCompleted ? 'completed' : ''); ?> <?php echo e($isCurrentLesson ? 'active' : ''); ?> <?php echo e(!$isCurrentLesson && !$isCompleted ? 'locked' : ''); ?>"
                                    ...
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="curriculum-item-meta">
                                                <span><i class="fas fa-clock me-1"></i> <?php echo e(__('student.mc_minutes', ['count' => $lesson->duration_minutes ?? 0])); ?></span>
                                                <?php if($lesson->video_url): ?>
                                                    <span><i class="fas fa-video me-1"></i> <?php echo e(__('student.mc_video')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="focus-settings-panel" :class="{ 'active': showSettings }">
            <div class="mb-4 pb-4 border-b border-gray-700">
                <h3 class="text-white font-bold text-lg mb-2">
                    ...
                    <?php echo e(__('student.mc_display_settings')); ?>
            ...
            <div class="space-y-4">
                <div>
                    <label class="text-gray-300 text-sm mb-2 block flex items-center gap-2">
                        ...
                        <?php echo e(__('student.mc_font_size')); ?>

                    </label>
                    <div class="flex gap-2">
                        <button @click="fontSize = 'small'" 
                                :class="fontSize === 'small' ? 'bg-blue-600 border-blue-400' : 'bg-gray-700 border-gray-600'"
                                class="px-3 py-1.5 rounded text-white text-sm border transition-all"><?php echo e(__('student.mc_font_small')); ?></button>
                        <button @click="fontSize = 'medium'" 
                                :class="fontSize === 'medium' ? 'bg-blue-600 border-blue-400' : 'bg-gray-700 border-gray-600'"
                                class="px-3 py-1.5 rounded text-white text-sm border transition-all"><?php echo e(__('student.mc_font_medium')); ?></button>
                        <button @click="fontSize = 'large'" 
                                :class="fontSize === 'large' ? 'bg-blue-600 border-blue-400' : 'bg-gray-700 border-gray-600'"
                                class="px-3 py-1.5 rounded text-white text-sm border transition-all"><?php echo e(__('student.mc_font_large')); ?></button>
                    </div>
                </div>
                <div class="pt-4 border-t border-gray-700">
                    <p class="text-gray-400 text-xs mb-2"><?php echo e(__('student.mc_keyboard_shortcuts')); ?></p>
                    <div class="space-y-1 text-xs text-gray-400">
                        <div class="flex justify-between">
                            <span><?php echo e(__('student.mc_shortcut_search')); ?></span>
                            <kbd class="px-2 py-0.5 bg-gray-700 rounded text-gray-300">Ctrl+F</kbd>
                        </div>
                        <div class="flex justify-between">
                            <span><?php echo e(__('student.mc_shortcut_print')); ?></span>
                            <kbd class="px-2 py-0.5 bg-gray-700 rounded text-gray-300">Ctrl+P</kbd>
                        </div>
                        <div class="flex justify-between">
                            <span><?php echo e(__('student.mc_shortcut_settings')); ?></span>
                            <kbd class="px-2 py-0.5 bg-gray-700 rounded text-gray-300">Ctrl+,</kbd>
                        </div>
                        <div class="flex justify-between">
                            <span><?php echo e(__('student.mc_shortcut_close')); ?></span>
                ...
                <button @click="showSettings = false" 
                    ...
                    <?php echo e(__('student.mc_close')); ?>
