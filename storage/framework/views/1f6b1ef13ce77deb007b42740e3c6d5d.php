                ...
                <div class="p-6 lg:p-8 space-y-6">
                    ...
                    <div class="grid sm:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="text" name="contact_hero_title" value="<?php echo e(old('contact_hero_title', $contactPage['hero_title'] ?? '')); ?>" required
                        ...
                        <div>
                            ...
                            <input type="text" name="contact_hero_subtitle" value="<?php echo e(old('contact_hero_subtitle', $contactPage['hero_subtitle'] ?? '')); ?>"
                                   class="mt-1.5 w-full rounded-xl border border-slate-200 px-3 py-2.5 text-sm">
                        </div>
                    </div>
                    <div>
                        <label class="text-sm font-bold text-slate-800">العنوان (اختياري)</label>
                        <input type="text" name="contact_address" value="<?php echo e(old('contact_address', $contactPage['address'] ?? '')); ?>"
                    ...
                    <div class="grid sm:grid-cols-3 gap-5">
                        <div>
                            ...
                            <input type="text" name="contact_phone" value="<?php echo e(old('contact_phone', $contactPage['phone'] ?? '')); ?>"
                        ...
                        <div>
                            ...
                            <input type="email" name="contact_email" value="<?php echo e(old('contact_email', $contactPage['email'] ?? '')); ?>"
                        ...
                        <div>
                            ...
                            <input type="text" name="contact_whatsapp" value="<?php echo e(old('contact_whatsapp', $contactPage['whatsapp'] ?? '')); ?>"
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            <?php $__currentLoopData = array_slice($hoursRows, 0, 5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="grid grid-cols-1 sm:grid-cols-12 gap-3 items-center rounded-xl border border-slate-200 bg-slate-50/80 p-3">
                                    <div class="sm:col-span-4">
                                        <input type="text" name="contact_hours[<?php echo e($i); ?>][label]" value="<?php echo e($row['label'] ?? ''); ?>"
                                               placeholder="اليوم / الفترة" class="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm">
                                    </div>
                                    <div class="sm:col-span-5">
                                        <input type="text" name="contact_hours[<?php echo e($i); ?>][value]" value="<?php echo e($row['value'] ?? ''); ?>"
                                    ...
                                    <label class="sm:col-span-3 inline-flex items-center gap-2 text-sm font-semibold text-slate-700 cursor-pointer">
                                        <input type="hidden" name="contact_hours[<?php echo e($i); ?>][closed]" value="0">
                                        <input type="checkbox" name="contact_hours[<?php echo e($i); ?>][closed]" value="1" class="rounded border-slate-300 text-rose-600"
                                               <?php if(!empty($row['closed'])): echo 'checked'; endif; ?>>
                                        مغلق
                                    </label>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/system-settings/index.blade.php ENDPATH**/ ?>