    ...
    <section class="rounded-3xl bg-white/95 backdrop-blur border border-slate-200 shadow-lg overflow-hidden">
        <div class="px-5 py-6 sm:px-8 lg:px-12 border-b border-slate-200 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <?php if(in_array($employeeAgreement->status, ['active', 'draft'], true)): ?>
                    <form action="<?php echo e(route('admin.employee-agreements.stop', $employeeAgreement)); ?>" method="POST" class="inline-flex flex-wrap items-center gap-2 rounded-xl border border-orange-200 bg-orange-50 px-3 py-2"
                ...
                <?php elseif($employeeAgreement->status === 'suspended'): ?>
                    <form action="<?php echo e(route('admin.employee-agreements.reactivate', $employeeAgreement)); ?>" method="POST" class="inline-block" onsubmit="return confirm('إعادة تفعيل الاتفاقية؟');">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/employee-agreements/show.blade.php ENDPATH**/ ?>