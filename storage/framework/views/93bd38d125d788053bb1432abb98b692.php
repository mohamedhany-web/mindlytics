                    ...
                    <div class="rounded-2xl border border-slate-200 bg-white shadow-sm p-6 h-full">
                        ...
                        <div class="space-y-3 text-sm text-slate-600">
                            ...
                            <div class="flex items-start gap-2">
                                ...
                                <span>
                                    <?php if($workshop->mode === 'online'): ?> حضور أونلاين
                                    <?php elseif($workshop->mode === 'offline'): ?> حضور في المكان
                                    <?php else: ?> أونلاين أو في المكان
                                    <?php endif; ?>
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-white shadow-lg p-6 sm:p-8">
                        <?php if(session('success')): ?>
                            <div class="p-5 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-800 text-sm text-center">
                                ...
                                <?php if($confirmed): ?>
                                    <p class="text-xs text-emerald-700 mt-3"><?php echo e($confirmed->name); ?> — <?php echo e($confirmed->checked_in_at?->format('Y-m-d H:i')); ?></p>
                                <?php endif; ?>
                                <?php if (! (request()->boolean('embed'))): ?>
                                    <a href="<?php echo e(url('/')); ?>" class="inline-flex items-center gap-2 mt-5 text-sm font-semibold text-blue-600 hover:text-blue-700">
...
<?php /**PATH C:\xampp\htdocs\mindly tics\Mindlytics\resources\views\public\workshop-confirm.blade.php ENDPATH**/ ?>