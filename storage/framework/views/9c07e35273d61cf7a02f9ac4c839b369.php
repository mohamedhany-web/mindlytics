...
<div class="w-full px-4 sm:px-6 lg:px-8 py-6 max-w-2xl mx-auto space-y-6">
    <div class="bg-white rounded-xl p-5 border border-gray-200 shadow-sm">
        <a href="<?php echo e(route('student.offline-courses.index')); ?>" class="text-sm text-purple-600 hover:text-purple-800 font-medium">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/student/offline-booking/form.blade.php ENDPATH**/ ?>