...
<div class="space-y-6">
    ...
    <div class="flex flex-wrap gap-2 mb-4">
        <a href="<?php echo e(route('admin.portfolio.index')); ?>" class="px-4 py-2 rounded-xl text-sm font-bold <?php echo e(!request('status') ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'); ?>">الكل</a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/portfolio/index.blade.php ENDPATH**/ ?>