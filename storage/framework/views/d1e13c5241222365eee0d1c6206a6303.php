        ...
        <form method="get"
            ...
            <div class="lg:col-span-2">
                ...
                <select name="lead_scope" class="w-full rounded-xl border border-gray-300 px-3 py-2 text-sm">
                    ...
                    <option value="transferred_from_admin" <?php if(($leadScope ?? 'touched') === 'transferred_from_admin'): echo 'selected'; endif; ?>>Leads محوّلة من الإدارة (مسندة للموظف)</option>
                </select>
            </div>
        ...
        <div class="rounded-2xl border border-emerald-200 bg-gradient-to-br from-emerald-50 to-white p-5 shadow-sm">
            ...
            <?php if($selectedRep && $periodReport): ?>
                ...
                <div class="mt-2 text-xs text-gray-600">
                    Leads أنشأها الموظف: <span class="font-bold"><?php echo e($counts['leads_created_by'] ?? 0); ?></span>
                    — Leads محوّلة من الإدارة: <span class="font-bold"><?php echo e($counts['leads_transferred_from_admin'] ?? 0); ?></span>
                </div>
