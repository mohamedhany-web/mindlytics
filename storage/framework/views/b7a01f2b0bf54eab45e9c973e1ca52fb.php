    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="flex justify-between items-center h-20 lg:h-24 gap-4 lg:gap-6">
            ...
            <div class="flex items-center space-x-3 space-x-reverse flex-shrink-0">
                <a href="<?php echo e(route('home')); ?>" class="flex items-center space-x-3 space-x-reverse group">
            ...
            <div class="hidden lg:flex items-center gap-6 flex-1 justify-center max-w-5xl mx-auto">
                ...
                <div class="flex items-center gap-4">
                    <a href="<?php echo e(route('public.learning-paths.index')); ?>" class="nav-link text-white/90 hover:text-white font-semibold transition-all duration-300 relative group px-4 py-2.5 whitespace-nowrap text-base rounded-xl hover:bg-white/15 backdrop-blur-sm border border-transparent hover:border-white/20">
                    ...
                    <a href="<?php echo e(route('public.courses')); ?>" class="nav-link text-white/90 hover:text-white font-semibold transition-all duration-300 relative group px-4 py-2.5 whitespace-nowrap text-base rounded-xl hover:bg-white/15 backdrop-blur-sm border border-transparent hover:border-white/20">
                        <span class="relative z-10 flex items-center gap-2.5">
                    ...
                    <a href="<?php echo e(route('public.about')); ?>" class="nav-link text-white/90 hover:text-white font-semibold transition-all duration-300 relative group px-4 py-2.5 whitespace-nowrap text-base rounded-xl hover:bg-white/15 backdrop-blur-sm border border-transparent hover:border-white/20">
                        <span class="relative z-10 flex items-center gap-2.5">
                    ...
                    <a href="<?php echo e(route('public.portfolio.index')); ?>" class="nav-link text-white/90 hover:text-white font-semibold transition-all duration-300 relative group px-4 py-2.5 whitespace-nowrap text-base rounded-xl hover:bg-white/15 backdrop-blur-sm border border-transparent hover:border-white/20">
                        <span class="relative z-10 flex items-center gap-2.5">
            ...
            <div class="hidden lg:flex items-center space-x-3 space-x-reverse flex-shrink-0">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(url('/dashboard')); ?>" class="bg-white text-blue-900 px-6 py-2.5 rounded-xl font-bold hover:bg-blue-50 transition-all duration-500 shadow-lg hover:shadow-xl relative overflow-hidden group text-sm whitespace-nowrap border-2 border-white/30 hover:border-white/50">
                ...
                <?php if(auth()->guard()->guest()): ?>
                    <a href="<?php echo e(route('login')); ?>" class="text-white/90 hover:text-white font-semibold transition-all duration-300 relative group px-5 py-2.5 rounded-xl hover:bg-white/15 backdrop-blur-sm text-sm whitespace-nowrap border-2 border-white/20 hover:border-white/40">
                        <div class="absolute inset-0 bg-gradient-to-r from-white/0 via-white/10 to-white/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-xl"></div>
                        <span class="relative z-10 flex items-center gap-2">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="bg-white text-blue-900 px-6 py-2.5 rounded-xl font-bold hover:bg-blue-50 transition-all duration-500 shadow-lg hover:shadow-xl relative overflow-hidden group text-sm whitespace-nowrap border-2 border-white/30 hover:border-white/50">
                        <div class="absolute inset-0 bg-gradient-to-r from-blue-50/0 via-blue-100/30 to-blue-50/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                        <span class="relative z-10 flex items-center gap-2">
    ...
    <div id="mobile-menu-sidebar"
        ...
        <div class="relative px-5 py-6 space-y-1">
            ...
            <div class="space-y-2">
                ...
                <a href="<?php echo e(route('public.courses')); ?>" class="group relative flex items-center text-white/90 hover:text-white hover:bg-white/10 font-medium transition-all duration-300 px-4 py-4 rounded-2xl text-sm border border-white/10 hover:border-white/40 overflow-hidden backdrop-blur-md shadow-lg hover:shadow-2xl">
                    <!-- Animated background on hover -->
                    <div class="absolute inset-0 bg-gradient-to-r from-white/0 via-white/15 to-white/0 opacity-0 group-hover:opacity-100 group-hover:animate-shimmer transition-opacity duration-300"></div>
                    <!-- Glow effect with multi-color -->
                    <div class="absolute -inset-0.5 rounded-2xl blur opacity-0 group-hover:opacity-100 transition-opacity duration-300" style="background: linear-gradient(135deg, rgba(59, 130, 246, 0.4), rgba(37, 99, 235, 0.3), rgba(59, 130, 246, 0.4));"></div>
                ...
                <a href="<?php echo e(route('public.about')); ?>" class="group relative flex items-center text-white/90 hover:text-white hover:bg-white/10 font-medium transition-all duration-300 px-4 py-4 rounded-2xl text-sm border border-white/10 hover:border-white/40 overflow-hidden backdrop-blur-md shadow-lg hover:shadow-2xl">
                    <!-- Animated background on hover -->
                    <div class="absolute inset-0 bg-gradient-to-r from-white/0 via-white/15 to-white/0 opacity-0 group-hover:opacity-100 group-hover:animate-shimmer transition-opacity duration-300"></div>
                    <!-- Glow effect with multi-color -->
                    <div class="absolute -inset-0.5 rounded-2xl blur opacity-0 group-hover:opacity-100 transition-opacity duration-300" style="background: linear-gradient(135deg, rgba(59, 130, 246, 0.4), rgba(37, 99, 235, 0.3), rgba(59, 130, 246, 0.4));"></div>
                ...
                <a href="<?php echo e(route('public.portfolio.index')); ?>" class="group relative flex items-center text-white/90 hover:text-white hover:bg-white/10 font-medium transition-all duration-300 px-4 py-4 rounded-2xl text-sm border border-white/10 hover:border-white/40 overflow-hidden backdrop-blur-md shadow-lg hover:shadow-2xl">
                    <div class="absolute inset-0 bg-gradient-to-r from-white/0 via-white/15 to-white/0 opacity-0 group-hover:opacity-100 group-hover:animate-shimmer transition-opacity duration-300"></div>
                    <div class="absolute -inset-0.5 rounded-2xl blur opacity-0 group-hover:opacity-100 transition-opacity duration-300" style="background: linear-gradient(135deg, rgba(59, 130, 246, 0.4), rgba(37, 99, 235, 0.3), rgba(59, 130, 246, 0.4));"></div>
                    <div class="relative w-11 h-11 bg-white/20 group-hover:bg-white rounded-xl flex items-center justify-center ml-3 transition-all duration-300 group-hover:scale-110 group-hover:rotate-3 shadow-xl group-hover:shadow-2xl overflow-hidden">
                        <div class="absolute inset-0 bg-gradient-to-br from-white/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            ...
            <div class="space-y-2.5">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(url('/dashboard')); ?>" class="group relative flex items-center justify-center gap-2 bg-white text-blue-900 px-6 py-3.5 rounded-xl font-semibold shadow-xl hover:shadow-2xl hover:bg-blue-50 transition-all duration-300 text-sm overflow-hidden">
                ...
                <?php endif; ?>
                <?php if(auth()->guard()->guest()): ?>
                    <a href="<?php echo e(route('login')); ?>" class="group relative flex items-center text-white/90 hover:text-white hover:bg-white/10 font-medium transition-all duration-300 px-4 py-3.5 rounded-xl text-sm border border-white/10 hover:border-white/30 overflow-hidden backdrop-blur-sm">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="group relative flex items-center justify-center gap-2 bg-white text-blue-900 px-6 py-3.5 rounded-xl font-semibold shadow-xl hover:shadow-2xl hover:bg-blue-50 transition-all duration-300 text-sm overflow-hidden">
                        <div class="absolute inset-0 bg-gradient-to-r from-blue-50/0 via-blue-100/50 to-blue-50/0 opacity-0 group-hover:opacity-100 group-hover:animate-shimmer transition-opacity duration-300"></div>
            ...
            <div class="mt-6 pt-6 border-t border-white/20">
                <div class="group relative flex items-center gap-3 px-4 py-4 bg-white/10 backdrop-blur-md rounded-xl border border-white/20 hover:bg-white/15 hover:border-white/30 transition-all duration-300 overflow-hidden">
                    ...
                    <div class="flex-1 min-w-0 relative z-10">
                        <p class="text-white font-bold text-sm truncate drop-shadow"><?php echo e(auth()->user()->name); ?></p>
                        <p class="text-white/70 text-xs truncate font-medium"><?php echo e(auth()->user()->email); ?></p>
                    </div>
