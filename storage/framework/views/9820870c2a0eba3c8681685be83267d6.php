            ...
            <div class="max-w-3xl mx-auto text-center relative z-10">
                ...
                <?php if(($confirmedCount ?? 0) > 0): ?>
                    <p class="mt-3 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-100 text-emerald-800 text-sm font-bold">
                        ...
                        <?php echo e(number_format($confirmedCount)); ?> أكّدوا الحضور
                    </p>
                <?php endif; ?>
            </div>
        </section>
                ...
                <div class="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
                    <div class="px-5 py-4 border-b border-slate-100 flex flex-wrap items-center justify-between gap-3">
                        ...
                        <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-100 text-slate-700 text-sm font-bold">
                            <?php echo e(number_format($confirmedCount ?? 0)); ?>

                        </span>
                    </div>
                    <div class="max-h-[420px] overflow-y-auto">
                        <?php $__empty_1 = true; $__currentLoopData = $confirmedAttendees ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="flex items-center justify-between gap-3 px-5 py-3 border-b border-slate-50 last:border-0 hover:bg-slate-50/80">
                                <div class="flex items-center gap-3 min-w-0">
                                    ...
                                    <span class="font-semibold text-slate-800 truncate"><?php echo e($attendee->name); ?></span>
                                </div>
