...
<head>
    ...
    <title>تأكيد الحضور — <?php echo e($workshop->title); ?> | Mindlytics</title>
        ...
        <section class="hero-section pt-10 pb-8 sm:pt-14 sm:pb-10 px-4">
            <div class="max-w-3xl mx-auto text-center relative z-10">
                ...
                <p class="text-slate-600 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
                    أدخل اسمك ورقم هاتفك كما سجّلتهما عند الحجز لتأكيد حضورك واستحقاقك لشهادة الورشة.
                </p>
            </div>
        </section>
            ...
            <div class="max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-6">
                ...
                <div class="lg:col-span-2">
                    <div class="rounded-2xl border border-slate-200 bg-white shadow-sm p-6 h-full">
                        ...
                        <h2 class="text-xl font-black text-slate-900 mb-4 leading-snug"><?php echo e($workshop->title); ?></h2>
                        <div class="space-y-3 text-sm text-slate-600">
                            <?php if($workshop->starts_at): ?>
                                <div class="flex items-start gap-2">
                                    <i class="fas fa-calendar-alt text-blue-500 mt-0.5"></i>
                                    <span><?php echo e($workshop->starts_at->locale('ar')->translatedFormat('l j F Y — H:i')); ?></span>
                                </div>
                            <?php endif; ?>
                            <?php if($workshop->location): ?>
                                <div class="flex items-start gap-2">
                                    <i class="fas fa-location-dot text-rose-500 mt-0.5"></i>
                                    <span><?php echo e($workshop->location); ?></span>
                                </div>
                            <?php endif; ?>
                            <div class="flex items-start gap-2">
                                <i class="fas fa-<?php echo e($workshop->mode === 'online' ? 'globe' : ($workshop->mode === 'offline' ? 'building' : 'people-arrows')); ?> text-emerald-500 mt-0.5"></i>
                                <span>
                        ...
                        <div class="mt-5 pt-4 border-t border-slate-100">
                            <p class="text-xs text-slate-500 leading-relaxed">
                                ...
                                يجب أن تطابق البيانات ما أدخلته وقت التسجيل. بعد التأكيد، يُراجع فريق الأكاديمية حضورك لإصدار الشهادة.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-3">
                    <div class="rounded-2xl border border-slate-200 bg-white shadow-lg p-6 sm:p-8">
                            ...
                            <div class="mb-5 p-4 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-800 text-sm">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <?php if($confirmed): ?>
                                            <p class="text-xs text-emerald-700 mt-2">الاسم: <?php echo e($confirmed->name); ?> — <?php echo e($confirmed->checked_in_at?->format('Y-m-d H:i')); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <?php if (! (session('success') || session('info'))): ?>
                            <form method="POST" action="<?php echo e(route('public.workshops.confirm.store', $workshop->slug)); ?>" class="space-y-5">
                                <?php echo csrf_field(); ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="name" name="name" value="<?php echo e(old('name')); ?>"
                                           class="form-input" placeholder="كما سجّلته عند الحجز" required autocomplete="name">
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="text-[11px] text-slate-500 mt-1.5">استخدم نفس الرقم الذي أدخلته عند التسجيل.</p>
                                </div>
                        ...
                        <?php else: ?>
                            <div class="text-center py-4">
                                <a href="<?php echo e(url('/')); ?>" class="inline-flex items-center gap-2 text-sm font-semibold text-blue-600 hover:text-blue-700">
...
<?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/public/workshop-confirm.blade.php ENDPATH**/ ?>