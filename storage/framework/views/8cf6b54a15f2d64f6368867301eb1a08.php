...
<div class="w-full space-y-6">
    ...
    <section class="w-full grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
        <?php $__currentLoopData = [
            ...
            <a href="<?php echo e(route($link['route'])); ?>" class="sch-card rounded-2xl p-5 flex items-start gap-4 hover:border-blue-300 transition-all">
                ...
                <div class="min-w-0">
                    <h3 class="font-black text-slate-900"><?php echo e($link['title']); ?></h3>
                    <p class="text-xs text-slate-600 mt-1 leading-relaxed"><?php echo e($link['desc']); ?></p>
                </div>
            </a>
