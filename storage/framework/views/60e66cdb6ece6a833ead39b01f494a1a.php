    ...
    <?php if(isset($pattern->pattern_data['problem_description'])): ?>
        <div class="mb-6">
            ...
            <div class="bg-yellow-50 border-2 border-yellow-200 rounded-xl p-4">
                <?php echo e($pattern->pattern_data['problem_description']); ?>

            </div>
        </div>
    <?php endif; ?>
    
    <?php if(isset($pattern->pattern_data['buggy_code'])): ?>
        <div class="mb-6">
            ...
            <div class="bg-gray-900 text-red-400 rounded-xl p-4 font-mono text-sm overflow-x-auto">
                <pre><?php echo e($pattern->pattern_data['buggy_code']); ?></pre>
            </div>
        </div>
    <?php endif; ?>
...
<?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/student/learning-patterns/types/debugging_exercise.blade.php ENDPATH**/ ?>