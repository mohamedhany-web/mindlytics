...
<nav class="flex flex-wrap gap-2 p-1.5 rounded-2xl bg-white border-2 border-slate-200/50 shadow-sm">
    ...
    <a href="<?php echo e(route('admin.hr.rubrics.index')); ?>"
       class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold transition-all <?php echo e($active === 'rubrics' ? 'bg-pink-600 text-white shadow-md' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'); ?>">
