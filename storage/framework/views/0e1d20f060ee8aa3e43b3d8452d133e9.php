                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $rubrics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rubric): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50/70 transition-colors">
                            <td class="px-6 py-4">
                                ...
                                <div class="text-xs text-slate-500 mt-0.5">معايير: <?php echo e(is_array($rubric->criteria_json) ? count($rubric->criteria_json) : 0); ?></div>
                            </td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mindly tics\Mindlytics\resources\views\admin\hr\rubrics\index.blade.php ENDPATH**/ ?>