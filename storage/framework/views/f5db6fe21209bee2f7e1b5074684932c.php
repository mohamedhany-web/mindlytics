...
<?php if(session('warning')): ?>
    <div class="rounded-xl bg-amber-50 border-2 border-amber-200 text-amber-900 px-5 py-4 flex items-center gap-3 shadow-sm">
        ...
        <span class="font-semibold text-sm"><?php echo e(session('warning')); ?></span>
    </div>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\mindly tics\Mindlytics\resources\views\admin\meta-social\_alerts.blade.php ENDPATH**/ ?>