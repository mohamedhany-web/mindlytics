<section class="<?php echo e($schSectionClass ?? 'rounded-2xl bg-white border-2 border-slate-200/50 shadow-xl overflow-hidden'); ?>">
    <div class="px-5 py-5 sm:px-6 border-b border-slate-200 bg-gradient-to-r from-violet-50/80 to-white flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div class="flex items-center gap-4">
            <div class="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center text-white shadow-lg flex-shrink-0">
                <i class="<?php echo e($icon ?? 'fas fa-graduation-cap'); ?> text-lg sm:text-xl"></i>
            </div>
            <div>
            ...
            <?php $__currentLoopData = $statCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
                    <div class="flex items-center justify-between gap-2">
                        ...
                        <div class="w-10 h-10 rounded-lg <?php echo e($card['bg'] ?? 'bg-violet-100'); ?> flex items-center justify-center <?php echo e($card['text'] ?? 'text-violet-600'); ?> flex-shrink-0">
...
<?php /**PATH C:\xampp\htdocs\mindly tics\Mindlytics\resources\views/admin/scholarships/_page-header.blade.php ENDPATH**/ ?>