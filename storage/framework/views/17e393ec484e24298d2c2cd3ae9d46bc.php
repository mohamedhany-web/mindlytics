...
<?php $__env->startSection('title', 'طلب حجز أونلاين #' . $offlineCourseBooking->id); ?>
<?php $__env->startSection('header', 'طلب حجز أونلاين #' . $offlineCourseBooking->id); ?>
...
<div class="space-y-6 w-full">
    ...
    <div class="flex flex-wrap gap-3">
        <a href="<?php echo e(route('admin.online-course-bookings.index')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-100 text-gray-800 rounded-lg text-sm hover:bg-gray-200"><i class="fas fa-arrow-right ml-2"></i> القائمة</a>
        <a href="<?php echo e(route('admin.offline-courses.show', $offlineCourseBooking->course)); ?>" class="inline-flex items-center px-4 py-2 bg-purple-50 text-purple-800 rounded-lg text-sm hover:bg-purple-100">صفحة الكورس</a>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6 space-y-4">
        ...
        <dl class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
            <div><dt class="text-gray-500">رقم الطلب</dt><dd class="font-semibold text-gray-900">#<?php echo e($offlineCourseBooking->id); ?></dd></div>
            ...
            <div class="lg:col-span-2"><dt class="text-gray-500">الكورس</dt><dd class="font-semibold text-gray-900"><?php echo e($offlineCourseBooking->course->title); ?></dd></div>
            ...
            <?php if($offlineCourseBooking->requestedGroup): ?>
                <div class="lg:col-span-2"><dt class="text-gray-500">المجموعة المطلوبة (أونلاين)</dt><dd class="font-semibold text-purple-800"><?php echo e($offlineCourseBooking->requestedGroup->name); ?></dd></div>
            <?php endif; ?>
            ...
            <div><dt class="text-gray-500">الاسم المحوِّل</dt><dd class="text-gray-800"><?php echo e($offlineCourseBooking->transfer_name ?: '—'); ?></dd></div>
            ...
            <?php if($offlineCourseBooking->reviewed_at): ?>
                <div><dt class="text-gray-500">تاريخ المراجعة</dt><dd class="text-gray-800"><?php echo e($offlineCourseBooking->reviewed_at?->format('Y-m-d H:i')); ?></dd></div>
            <?php endif; ?>
            <?php if($offlineCourseBooking->assignedGroup): ?>
                <div><dt class="text-gray-500">المجموعة المعتمدة</dt><dd class="font-semibold text-emerald-700"><?php echo e($offlineCourseBooking->assignedGroup->name); ?></dd></div>
            <?php endif; ?>
        </dl>
            ...
            <div class="border-t border-gray-100 pt-4">
                ...
                <div class="space-y-3">
                    <a href="<?php echo e(asset('storage/' . $offlineCourseBooking->payment_proof)); ?>" target="_blank" rel="noopener" class="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium">
                        <i class="fas fa-image ml-2"></i> فتح الإيصال في نافذة جديدة
                    </a>
                    <img src="<?php echo e(asset('storage/' . $offlineCourseBooking->payment_proof)); ?>" alt="إيصال التحويل" class="max-w-full lg:max-w-3xl rounded-lg border border-gray-200 shadow-sm">
                </div>
            </div>
        <?php endif; ?>
    ...
    <?php if($offlineCourseBooking->isPending()): ?>
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6 space-y-4">
            <h2 class="text-lg font-bold text-gray-900">قبول الطلب وإضافة للمجموعة (أونلاين)</h2>
            <form action="<?php echo e(route('admin.online-course-bookings.approve', $offlineCourseBooking)); ?>" method="post" class="space-y-4">
                <?php echo csrf_field(); ?>
                <div>
                    ...
                    <select name="group_id" required class="w-full max-w-md rounded-lg border-gray-300">
                        ...
                        <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($g->id); ?>" <?php if(! $g->canEnroll('online')): echo 'disabled'; endif; ?>>
                                <?php echo e($g->name); ?> — متاح أونلاين <?php echo e($g->availableSeats('online')); ?> / <?php echo e($g->max_students_online); ?>

                                <?php if(! $g->canEnroll('online')): ?> (غير متاحة) <?php endif; ?>
                            </option>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-red-100 p-6">
            ...
            <form action="<?php echo e(route('admin.online-course-bookings.reject', $offlineCourseBooking)); ?>" method="post" class="space-y-3">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/online-course-bookings/show.blade.php ENDPATH**/ ?>