...
<?php $__env->startSection('title', 'موارد الكورس ' . (($channel ?? 'offline') === 'online' ? 'الأونلاين' : 'الأوفلاين') . ' - ' . $offlineCourse->title); ?>
                    ...
                    <li class="p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 hover:bg-slate-50/50">
                        <div class="min-w-0 flex-1">
                            <div class="flex items-center gap-2 flex-wrap">
                                ...
                                <?php if($resource->relationLoaded('lectures') && $resource->lectures->isNotEmpty()): ?>
                                    <span class="text-xs px-2 py-0.5 rounded bg-sky-50 text-sky-700">
                                        <i class="fas fa-chalkboard-teacher ml-1"></i>
                                        <?php echo e($resource->lectures->take(1)->first()->title); ?>

                                        <?php if($resource->lectures->count() > 1): ?>
                                            (<?php echo e($resource->lectures->count()); ?>)
                                        <?php endif; ?>
                                    </span>
                                <?php endif; ?>
                        ...
                        <div class="flex items-center gap-2 flex-shrink-0">
                            ...
                            <?php endif; ?>
                            <a href="<?php echo e(route('instructor.offline-courses.resources.edit', ['offlineCourse' => $offlineCourse, 'resource' => $resource, 'channel' => ($channel ?? 'offline')])); ?>" class="px-3 py-1.5 text-sm bg-slate-100 text-slate-700 rounded-lg hover:bg-slate-200">تعديل</a>
                            <form action="<?php echo e(route('instructor.offline-courses.resources.destroy', ['offlineCourse' => $offlineCourse, 'resource' => $resource, 'channel' => ($channel ?? 'offline')])); ?>" method="post" class="inline" onsubmit="return confirm('حذف هذا المورد؟');">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/instructor/offline-courses/resources/index.blade.php ENDPATH**/ ?>