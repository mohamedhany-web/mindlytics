        ...
        <div class="bg-white rounded-2xl p-5 border-2 border-emerald-200/50 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-black text-emerald-700"><?php echo e(number_format($stats['total_revenue'] ?? 0, 2)); ?></p>
        ...
        <div class="bg-white rounded-2xl p-5 border-2 border-red-200/50 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-black text-red-700"><?php echo e(number_format($stats['total_remaining'] ?? 0, 2)); ?></p>
                    <p class="text-xs text-gray-500 mt-1">ج.م</p>
                </div>
        ...
        <div class="bg-white rounded-2xl p-5 border-2 border-indigo-200/50 shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-black text-indigo-700"><?php echo e($stats['total_sessions'] ?? 0); ?></p>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/offline-courses/show.blade.php ENDPATH**/ ?>