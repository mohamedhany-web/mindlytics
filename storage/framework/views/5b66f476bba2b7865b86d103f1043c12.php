...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="number" name="price" id="course_price" value="<?php echo e(old('price', 0)); ?>" min="0" step="0.01"
                                           class="w-full rounded-2xl border border-gray-200 bg-white/70 px-4 py-3 text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="number" name="discount_amount" id="course_discount" value="<?php echo e(old('discount_amount', 0)); ?>" min="0" step="0.01"
                                           class="w-full rounded-2xl border border-gray-200 bg-white/70 px-4 py-3 text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition"
