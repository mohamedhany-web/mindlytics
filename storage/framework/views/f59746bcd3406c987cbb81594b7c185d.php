<?php $__env->startSection('title', 'إضافة مورد - كورس أوفلاين'); ?>
...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="rounded-2xl bg-white border border-slate-200 shadow-sm p-5 sm:p-6 mb-6">
        <nav class="text-sm text-slate-500 mb-2">
            ...
            <span class="mx-2">/</span>
            <a href="<?php echo e(route('instructor.offline-courses.resources.index', $offlineCourse)); ?>" class="hover:text-amber-600 transition-colors">الموارد</a>
            <span class="mx-2">/</span>
    ...
    <div class="rounded-2xl bg-white border border-slate-200 shadow-sm p-6 sm:p-8">
        <form action="<?php echo e(route('instructor.offline-courses.resources.store', $offlineCourse)); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="space-y-4">
                <div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mt-6 flex gap-3">
                ...
                <a href="<?php echo e(route('instructor.offline-courses.resources.index', $offlineCourse)); ?>" class="px-4 py-2.5 bg-slate-100 text-slate-700 rounded-xl font-semibold hover:bg-slate-200">إلغاء</a>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mindly tics\Mindlytics\resources\views/instructor/offline-courses/resources/create.blade.php ENDPATH**/ ?>