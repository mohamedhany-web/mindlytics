    ...
    <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <p class="font-semibold text-gray-900 text-lg"><?php echo e($employee->weeklyOffDayLabel() ?? 'عطلة نهاية الأسبوع (افتراضي)'); ?></p>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/employees/show.blade.php ENDPATH**/ ?>