                        ...
                        <?php $__currentLoopData = $deliverablesTimeline; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr class="hover:bg-fuchsia-50/30 align-top">
                                ...
                                <td class="px-4 py-3">
                                    ...
                                    <?php elseif(in_array($type, ['file', 'image'], true) && $d->file_path): ?>
                                        <?php if($type === 'image'): ?>
                                            <a href="<?php echo e(asset('storage/'.$d->file_path)); ?>" target="_blank" rel="noopener" class="block">
                                                <img src="<?php echo e(asset('storage/'.$d->file_path)); ?>" alt="" class="max-h-28 rounded-lg border border-gray-200 shadow-sm object-contain bg-gray-50">
                                            </a>
                                        <?php endif; ?>
                                        <a href="<?php echo e(asset('storage/'.$d->file_path)); ?>" target="_blank" rel="noopener" class="inline-flex items-center gap-1 mt-2 text-violet-700 hover:text-violet-900 font-semibold text-xs">
...
<?php echo $__env->make('layouts.employee', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mindly tics\Mindlytics\resources\views/employee/design-cycles/show.blade.php ENDPATH**/ ?>