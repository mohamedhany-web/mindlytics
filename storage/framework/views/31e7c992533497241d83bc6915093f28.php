<?php $__env->startSection('title', 'كورساتي المفعلة'); ?>
<?php $__env->startSection('header', 'كورساتي المفعلة'); ?>
            ...
            <a href="<?php echo e(route('my-courses.show', $course)); ?>" class="course-card block">
                <div class="course-thumbnail h-36 bg-sky-100 flex items-center justify-center relative">
                    ...
                    <?php else: ?>
                        <div class="text-sky-600">
                            ...
                            <p class="text-xs font-medium mt-1 text-sky-700"><?php echo e($course->academicSubject->name ?? 'كورس'); ?></p>
                        </div>
                    <?php endif; ?>
                    <?php if($isCompleted): ?>
                ...
                <div class="p-4">
                    ...
                    <p class="text-xs text-gray-500 mb-3">
                        <?php echo e($course->academicSubject->name ?? '—'); ?> · <?php echo e($course->teacher->name ?? '—'); ?> · <?php echo e($course->lessons->count()); ?> درس
                    </p>
