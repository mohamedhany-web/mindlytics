            ...
            <div class="flex items-center gap-3 gap-reverse flex-shrink-0">
                <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3 gap-reverse group nav-brand">
                    <div class="relative flex-shrink-0 flex items-center">
                        <img
                            src="<?php echo e($platformLogoUrl ?? asset('logo-fallback.svg')); ?>"
                            alt="Mindlytics Logo"
...
<?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/components/unified-navbar.blade.php ENDPATH**/ ?>