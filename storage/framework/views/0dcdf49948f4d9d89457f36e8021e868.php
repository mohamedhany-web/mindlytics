...
<div class="space-y-6">
    ...
    <section class="rounded-2xl bg-white border border-slate-200 shadow-lg overflow-hidden">
        <div class="px-4 py-4 bg-slate-50 border-b border-slate-200 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                <a href="<?php echo e(route('admin.sales.transfer.index')); ?>" class="inline-flex items-center gap-2 px-3 py-2 text-sm font-semibold text-slate-700 rounded-xl border border-slate-300 hover:bg-white">
        ...
        <?php if($hasFilters): ?>
            <div class="px-4 pb-4">
                <p class="text-xs text-slate-600 bg-amber-50 border border-amber-200 rounded-xl px-3 py-2">
                    ...
                    فلتر نشط — <strong><?php echo e(number_format($stats['total'] ?? 0)); ?></strong> سجل مطابق.
                </p>
            </div>
        <?php endif; ?>
    </section>
    ...
    <section class="rounded-2xl bg-white border border-slate-200 shadow-lg overflow-hidden">
        ...
        <div class="p-4">
            <form method="get" action="<?php echo e(route('admin.sales.audit-log.index')); ?>" class="flex flex-col gap-3">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <select name="action" class="<?php echo e($inputClass); ?>">
                            <option value="">الكل</option>
                    ...
                    <div class="sm:col-span-2 lg:col-span-3 xl:col-span-2">
                        ...
                        <input type="search" name="search" value="<?php echo e(request('search')); ?>" placeholder="الوصف أو الرابط..." class="<?php echo e($inputClass); ?>">
                    </div>
                </div>
                <div class="flex items-center gap-2 pt-1">
                    ...
                    <?php if($hasFilters): ?>
                        <a href="<?php echo e(route('admin.sales.audit-log.index')); ?>" class="inline-flex items-center justify-center rounded-xl border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50">
    ...
    <section class="rounded-2xl bg-white border border-slate-200 shadow-lg overflow-hidden">
        <div class="px-4 py-3 border-b border-slate-200 bg-slate-50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            ...
            <span class="text-xs font-semibold text-sky-700 bg-sky-50 px-2.5 py-1 rounded-lg border border-sky-200"><?php echo e(number_format($logs->total())); ?> سجل</span>
        </div>
                ...
                <tbody class="divide-y divide-slate-100">
                    <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50 align-top">
                            <td class="px-4 py-3 text-slate-600 whitespace-nowrap tabular-nums text-xs"><?php echo e($log->created_at->format('Y-m-d H:i:s')); ?></td>
                            <td class="px-4 py-3 font-semibold text-slate-900"><?php echo e($log->user->name ?? '—'); ?></td>
                            <td class="px-4 py-3">
                            ...
                            <td class="px-4 py-3 text-slate-700 max-w-md"><?php echo e(\Illuminate\Support\Str::limit($log->description, 200)); ?></td>
                            <td class="px-4 py-3 text-xs text-slate-500 max-w-[200px] truncate" title="<?php echo e($log->url); ?>"><?php echo e(\Illuminate\Support\Str::limit($log->url, 40)); ?></td>
                        </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/sales/audit/index.blade.php ENDPATH**/ ?>