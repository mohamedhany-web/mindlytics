...
<?php $__env->startSection('title', 'تفاصيل مراجعة المسار'); ?>
<?php $__env->startSection('header', 'تفاصيل مراجعة المسار'); ?>
...
<div class="space-y-6">
    <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
        <div class="flex justify-between items-start mb-6">
            ...
            <a href="<?php echo e(route('admin.learning-path-reviews.index')); ?>" class="bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded-lg font-medium transition-colors">
                رجوع
            </a>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                <h3 class="text-lg font-bold text-gray-900 mb-4">معلومات المسار</h3>
                <div class="space-y-2 text-sm">
                    <div><span class="text-gray-600">اسم المسار:</span> <span class="font-medium text-gray-900 mr-2"><?php echo e($review->learningPath->name ?? '-'); ?></span></div>
                </div>
            </div>
        </div>
        ...
        <?php if($review->comment): ?>
            <div class="border-t border-gray-200 pt-6 mb-6">
                ...
                <p class="text-gray-600 whitespace-pre-line"><?php echo e($review->comment); ?></p>
            </div>
        <?php endif; ?>

        <div class="border-t border-gray-200 pt-6">
            <form action="<?php echo e(route('admin.learning-path-reviews.update', $review)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/learning-path-reviews/show.blade.php ENDPATH**/ ?>