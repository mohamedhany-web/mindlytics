                                ...
                                <div class="space-y-2">
                                    ...
                                    <select name="branch_id"
                                        ...
                                        <?php $__currentLoopData = $branches ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($branch->id); ?>" <?php echo e((string) old('branch_id', $advancedCourse->branch_id ?? '') === (string) $branch->id ? 'selected' : ''); ?>>
                                                <?php echo e($branch->name); ?> <?php if($branch->slug): ?><span class="text-gray-400">(<?php echo e($branch->slug); ?>)</span><?php endif; ?>
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="number" name="price" id="course_price" value="<?php echo e(old('price', $advancedCourse->price ?? 0)); ?>" min="0" step="0.01"
                                           class="w-full rounded-2xl border border-gray-200 bg-white/70 px-4 py-3 text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="number" name="discount_amount" id="course_discount" value="<?php echo e(old('discount_amount', $advancedCourse->discount_amount ?? 0)); ?>" min="0" step="0.01"
                                           class="w-full rounded-2xl border border-gray-200 bg-white/70 px-4 py-3 text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-2 rounded-2xl border border-indigo-100 bg-indigo-50/40 p-5 space-y-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="text" name="title_en" value="<?php echo e(old('title_en', $advancedCourse->title_en)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <textarea name="description_en" rows="4" dir="ltr"
                                              class="w-full rounded-2xl border border-gray-200 bg-white px-4 py-3 text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition"
                                              placeholder="Course description in English"><?php echo e(old('description_en', $advancedCourse->description_en)); ?></textarea>
