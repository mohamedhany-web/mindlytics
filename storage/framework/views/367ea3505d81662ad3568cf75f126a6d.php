...
<?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if($panelType): ?>
            ...
            <section id="learn-panel-<?php echo e($panelType); ?>-<?php echo e($item->id); ?>"
                ...
                <div class="learn-panel-body" data-panel-body="<?php echo e($panelType); ?>-<?php echo e($item->id); ?>" <?php if($isLocked): ?> hidden <?php endif; ?>>
                    ...
                    <div class="learn-tab-panel" x-show="getPanelTab('<?php echo e($panelType); ?>', <?php echo e($item->id); ?>) === 'discussion'" x-cloak>
                        <?php echo $__env->make('student.my-courses.partials.learn-thread-panel', [
                            'kind' => 'discussion',
                            'panelType' => $panelType,
                            'item' => $item,
                            'course' => $course,
                    ...
                    <div class="learn-tab-panel" x-show="getPanelTab('<?php echo e($panelType); ?>', <?php echo e($item->id); ?>) === 'qa'" x-cloak>
                        <?php echo $__env->make('student.my-courses.partials.learn-thread-panel', [
                            'kind' => 'qa',
                            'panelType' => $panelType,
                            'item' => $item,
    ...
    <?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH C:\xampp\htdocs\mindly tics\Mindlytics\resources\views/student/my-courses/partials/learn-curriculum-panels.blade.php ENDPATH**/ ?>