...
<body class="bg-gray-50 <?php echo e($waImmersive ? 'wa-immersive-inbox employee-wa-immersive' : ''); ?>">
    ...
    <div class="flex min-h-screen lg:h-screen overflow-x-hidden">
        <!-- Sidebar - Fixed -->
        <aside class="hidden lg:flex <?php echo e($waImmersive ? 'lg:w-[4.25rem] emp-sidebar-compact' : 'lg:w-64'); ?> lg:flex-col lg:fixed lg:right-0 lg:z-20 flex-shrink-0 inset-y-0">
        ...
        <!-- Main content area -->
        <div class="flex flex-col flex-1 min-w-0 <?php echo e($waImmersive ? 'lg:pr-[4.25rem]' : 'lg:pr-64'); ?> w-full lg:h-screen">
            <!-- Top navigation -->
            <header class="sticky top-0 z-30 flex-shrink-0 flex h-14 sm:h-16 bg-gradient-to-r from-slate-50 via-blue-50 to-slate-100 shadow-lg border-b border-slate-200/50 backdrop-blur-sm <?php echo e($waImmersive ? 'lg:hidden' : ''); ?>">
                ...
                <div class="flex-1 px-3 sm:px-6 flex justify-between items-center gap-2">
                    ...
                    <div class="flex items-center gap-2 sm:gap-4">
                        <?php echo $__env->make('components.employee-attendance-bar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        <?php
                            try {
                           ...
                           title="الإشعارات">
                            ...
                            <?php if($navUnreadNotifications > 0): ?>
                                <span class="absolute -top-0.5 -left-0.5 min-w-[1.15rem] h-[1.15rem] px-1 rounded-full bg-rose-500 text-white text-[10px] font-bold flex items-center justify-center leading-none">
                                    <?php echo e($navUnreadNotifications > 99 ? '99+' : $navUnreadNotifications); ?>
                        ...
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" 
                                ...
                                <a href="<?php echo e(route('employee.notifications')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                    <i class="fas fa-bell mr-2"></i>الإشعارات
                                    <?php if($navUnreadNotifications > 0): ?>
                                        <span class="inline-flex mr-1 px-1.5 py-0.5 rounded-full bg-rose-100 text-rose-700 text-[10px] font-bold"><?php echo e($navUnreadNotifications > 99 ? '99+' : $navUnreadNotifications); ?></span>
                                    <?php endif; ?>
                                </a>
            ...
            <!-- Page Content -->
            <main class="flex-1 overflow-y-auto <?php echo e($waImmersive ? 'overflow-hidden bg-slate-50' : 'bg-[#f8fafc]'); ?>">
                <div class="<?php echo e($waImmersive ? 'p-0 h-full flex flex-col min-h-0 overflow-hidden' : 'p-3 sm:p-4 md:p-6'); ?>">
                    <?php if(! $waImmersive): ?>
    ...
    <?php echo $__env->make('components.employee-presence-heartbeat', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('components.sales-team-chat-widget', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</body>
</html>
