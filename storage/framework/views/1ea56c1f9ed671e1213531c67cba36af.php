                            ...
                            <div class="p-4 bg-white relative overflow-hidden">
                                ...
                                <div class="flex items-center justify-between pt-3 border-t border-gray-100 group-hover:border-blue-100 transition-colors duration-300 relative z-10">
                                    <div>
                                        ...
                                        <?php else: ?>
                                            <?php if (isset($component)) { $__componentOriginalde6b44ec9be922fb2a9a8440f4bb4f15 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalde6b44ec9be922fb2a9a8440f4bb4f15 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.course-price-display','data' => ['course' => $course,'size' => 'sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('course-price-display'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginalde6b44ec9be922fb2a9a8440f4bb4f15)): ?>
<?php $attributes = $__attributesOriginalde6b44ec9be922fb2a9a8440f4bb4f15; ?>
<?php unset($__attributesOriginalde6b44ec9be922fb2a9a8440f4bb4f15); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalde6b44ec9be922fb2a9a8440f4bb4f15)): ?>
<?php $component = $__componentOriginalde6b44ec9be922fb2a9a8440f4bb4f15; ?>
<?php unset($__componentOriginalde6b44ec9be922fb2a9a8440f4bb4f15); ?>
<?php endif; ?>
                                        <?php endif; ?>
                                    </div>
    ...
    <script>
        ...
        function animateCounter(counter) {
            ...
            const duration = 2500;
            const increment = target > 0 ? Math.max(1, target / (duration / 16)) : 0;
            let current = 0;

            const updateCounter = () => {
                current += increment;
                if (current < target) {
                    const formatted = Math.floor(current).toLocaleString(landingCounterLocale);
                    counter.textContent = formatted + suffix;
                    requestAnimationFrame(updateCounter);
                } else {
                    const formatted = target.toLocaleString(landingCounterLocale);
                    counter.textContent = formatted + suffix;
                }
            };
