...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="hourly_rate" value="<?php echo e(old('hourly_rate')); ?>" step="0.01" min="0" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg">
                </div>
                <div>
                    ...
                    <select name="default_wallet_id" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg">
                        ...
                        <?php $__currentLoopData = $wallets ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wallet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($wallet->id); ?>" <?php if(old('default_wallet_id') == $wallet->id): echo 'selected'; endif; ?>><?php echo e($wallet->name); ?></option>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/offline-locations/create.blade.php ENDPATH**/ ?>