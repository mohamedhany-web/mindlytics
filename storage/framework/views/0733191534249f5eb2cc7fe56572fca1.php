<?php $__env->startSection('title', 'تعديل كورس أوفلاين'); ?>
<?php $__env->startSection('header', 'تعديل كورس أوفلاين'); ?>
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
        <div class="flex justify-between items-center">
            ...
            <a href="<?php echo e(route('admin.offline-courses.show', $offlineCourse)); ?>" class="text-gray-600 hover:text-gray-900">
                <i class="fas fa-arrow-right mr-2"></i>العودة للتفاصيل
            </a>
        </div>
    </div>

    <form action="<?php echo e(route('admin.offline-courses.update', $offlineCourse)); ?>" method="POST" class="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
        <?php echo csrf_field(); ?>
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="title" value="<?php echo e(old('title', $offlineCourse->title)); ?>" required 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" rows="3" 
                                  class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"><?php echo e(old('description', $offlineCourse->description)); ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="instructor_id" required 
                            ...
                            <?php $__currentLoopData = $instructors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instructor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($instructor->id); ?>" <?php echo e(old('instructor_id', $offlineCourse->instructor_id) == $instructor->id ? 'selected' : ''); ?>><?php echo e($instructor->name); ?></option>
                    ...
                    <div>
                        ...
                        <select name="branch_id"
                            ...
                            <?php $__currentLoopData = $branches ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($branch->id); ?>" <?php echo e((string) old('branch_id', $offlineCourse->branch_id ?? '') === (string) $branch->id ? 'selected' : ''); ?>><?php echo e($branch->name); ?> <?php if($branch->slug): ?> (<?php echo e($branch->slug); ?>) <?php endif; ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="location_id" 
                            ...
                            <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($location->id); ?>" <?php echo e(old('location_id', $offlineCourse->location_id) == $location->id ? 'selected' : ''); ?>><?php echo e($location->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text" name="location" value="<?php echo e(old('location', $offlineCourse->location)); ?>" placeholder="أو أدخل موقع مخصص" 
                               class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                    </div>
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" name="start_date" value="<?php echo e(old('start_date', $offlineCourse->start_date?->format('Y-m-d'))); ?>" 
                               class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="end_date" value="<?php echo e(old('end_date', $offlineCourse->end_date?->format('Y-m-d'))); ?>" 
                               class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="duration_hours" value="<?php echo e(old('duration_hours', $offlineCourse->duration_hours)); ?>" min="0" 
                               class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="sessions_count" value="<?php echo e(old('sessions_count', $offlineCourse->sessions_count)); ?>" min="0" 
                               class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                    </div>
                </div>
            </div>
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="price" value="<?php echo e(old('price', $offlineCourse->price)); ?>" min="0" step="0.01" 
                               class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="max_students" value="<?php echo e(old('max_students', $offlineCourse->max_students)); ?>" min="1" required 
                               class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                ...
                <div class="space-y-4">
                    <label class="inline-flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="public_booking_enabled" value="1"
                               <?php echo e(old('public_booking_enabled', $offlineCourse->public_booking_enabled) ? 'checked' : ''); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="datetime-local" name="booking_opens_at"
                                   value="<?php echo e(old('booking_opens_at', $offlineCourse->booking_opens_at?->format('Y-m-d\TH:i'))); ?>"
                                   class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                        </div>
                        <div>
                            ...
                            <input type="datetime-local" name="booking_closes_at"
                                   value="<?php echo e(old('booking_closes_at', $offlineCourse->booking_closes_at?->format('Y-m-d\TH:i'))); ?>"
                                   class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                        </div>
                    </div>
                    <?php $__errorArgs = ['booking_closes_at'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-red-500 text-xs mt-1"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <label class="inline-flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="student_online_portal_enabled" value="1"
                           <?php echo e(old('student_online_portal_enabled', $offlineCourse->student_online_portal_enabled) ? 'checked' : ''); ?>
                ...
                <label class="inline-flex items-center gap-2 cursor-pointer mt-4">
                    <input type="checkbox" name="online_only" value="1"
                           <?php echo e(old('online_only', $offlineCourse->online_only) ? 'checked' : ''); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="status" required 
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                            <option value="draft" <?php echo e(old('status', $offlineCourse->status) == 'draft' ? 'selected' : ''); ?>>مسودة</option>
                            <option value="active" <?php echo e(old('status', $offlineCourse->status) == 'active' ? 'selected' : ''); ?>>نشط</option>
                            <option value="completed" <?php echo e(old('status', $offlineCourse->status) == 'completed' ? 'selected' : ''); ?>>مكتمل</option>
                            <option value="cancelled" <?php echo e(old('status', $offlineCourse->status) == 'cancelled' ? 'selected' : ''); ?>>ملغي</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="notes" rows="3" 
                                  class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"><?php echo e(old('notes', $offlineCourse->notes)); ?></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mt-6 pt-6 border-t border-gray-200 flex items-center justify-end gap-4">
            <a href="<?php echo e(route('admin.offline-courses.show', $offlineCourse)); ?>" class="px-6 py-2.5 bg-gray-500 hover:bg-gray-600 text-white rounded-lg font-medium transition-colors">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/offline-courses/edit.blade.php ENDPATH**/ ?>