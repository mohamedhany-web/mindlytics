...
<?php $__env->startSection('title', 'تعديل مورد - كورس أوفلاين'); ?>
...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
    <div class="rounded-2xl bg-white border border-slate-200 shadow-sm p-5">
        <nav class="text-sm text-slate-500 mb-2">
            ...
            <a href="<?php echo e(route('instructor.offline-courses.resources.index', $offlineCourse)); ?>" class="hover:text-amber-600">الموارد</a>
            <span class="mx-2">/</span>
    ...
    <div class="rounded-2xl bg-white border border-slate-200 shadow-sm p-6">
        <form action="<?php echo e(route('instructor.offline-courses.resources.update', [$offlineCourse, $resource])); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
