...
<div class="space-y-6">
    ...
    <section class="rounded-2xl bg-white border border-slate-200 shadow-sm p-6">
        ...
        <?php if(($transferWallets ?? collect())->count() > 1): ?>
            <form action="<?php echo e(route('admin.wallets.transfer')); ?>" method="POST" class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                <?php echo csrf_field(); ?>
                <div>
                    ...
                    <select id="from_wallet_id" name="from_wallet_id" class="w-full rounded-xl border-slate-300 focus:border-sky-500 focus:ring-sky-500" required>
                        ...
                        <?php $__currentLoopData = $transferWallets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $walletOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($walletOption->id); ?>" <?php if(old('from_wallet_id') == $walletOption->id): echo 'selected'; endif; ?>>
                                <?php echo e($walletOption->name ?? ('محفظة #' . $walletOption->id)); ?> - <?php echo e(number_format($walletOption->balance, 2)); ?> ج.م
                            </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select id="to_wallet_id" name="to_wallet_id" class="w-full rounded-xl border-slate-300 focus:border-sky-500 focus:ring-sky-500" required>
                        ...
                        <?php $__currentLoopData = $transferWallets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $walletOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($walletOption->id); ?>" <?php if(old('to_wallet_id') == $walletOption->id): echo 'selected'; endif; ?>>
                                <?php echo e($walletOption->name ?? ('محفظة #' . $walletOption->id)); ?>
                ...
                <div>
                    ...
                    <input id="amount" name="amount" type="number" min="0.01" step="0.01" value="<?php echo e(old('amount')); ?>" class="w-full rounded-xl border-slate-300 focus:border-sky-500 focus:ring-sky-500" required>
                </div>

                <div>
                    <label for="notes" class="block text-xs font-semibold text-slate-600 mb-1">ملاحظة (اختياري)</label>
                    <input id="notes" name="notes" type="text" maxlength="500" value="<?php echo e(old('notes')); ?>" class="w-full rounded-xl border-slate-300 focus:border-sky-500 focus:ring-sky-500">
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/wallets/index.blade.php ENDPATH**/ ?>