...
?>
<?php if($stats !== []): ?>
<div class="grid <?php echo e($columns); ?> gap-4">
    <?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php $theme = $cardThemes[$card['theme'] ?? 'sky'] ?? $cardThemes['sky']; ?>
...
<?php endif; ?>
<?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/installments/partials/stats.blade.php ENDPATH**/ ?>