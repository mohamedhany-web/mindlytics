...
<?php $__env->startSection('title', 'تعديل فريق — '.$team->name); ?>
<?php $__env->startSection('header', 'المبيعات — تعديل الفريق'); ?>
...
<div class="max-w-3xl space-y-6">
    ...
    <section class="rounded-2xl bg-white border border-slate-200 shadow-lg overflow-hidden">
        <div class="px-4 py-4 bg-slate-50 border-b border-slate-200 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-xl font-black text-slate-900"><?php echo e($team->name); ?></h2>
        ...
        <form method="POST" action="<?php echo e(route('admin.sales.sales-teams.update', $team)); ?>" class="p-6">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            <?php echo $__env->make('admin.sales.sales-teams._form', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <section class="rounded-2xl bg-white border border-rose-200 shadow-lg overflow-hidden">
        ...
        <div class="p-4">
            ...
            <form method="POST" action="<?php echo e(route('admin.sales.sales-teams.destroy', $team)); ?>" onsubmit="return confirm('هل أنت متأكد من حذف هذا الفريق؟')">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mindly tics\Mindlytics\resources\views\admin\sales\sales-teams\edit.blade.php ENDPATH**/ ?>