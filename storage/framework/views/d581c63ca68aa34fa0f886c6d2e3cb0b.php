...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">
                        ...
                        <?php echo e(__('مصدر تمويل المصروف')); ?> *
                    </label>
                    <select name="funding_source" id="funding_source" required
                        ...
                        <option value="revenue" <?php echo e(old('funding_source', 'revenue') === 'revenue' ? 'selected' : ''); ?>>من إيرادات الكورسات / محفظة الأكاديمية</option>
                        <option value="out_of_pocket" <?php echo e(old('funding_source') === 'out_of_pocket' ? 'selected' : ''); ?>>من جيب الشركة (تمويل ذاتي — فلوس زيادة)</option>
                    </select>
                    <p class="text-xs text-amber-700 mt-1">اختر «من جيب الشركة» إذا دفعتم المبلغ من مالكم وليس من إيرادات الطلاب.</p>
                    <?php $__errorArgs = ['funding_source'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/expenses/create.blade.php ENDPATH**/ ?>