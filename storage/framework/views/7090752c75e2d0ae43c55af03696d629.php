...
<?php $__env->startSection('title', 'إدارة المدونة - Mindlytics'); ?>
...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white shadow rounded-lg mb-6">
            <form method="GET" action="<?php echo e(route('admin.blog.index')); ?>" class="p-6">
        ...
        <div class="bg-white shadow rounded-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-medium text-gray-900">
                    المقالات (<?php echo e($posts->total()); ?>)
                </h3>
            </div>
                        ...
                        <tr>
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    ...
                                    <img src="<?php echo e(asset($post->featured_image)); ?>" alt="<?php echo e($post->title); ?>" class="h-12 w-12 rounded-lg object-cover ml-3" onerror="this.style.display='none'">
                                    <?php else: ?>
                                    ...
                                    <div>
                                        ...
                                        <div class="text-sm text-gray-500"><?php echo e(Str::limit($post->excerpt ?? Str::limit(strip_tags($post->content), 100), 60)); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <?php echo e($post->author->name ?? 'غير محدد'); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <?php echo e($post->published_at ? $post->published_at->format('Y-m-d') : 'غير منشور'); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center space-x-2 space-x-reverse">
                                    <a href="<?php echo e(route('admin.blog.show', $post)); ?>" class="text-blue-600 hover:text-blue-900">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="<?php echo e(route('admin.blog.edit', $post)); ?>" class="text-sky-600 hover:text-sky-900">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="<?php echo e(route('admin.blog.destroy', $post)); ?>" method="POST" class="inline" onsubmit="return confirm('هل أنت متأكد من حذف هذا المقال؟');">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/blog/index.blade.php ENDPATH**/ ?>