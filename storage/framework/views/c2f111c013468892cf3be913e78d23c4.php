...
<div class="p-3 sm:p-4 md:p-6 space-y-4 sm:space-y-6" style="background: #f8fafc; min-height: 100vh;">
    ...
    <section class="<?php echo e($waSectionClass); ?>">
        <div class="px-5 py-4 border-b border-slate-200">
            <form method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-3">
                <div class="md:col-span-2">
                    <input type="search" name="search" value="<?php echo e(request('search')); ?>" placeholder="بحث بالتسمية أو كود Meta أو المحتوى..."
                           class="<?php echo e($waInputClass); ?>">
                </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tpl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="hover:bg-emerald-50/30">
                            <td class="px-5 py-3.5">
                                <a href="<?php echo e(route('admin.whatsapp.templates.show', $tpl)); ?>" class="font-bold text-slate-900 hover:text-emerald-700 block"><?php echo e($tpl->displayTitle()); ?></a>
                                <span class="text-xs text-slate-500 font-mono dir-ltr"><?php echo e($tpl->name); ?> · <?php echo e($tpl->language); ?></span>
                            </td>
                            ...
                            <td class="px-5 py-3.5">
                                ...
                                <?php if($tpl->displayRejectionReason()): ?>
                                    <p class="text-[10px] text-rose-600 mt-1 max-w-xs truncate" title="<?php echo e($tpl->displayRejectionReason()); ?>"><?php echo e(Str::limit($tpl->displayRejectionReason(), 40)); ?></p>
                                <?php endif; ?>
                            </td>
                            <?php if(($templateAccessMode ?? 'all') === 'restricted'): ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mindly tics\Mindlytics\resources\views/admin/whatsapp/templates/index.blade.php ENDPATH**/ ?>