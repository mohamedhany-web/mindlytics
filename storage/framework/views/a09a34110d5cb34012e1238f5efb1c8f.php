                            ...
                            <?php else: ?>
                                ...
                                <form action="<?php echo e($formRoute ?? route('public.offline-groups.book', $group->public_slug)); ?>" method="POST" enctype="multipart/form-data" class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="transfer_name" value="<?php echo e(old('transfer_name')); ?>" required
...
<?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/public/offline-group-checkout.blade.php ENDPATH**/ ?>