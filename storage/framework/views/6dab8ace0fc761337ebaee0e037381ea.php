<?php $__env->startSection('title', 'Mindlytics Community — الصفحة الرئيسية'); ?>
<?php $__env->startSection('page_title', 'Mindlytics Community · المحتوى'); ?>
...
<div class="w-full min-h-screen p-3 sm:p-4 md:p-6 lg:p-8 space-y-4 sm:space-y-6" style="background: #f8fafc;">
    ...
    <form action="<?php echo e(route('admin.mobile-app.update')); ?>" method="POST" class="space-y-6 w-full">
        <?php echo csrf_field(); ?>
        ...
        <div class="rounded-2xl border-2 border-slate-200/70 bg-white p-5 sm:p-8 shadow-lg w-full">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-6 w-full">
                <div class="space-y-2">
                    ...
                    <input type="text" name="welcome_title_ar" value="<?php echo e(old('welcome_title_ar', $settings->welcome_title_ar)); ?>"
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="welcome_title_en" value="<?php echo e(old('welcome_title_en', $settings->welcome_title_en)); ?>" dir="ltr"
                           class="w-full rounded-xl border-2 border-slate-200/90 bg-slate-50/50 px-4 py-3 text-sm focus:ring-2 focus:ring-violet-500/30 focus:border-violet-400 transition-shadow">
                </div>
                <div class="lg:col-span-2 space-y-2">
                    <label class="block text-sm font-bold text-slate-700">الوصف الفرعي (عربي)</label>
                    <input type="text" name="welcome_subtitle_ar" value="<?php echo e(old('welcome_subtitle_ar', $settings->welcome_subtitle_ar)); ?>"
                           class="w-full rounded-xl border-2 border-slate-200/90 bg-slate-50/50 px-4 py-3 text-sm focus:ring-2 focus:ring-violet-500/30 focus:border-violet-400 transition-shadow">
                </div>
                <div class="lg:col-span-2 space-y-2">
                    <label class="block text-sm font-bold text-slate-700">الوصف الفرعي (English)</label>
                    <input type="text" name="welcome_subtitle_en" value="<?php echo e(old('welcome_subtitle_en', $settings->welcome_subtitle_en)); ?>" dir="ltr"
                           class="w-full rounded-xl border-2 border-slate-200/90 bg-slate-50/50 px-4 py-3 text-sm focus:ring-2 focus:ring-violet-500/30 focus:border-violet-400 transition-shadow">
                </div>
            </div>
        </div>
        ...
        <div class="rounded-2xl border-2 border-slate-200/70 bg-white p-5 sm:p-8 shadow-lg w-full">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-6 w-full">
                <div class="space-y-2">
                    ...
                    <input type="text" name="mission_headline_ar" value="<?php echo e(old('mission_headline_ar', $settings->mission_headline_ar)); ?>"
                           class="w-full rounded-xl border-2 border-slate-200/90 bg-slate-50/50 px-4 py-3 text-sm focus:ring-2 focus:ring-violet-500/30 focus:border-violet-400 transition-shadow">
                </div>
                <div class="space-y-2">
                    <label class="block text-sm font-bold text-slate-700">عنوان المهمة (English)</label>
                    <input type="text" name="mission_headline_en" value="<?php echo e(old('mission_headline_en', $settings->mission_headline_en)); ?>" dir="ltr"
                           class="w-full rounded-xl border-2 border-slate-200/90 bg-slate-50/50 px-4 py-3 text-sm focus:ring-2 focus:ring-violet-500/30 focus:border-violet-400 transition-shadow">
                </div>
                <div class="lg:col-span-2 space-y-2">
                    <label class="block text-sm font-bold text-slate-700">نص المهمة (عربي)</label>
                    <textarea name="mission_body_ar" rows="4"
                              class="w-full rounded-xl border-2 border-slate-200/90 bg-slate-50/50 px-4 py-3 text-sm focus:ring-2 focus:ring-violet-500/30 focus:border-violet-400 transition-shadow"><?php echo e(old('mission_body_ar', $settings->mission_body_ar)); ?></textarea>
                </div>
                <div class="lg:col-span-2 space-y-2">
                    <label class="block text-sm font-bold text-slate-700">نص المهمة (English)</label>
                    <textarea name="mission_body_en" rows="4" dir="ltr"
                              class="w-full rounded-xl border-2 border-slate-200/90 bg-slate-50/50 px-4 py-3 text-sm focus:ring-2 focus:ring-violet-500/30 focus:border-violet-400 transition-shadow"><?php echo e(old('mission_body_en', $settings->mission_body_en)); ?></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="rounded-2xl border-2 border-slate-200/70 bg-white p-5 sm:p-8 shadow-lg w-full">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-6 w-full">
                <div class="space-y-2">
                    <label class="block text-sm font-bold text-slate-700">العنوان (عربي)</label>
                    <input type="text" name="no_subscription_title_ar" value="<?php echo e(old('no_subscription_title_ar', $settings->no_subscription_title_ar)); ?>"
                           class="w-full rounded-xl border-2 border-slate-200/90 bg-slate-50/50 px-4 py-3 text-sm focus:ring-2 focus:ring-violet-500/30 focus:border-violet-400 transition-shadow">
                </div>
                <div class="space-y-2">
                    <label class="block text-sm font-bold text-slate-700">العنوان (English)</label>
                    <input type="text" name="no_subscription_title_en" value="<?php echo e(old('no_subscription_title_en', $settings->no_subscription_title_en)); ?>" dir="ltr"
                           class="w-full rounded-xl border-2 border-slate-200/90 bg-slate-50/50 px-4 py-3 text-sm focus:ring-2 focus:ring-violet-500/30 focus:border-violet-400 transition-shadow">
                </div>
                <div class="lg:col-span-2 space-y-2">
                    <label class="block text-sm font-bold text-slate-700">النص (عربي)</label>
                    <textarea name="no_subscription_body_ar" rows="4"
                              class="w-full rounded-xl border-2 border-slate-200/90 bg-slate-50/50 px-4 py-3 text-sm focus:ring-2 focus:ring-violet-500/30 focus:border-violet-400 transition-shadow"><?php echo e(old('no_subscription_body_ar', $settings->no_subscription_body_ar)); ?></textarea>
                </div>
                <div class="lg:col-span-2 space-y-2">
                    ...
                    <textarea name="no_subscription_body_en" rows="4" dir="ltr"
                              class="w-full rounded-xl border-2 border-slate-200/90 bg-slate-50/50 px-4 py-3 text-sm focus:ring-2 focus:ring-violet-500/30 focus:border-violet-400 transition-shadow"><?php echo e(old('no_subscription_body_en', $settings->no_subscription_body_en)); ?></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="rounded-2xl border-2 border-indigo-200/60 p-5 sm:p-8 shadow-lg w-full"
            ...
            <div class="flex flex-col lg:flex-row lg:items-end gap-6">
                <div class="flex-1 min-w-0 space-y-2">
                    ...
                    <input type="text" name="catalog_web_path" value="<?php echo e(old('catalog_web_path', $settings->catalog_web_path)); ?>" required dir="ltr"
                           placeholder="/courses"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/mobile-app/edit.blade.php ENDPATH**/ ?>