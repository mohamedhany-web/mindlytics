...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="rounded-2xl bg-white border border-slate-200 shadow-sm p-5 sm:p-6 mb-6">
        <nav class="text-sm text-slate-500 mb-2">
            ...
            <span class="mx-2">/</span>
            <?php if(!empty($curriculumSectionId)): ?>
                ...
                <span class="mx-2">/</span>
            <?php endif; ?>
            <a href="<?php echo e(route('instructor.offline-courses.lectures.index', ['offlineCourse' => $offlineCourse, 'channel' => ($channel ?? 'offline')])); ?>" class="hover:text-amber-600 transition-colors">المحاضرات</a>
            <span class="mx-2">/</span>
    ...
    <div class="rounded-2xl bg-white border border-slate-200 shadow-sm p-6 sm:p-8">
        <form action="<?php echo e(route('instructor.offline-courses.lectures.store', ['offlineCourse' => $offlineCourse, 'channel' => ($channel ?? 'offline')])); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <?php if(!empty($curriculumSectionId)): ?>
                <input type="hidden" name="curriculum_section_id" value="<?php echo e($curriculumSectionId); ?>">
            <?php endif; ?>
            <div class="space-y-4">
                <div>
