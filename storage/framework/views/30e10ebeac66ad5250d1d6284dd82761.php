<?php $__env->startSection('title', (($channel ?? 'offline') === 'online' ? 'كورساتي الأونلاين' : __('instructor.my_offline_courses')) . ' - Mindlytics'); ?>
<?php $__env->startSection('header', (($channel ?? 'offline') === 'online' ? 'كورساتي الأونلاين' : __('instructor.my_offline_courses'))); ?>
        ...
        <form method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="flex items-end gap-2">
                ...
                <?php if(request()->anyFilled(['search', 'status'])): ?>
                    <a href="<?php echo e(route('instructor.offline-courses.index', ['channel' => ($channel ?? 'offline')])); ?>" class="px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl font-semibold transition-colors inline-flex items-center justify-center">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/instructor/offline-courses/index.blade.php ENDPATH**/ ?>