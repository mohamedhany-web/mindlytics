...
<?php $__env->startSection('title', 'إدارة الأماكن - الأوفلاين'); ?>
<?php $__env->startSection('header', 'إدارة الأماكن - الأوفلاين'); ?>
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
        <div class="flex justify-between items-center">
            ...
            <a href="<?php echo e(route('admin.offline-locations.create')); ?>" 
        ...
        <div class="mt-6 pt-6 border-t border-gray-200">
            <form method="GET" action="<?php echo e(route('admin.offline-locations.index')); ?>" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                ...
                <div class="flex items-end gap-2">
                    ...
                    <?php if(request()->hasAny(['search', 'status'])): ?>
                        <a href="<?php echo e(route('admin.offline-locations.index')); ?>" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg font-medium transition-colors">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 border border-gray-200">
                ...
                <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-blue-100/50">
                    <div class="flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-gray-900 truncate"><?php echo e($location->name); ?></h3>
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($location->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                            <?php echo e($location->is_active ? 'نشط' : 'غير نشط'); ?>
                ...
                <div class="px-6 py-4">
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center text-sm">
                            ...
                            <span class="text-gray-900 mr-2 font-medium"><?php echo e(Str::limit($location->address, 30)); ?></span>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex items-center text-sm">
                            ...
                            <span class="text-gray-900 mr-2 font-medium"><?php echo e($location->city); ?></span>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex items-center text-sm">
                            ...
                            <span class="text-gray-900 mr-2 font-medium"><?php echo e($location->phone); ?></span>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex items-center text-sm">
                            ...
                            <span class="text-gray-900 mr-2 font-medium"><?php echo e($location->capacity); ?> شخص</span>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex items-center justify-end gap-2">
                    <a href="<?php echo e(route('admin.offline-locations.show', $location)); ?>" 
                    ...
                    <a href="<?php echo e(route('admin.offline-locations.edit', $location)); ?>" 
                       class="px-3 py-1.5 bg-yellow-600 hover:bg-yellow-700 text-white text-sm rounded-lg font-medium transition-colors">
                        <i class="fas fa-edit mr-1"></i>تعديل
                    </a>
                    <form action="<?php echo e(route('admin.offline-locations.destroy', $location)); ?>" method="POST" class="inline" onsubmit="return confirm('هل أنت متأكد من الحذف؟');">
                        <?php echo csrf_field(); ?>
    ...
    <?php else: ?>
        <div class="bg-white rounded-xl shadow-lg p-12 text-center border border-gray-200">
            ...
            <a href="<?php echo e(route('admin.offline-locations.create')); ?>" class="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/offline-locations/index.blade.php ENDPATH**/ ?>