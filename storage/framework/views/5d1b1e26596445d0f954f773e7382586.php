                            ...
                            <div class="mb-6 space-y-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-xl font-black text-blue-600 text-left">
                                        <?php if($checkoutHasDiscount): ?>
                                            <span class="block text-sm text-gray-400 line-through font-semibold"><?php echo e(number_format($checkoutOriginal, 2)); ?> ج.م</span>
                                        <?php endif; ?>
                                        <span><?php echo e(number_format($checkoutFinal, 2)); ?></span>
                                ...
                                <?php if($checkoutHasDiscount): ?>
                                    <div class="flex items-center justify-between text-sm">
                                        ...
                                        <span class="font-bold text-rose-600">- <?php echo e(number_format($course->courseDiscountAmount(), 2)); ?> ج.م</span>
                                    </div>
                                <?php endif; ?>
                                <div class="flex items-center justify-between pt-4 border-t-2 border-gray-300">
                                    ...
                                    <span class="text-2xl font-black text-green-600">
                                        <?php echo e(number_format($checkoutFinal, 2)); ?> 
