...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <select name="billing_type" id="billing_type" required 
                        ...
                        <option value="course_percentage" <?php echo e(old('billing_type') == 'course_percentage' ? 'selected' : ''); ?>>نسبة من الكورس</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div id="billing_course_percentage_fields" class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6 billing-type-fields" style="display: none;">
                    <div>
                        ...
                        <select name="advanced_course_id" id="advanced_course_id" 
                            ...
                            <?php $__currentLoopData = $advancedCourses ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ac): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($ac->id); ?>" <?php echo e(old('advanced_course_id') == $ac->id ? 'selected' : ''); ?>><?php echo e($ac->title); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <div>
                        ...
                        <input type="number" name="course_percentage" id="course_percentage" value="<?php echo e(old('course_percentage')); ?>" min="0" max="100" step="0.01" 
                               class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/offline-agreements/create.blade.php ENDPATH**/ ?>