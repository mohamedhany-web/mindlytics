...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php echo $__env->make('admin.employees._weekly_off_day_field', ['employee' => $employee], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    ...
                    <div>
                        ...
                        <select name="work_schedule_id" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
                            ...
                            <?php $__currentLoopData = $workSchedules ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($schedule->id); ?>" <?php if((int) old('work_schedule_id', $employee->work_schedule_id) === (int) $schedule->id): echo 'selected'; endif; ?>>
                                    <?php echo e($schedule->name); ?> — <?php echo e($schedule->timeRangeLabel()); ?> (<?php echo e($schedule->required_hours); ?> س)
                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <?php $__errorArgs = ['work_schedule_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-red-500 text-xs mt-1"><?php echo e($message); ?></p><?php unset($message);
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mindly tics\Mindlytics\resources\views/admin/employees/edit.blade.php ENDPATH**/ ?>