                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="penalty_title"
                               value="<?php echo e(old('penalty_title', $s['penalty_title'] ?? $defaults['penalty_title'] ?? '')); ?>" required class="<?php echo e($penaltyInputClass); ?>">
                    </div>
                    <div class="sm:col-span-2">
        ...
        <div class="rounded-xl border border-rose-200 bg-rose-50/40 p-4 sm:p-5 space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="penalty_title" value="<?php echo e(old('penalty_title', $s['penalty_title'] ?? $defaults['penalty_title'] ?? '')); ?>" required class="<?php echo e($penaltyInputClass); ?>">
                </div>
                <div class="md:col-span-2">
