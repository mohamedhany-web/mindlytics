...
<?php $__env->startSection('title', 'إضافة مقال جديد - Mindlytics'); ?>
...
<div class="min-h-screen bg-gray-50">
    <div class="bg-white shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">إضافة مقال جديد</h1>
                    <p class="mt-2 text-gray-600">إنشاء مقال جديد للمدونة</p>
                </div>
                <div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form action="<?php echo e(route('admin.blog.store')); ?>" method="POST" enctype="multipart/form-data" class="bg-white shadow rounded-lg p-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="excerpt" rows="3"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md bg-white text-gray-900"><?php echo e(old('excerpt')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="content" id="content" rows="15" required
                              class="w-full px-3 py-2 border border-gray-300 rounded-md bg-white text-gray-900"><?php echo e(old('content')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="tags_input" value="<?php echo e(old('tags_input')); ?>"
                ...
                <div>
                    ...
                    <textarea name="meta_description" rows="2"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md bg-white text-gray-900"><?php echo e(old('meta_description')); ?></textarea>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/blog/create.blade.php ENDPATH**/ ?>