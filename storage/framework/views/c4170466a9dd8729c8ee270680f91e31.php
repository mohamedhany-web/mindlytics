            ...
            <form action="<?php echo e(route('admin.subscriptions.update', $subscription)); ?>" method="POST" class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="plan_name" value="<?php echo e(old('plan_name', $subscription->plan_name)); ?>" required
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input type="number" name="price" step="0.01" min="0" value="<?php echo e(old('price', $subscription->price)); ?>" required
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/subscriptions/edit.blade.php ENDPATH**/ ?>