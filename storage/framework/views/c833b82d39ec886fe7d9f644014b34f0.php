        ...
        window.__navNotifications = window.__navNotifications || function () {
            return {
                ...
                async refresh() {
                    try {
                        this.loading = true;
                        const res = await fetch(`<?php echo e(route('nav-notifications.recent')); ?>`, { headers: { 'Accept': 'application/json' } });
...
</html><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/layouts/app.blade.php ENDPATH**/ ?>