                ...
                <div class="px-6 py-4 flex-1">
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center text-sm text-gray-600">
                            ...
                            <span class="text-gray-900 font-medium"><?php echo e($course->academicYear->name ?? '—'); ?></span>
                        </div>
                        <div class="flex items-center text-sm text-gray-600">
                            <i class="fas fa-book text-gray-400 w-5 ml-2 flex-shrink-0"></i>
                            <span class="mr-1">المادة:</span>
                            <span class="text-gray-900 font-medium"><?php echo e($course->academicSubject->name ?? '—'); ?></span>
                        </div>
                        <div class="flex items-center text-sm text-gray-600">
                            <?php if($course->price): ?>
