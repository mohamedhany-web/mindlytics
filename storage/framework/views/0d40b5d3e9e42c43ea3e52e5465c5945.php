<div class="bg-white rounded-2xl border-2 border-gray-200 p-6 shadow-lg"
    ...
    <?php if(isset($pattern->pattern_data['project_description'])): ?>
        <div class="mb-6">
            <h4 class="font-bold text-[#1C2C39] mb-2">وصف المشروع</h4>
            <div class="bg-gray-50 rounded-xl p-4 whitespace-pre-wrap"><?php echo e($pattern->pattern_data['project_description']); ?></div>
        </div>
    <?php endif; ?>
    
    <?php if(isset($pattern->pattern_data['requirements'])): ?>
        <div class="mb-6">
            <h4 class="font-bold text-[#1C2C39] mb-2">المتطلبات</h4>
            <div class="bg-blue-50 border-r-4 border-blue-500 rounded-xl p-4">
                <?php if(is_array($pattern->pattern_data['requirements'])): ?>
                    <ul class="list-disc list-inside space-y-2">
                        <?php $__currentLoopData = $pattern->pattern_data['requirements']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $requirement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><?php echo e($requirement); ?></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                <?php else: ?>
                    <div class="whitespace-pre-wrap"><?php echo e($pattern->pattern_data['requirements']); ?></div>
                <?php endif; ?>
            </div>
        </div>
    <?php endif; ?>
...
<?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/student/learning-patterns/types/project_based.blade.php ENDPATH**/ ?>