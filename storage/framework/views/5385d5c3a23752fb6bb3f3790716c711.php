            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="course-video-card bg-gradient-to-br from-[#2CA9BD] via-[#65DBE4] to-[#2CA9BD] h-[320px] sm:h-[380px] md:h-[450px] flex items-center justify-center relative group overflow-hidden">
                    <?php if($advancedCourse->image): ?>
                        <img src="<?php echo e(asset('storage/' . $advancedCourse->image)); ?>" alt="<?php echo e($advancedCourse->localized('title')); ?>" 
                ...
                <div class="bg-white rounded-3xl shadow-2xl border-2 border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-3xl">
                    <div class="p-6 sm:p-8 lg:p-10">
                        ...
                        <nav class="text-sm text-gray-500 dark:text-gray-400 mb-6 flex items-center gap-2 flex-wrap">
                            ...
                            <?php endif; ?>
                            <span class="text-[#2CA9BD]">/</span>
                            <span class="text-[#1C2C39] font-bold"><?php echo e($advancedCourse->localized('title')); ?></span>
                        </nav>

                        <!-- عنوان الكورس -->
                        <h1 class="text-3xl sm:text-4xl lg:text-5xl font-black text-[#1C2C39] mb-4 leading-tight"><?php echo e($advancedCourse->localized('title')); ?></h1>
                    ...
                    <?php if(!$isEnrolled && (!$existingOrder || $existingOrder->status == 'rejected')): ?>
                        <div id="orderForm" class="hidden mt-6 pt-6 border-t-2 border-gray-100">
                            <form action="<?php echo e(route('courses.order', $advancedCourse)); ?>" method="POST" enctype="multipart/form-data" class="space-y-5">
                                ...
                                <!-- حقل كوبون الخصم -->
                                <?php if($advancedCourse->price && $advancedCourse->price > 0): ?>
                                <?php if(!empty($workshopPromoPreview)): ?>
                                <div class="mb-4 rounded-2xl p-4 border-2 border-violet-300 bg-violet-50">
                                    ...
                                    <p class="text-sm text-violet-800 mt-1">
                                        خصم <strong><?php echo e(number_format($workshopPromoPreview['discount_amount'], 2)); ?> ج.م</strong>
                                        — السعر بعد الخصم: <strong><?php echo e(number_format($workshopPromoPreview['final_amount'], 2)); ?> ج.م</strong>
                                    </p>
                                    <input type="hidden" name="applied_coupon_id" id="applied_coupon_id" value="<?php echo e($workshopPromoCoupon->id); ?>">
                                </div>
                                <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/student/courses/show.blade.php ENDPATH**/ ?>