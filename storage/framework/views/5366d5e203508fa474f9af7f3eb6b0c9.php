...
<body>
    <div class="box">
        ...
        <p>تم تعيين مهمة جديدة لك من قبل <strong><?php echo e($task->assigner->name ?? 'الإدارة'); ?></strong>.</p>

        <div class="card">
            <div class="label">نوع المهمة</div>
            <div class="value"><?php echo e(\App\Models\EmployeeTask::taskTypeLabel($task->task_type)); ?></div>
        </div>
        <div class="card">
...
<?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/emails/employee-task-assigned.blade.php ENDPATH**/ ?>