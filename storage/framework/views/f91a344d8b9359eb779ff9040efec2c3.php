        ...
        <div class="register-mobile-wrap">
            ...
            <div class="register-mobile-form-wrap">
                ...
                <div class="register-mobile-form-card">
                    <?php if(!empty($scholarshipProgram)): ?>
                        <div class="mb-3 rounded-xl border border-amber-200 bg-amber-50 px-3 py-2.5 text-amber-900">
                            <p class="text-xs font-bold">تسجيل في منحة: <?php echo e($scholarshipProgram->name); ?></p>
                            <p class="text-[11px] mt-1 opacity-80">بعد التسجيل ستنتظر تفعيل الأكاديمية لفتح الكورس.</p>
                        </div>
                    <?php endif; ?>
                    <form action="<?php echo e($registerFormAction ?? route('register')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="input-wrap">
                            ...
                            <input type="text" name="promo_code" id="promo_code_m" value="<?php echo e(old('promo_code', request('promo', request('code')))); ?>"
                                   class="form-input w-full font-mono uppercase <?php $__errorArgs = ['promo_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" placeholder="WS-XXXXXX">
        ...
        <div class="register-container">
            ...
            <div class="register-form-section">
                <div class="register-form-wrapper">
                    ...
                    <!-- Register Form -->
                    <form action="<?php echo e($registerFormAction ?? route('register')); ?>" method="POST" class="space-y-2.5 md:space-y-3">
                        <?php echo csrf_field(); ?>
                        
                        <!-- Student Notice -->
                        <?php if(!empty($scholarshipProgram)): ?>
                            <div class="bg-amber-50 border border-amber-200 rounded-xl p-3 mb-4">
                                <p class="text-sm font-bold text-amber-900">تسجيل في منحة: <?php echo e($scholarshipProgram->name); ?></p>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="referral_code" id="referral_code" value="<?php echo e($defaultRef); ?>"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="promo_code" id="promo_code" value="<?php echo e($defaultPromo); ?>"
                                   class="form-input w-full px-4 py-3 rounded-xl font-mono uppercase <?php $__errorArgs = ['promo_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
