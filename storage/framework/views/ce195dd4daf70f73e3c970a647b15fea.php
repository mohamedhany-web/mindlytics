                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" 
                            ...
                            <div class="p-2 space-y-1">
                                ...
                                <a href="<?php echo e(route('admin.accounting.reports.export', array_merge(request()->all(), ['type' => 'subscriptions']))); ?>" 
                                   class="flex items-center gap-2 px-4 py-2 text-sm text-slate-700 hover:bg-slate-100 rounded-lg">
                                    <i class="fas fa-calendar-check w-4"></i>
                                    الاشتراكات
                                </a>
                                <a href="<?php echo e(route('admin.accounting.reports.export', array_merge(request()->all(), ['type' => 'withdrawals']))); ?>" 
                                   class="flex items-center gap-2 px-4 py-2 text-sm text-slate-700 hover:bg-slate-100 rounded-lg">
                                    <i class="fas fa-hand-holding-usd w-4"></i>
                                    سحوبات المدربين
                                </a>
                                <a href="<?php echo e(route('admin.accounting.reports.export', array_merge(request()->all(), ['type' => 'installments']))); ?>" 
                                   class="flex items-center gap-2 px-4 py-2 text-sm text-slate-700 hover:bg-slate-100 rounded-lg">
                                    <i class="fas fa-handshake w-4"></i>
                                    اتفاقيات التقسيط
                                </a>
                                <a href="<?php echo e(route('admin.accounting.reports.export', array_merge(request()->all(), ['type' => 'offline_enrollments']))); ?>" 
                                   class="flex items-center gap-2 px-4 py-2 text-sm text-slate-700 hover:bg-slate-100 rounded-lg">
                                    <i class="fas fa-building w-4"></i>
                                    تسجيلات أوفلاين
                                </a>
                                <a href="<?php echo e(route('admin.accounting.reports.export', array_merge(request()->all(), ['type' => 'chart']))); ?>" 
                                   class="flex items-center gap-2 px-4 py-2 text-sm text-slate-700 hover:bg-slate-100 rounded-lg">
