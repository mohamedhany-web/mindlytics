<?php $__env->startSection('title', $activity->title . ' - نشاط'); ?>
    ...
    <header class="oc-chrome">
        <div>
            <nav class="oc-crumb" aria-label="مسار التنقل">
                ...
                <span aria-hidden="true">/</span>
                <span style="color:var(--ml-ink);font-weight:700">نشاط</span>
            </nav>
            <h1><?php echo e($activity->title); ?></h1>
            <p class="sub">نشاط <?php echo e($channelLabel); ?> · <?php echo e($offlineCourse->title); ?></p>
        </div>
        <div class="oc-signals">
            <span class="oc-signal oc-signal-hot"><?php echo e($maxScore); ?> نقطة</span>
        </div>
    </header>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <?php $__currentLoopData = $activity->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $att): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <a href="<?php echo e(stored_upload_file_url($att)); ?>" target="_blank" rel="noopener" class="inline-flex items-center gap-2 text-teal-700 hover:underline font-medium">
                        ...
                        <div>
                            ...
                            <ul class="space-y-2">
                                <?php $__currentLoopData = $submission->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <a href="<?php echo e(offline_activity_submission_file_url($f)); ?>" target="_blank" rel="noopener" download="<?php echo e($f['name'] ?? 'download'); ?>" class="inline-flex items-center gap-2 text-teal-700 hover:underline text-sm font-medium">
                ...
                <div class="border-t border-gray-100 pt-6">
                    ...
                    <form action="<?php echo e(route(($studentRouteGroup ?? 'student.offline-courses') . '.activities.submit', [$offlineCourse, $activity])); ?>" method="post" enctype="multipart/form-data" class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="submission_content" rows="5" class="w-full rounded-xl border border-gray-200 px-4 py-2.5 focus:ring-2 focus:ring-teal-500" placeholder="اكتب إجابتك أو وصف التقديم هنا..."><?php echo e(old('submission_content', $submission->submission_content ?? '')); ?></textarea>
...
<?php echo $__env->make('layouts.student-dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mindly tics\Mindlytics\resources\views\student\offline-courses\activity-show.blade.php ENDPATH**/ ?>