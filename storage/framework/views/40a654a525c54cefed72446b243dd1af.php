            ...
            <div class="xl:col-span-9 divide-y divide-slate-100">
                ...
                <div class="p-5 sm:p-6 space-y-4">
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        <form method="POST" action="<?php echo e(route('admin.workshops.send-acceptance', $workshop)); ?>" class="rounded-xl border border-slate-200 p-4 space-y-3 bg-slate-50/50">
                            <?php echo csrf_field(); ?>
                        ...
                        <form method="POST" action="<?php echo e(route('admin.workshops.send-whatsapp', $workshop)); ?>" class="rounded-xl border border-slate-200 p-4 space-y-3 bg-slate-50/50">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/workshops/show.blade.php ENDPATH**/ ?>