...
<div class="mb-4 <?php echo e($depth > 0 ? 'pr-2 border-r-2 border-slate-100' : ''); ?> <?php echo e($isSectionLocked ? 'opacity-80' : ''); ?>" style="<?php echo e($depth > 0 ? 'margin-right: ' . ($depth * 0.5) . 'rem;' : ''); ?>">
    ...
    <div class="curriculum-section-body"
         :class="{ 'is-collapsed': isSectionCollapsed(<?php echo e($section->id); ?>) }">
        <?php $__currentLoopData = $section->activeItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $curriculumItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="curriculum-item <?php echo e($isCompleted ? 'completed' : ''); ?> <?php echo e($isCurrent ? 'active' : ''); ?> <?php echo e($isLocked ? 'locked' : ''); ?>"
                 ...
                 <?php if($item instanceof \App\Models\CourseLesson): ?>
                     ...
                     data-item-locked="<?php echo e($isLocked ? '1' : '0'); ?>"
                     @click="currentSectionDescription = (window.learnSectionDescriptions || {})[$event.currentTarget.dataset.sectionId] || ''; if (($event.currentTarget.dataset.itemLocked || '0') === '1') return; selectedLesson = <?php echo e($item->id); ?>; loadLesson(<?php echo e($item->id); ?>); syncActivePanel('lesson', <?php echo e($item->id); ?>); mobileCurriculumOpen = false"
                 <?php elseif($item instanceof \App\Models\Lecture): ?>
                     data-item-type="lecture"
                     data-item-id="<?php echo e($item->id); ?>"
                     data-item-locked="<?php echo e($isLocked ? '1' : '0'); ?>"
                     @click="currentSectionDescription = (window.learnSectionDescriptions || {})[$event.currentTarget.dataset.sectionId] || ''; if (($event.currentTarget.dataset.itemLocked || '0') === '1') return; loadLecture(<?php echo e($item->id); ?>); mobileCurriculumOpen = false"
                 <?php elseif($item instanceof \App\Models\Assignment): ?>
                     data-item-type="assignment"
                     data-item-id="<?php echo e($item->id); ?>"
                     data-item-locked="0"
                     @click="currentSectionDescription = (window.learnSectionDescriptions || {})[$event.currentTarget.dataset.sectionId] || ''; loadAssignment(<?php echo e($item->id); ?>); syncActivePanel('assignment', <?php echo e($item->id); ?>); mobileCurriculumOpen = false"
                 <?php elseif($item instanceof \App\Models\AdvancedExam || $item instanceof \App\Models\Exam): ?>
                     data-item-type="exam"
                     data-item-id="<?php echo e($item->id); ?>"
                     data-item-locked="0"
                     @click="currentSectionDescription = (window.learnSectionDescriptions || {})[$event.currentTarget.dataset.sectionId] || ''; loadExam(<?php echo e($item->id); ?>); syncActivePanel('exam', <?php echo e($item->id); ?>); mobileCurriculumOpen = false"
                 <?php elseif($item instanceof \App\Models\LearningPattern): ?>
                     data-item-type="pattern"
                     data-item-id="<?php echo e($item->id); ?>"
                     data-item-locked="<?php echo e($isLocked ? '1' : '0'); ?>"
                     @click="currentSectionDescription = (window.learnSectionDescriptions || {})[$event.currentTarget.dataset.sectionId] || ''; if (($event.currentTarget.dataset.itemLocked || '0') === '1') return; loadPattern(<?php echo e($item->id); ?>); syncActivePanel('pattern', <?php echo e($item->id); ?>); mobileCurriculumOpen = false"
                 <?php endif; ?>>
...
<?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/student/my-courses/partials/learn-sidebar-section.blade.php ENDPATH**/ ?>