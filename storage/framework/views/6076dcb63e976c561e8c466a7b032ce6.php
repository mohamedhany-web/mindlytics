    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div class="stat-card p-5 text-center">
                <div class="text-3xl font-black text-blue-600 mb-1 tabular-nums"><?php echo e($jobs->count()); ?></div>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-2 gap-6 lg:gap-8">
            <?php $__empty_1 = true; $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a href="<?php echo e(route('careers.show', $job)); ?>" class="job-card p-6 group">
                    <div class="flex items-start justify-between gap-4 mb-4">
                        <div class="min-w-0 flex-1">
                            ...
                            <?php if($job->employment_type): ?>
                                <p class="text-xs font-bold text-sky-600 mt-1"><?php echo e($job->employment_type); ?></p>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="flex flex-wrap gap-2 mb-4">
                        <?php if($job->department): ?>
                            <span class="job-meta-chip blue"><i class="fas fa-building text-[10px]"></i><?php echo e($job->department); ?></span>
                        <?php endif; ?>
                        <?php if($job->location): ?>
                            <span class="job-meta-chip green"><i class="fas fa-map-marker-alt text-[10px]"></i><?php echo e($job->location); ?></span>
                        <?php endif; ?>
                    </div>

                    <?php if($job->description): ?>
                        <p class="text-sm text-slate-600 leading-relaxed line-clamp-3 flex-1">
                            <?php echo e(\Illuminate\Support\Str::limit(strip_tags((string) $job->description), 180)); ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/careers/index.blade.php ENDPATH**/ ?>