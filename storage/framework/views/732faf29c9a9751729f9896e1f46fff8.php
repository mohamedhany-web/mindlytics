                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                    ...
                    <div class="p-6 space-y-5">
                        <div>
                            ...
                            <p class="mt-1.5 text-xs text-slate-500">الحد الأقصى 100 MB. الامتدادات: xlsx, xls, csv. إن رفعت ملفاً سيُعرض للطالب كجدول مع اسكرول.</p>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/community/datasets/create.blade.php ENDPATH**/ ?>