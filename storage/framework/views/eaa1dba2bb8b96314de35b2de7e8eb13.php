    ...
    <header class="oc-chrome">
        <div>
            <nav class="oc-crumb" aria-label="مسار التنقل">
                ...
                <span aria-hidden="true">/</span>
                <span style="color:var(--ml-ink);font-weight:700">المنهج</span>
            </nav>
            <h1>منهج الكورس</h1>
        ...
        <div class="oc-signals">
            ...
            <span class="oc-signal"><?php echo e($stats['sections']); ?> أقسام</span>
            <span class="oc-signal oc-signal-hot"><?php echo e($stats['items']); ?> عناصر</span>
        </div>
    </header>

    <section class="oc-stage" aria-label="ملخص المنهج">
        <div class="oc-eyebrow">التوصيف وهيكل المحتوى <em><?php echo e($channelLabel); ?></em></div>
        <h2><?php echo e($offlineCourse->title); ?></h2>
        <p class="oc-copy">
            <?php if($enrollment->group): ?>
                مجموعتك: <?php echo e($enrollment->group->name); ?> —
            <?php endif; ?>
            استعرض الوصف ثم انتقل لعناصر المنهج بالترتيب.
        </p>
        <div class="oc-nav" style="margin-top:14px">
            <a class="oc-btn" href="<?php echo e(route($sg . '.lectures', $offlineCourse)); ?>"><i class="fas fa-chalkboard-teacher text-xs"></i> المحاضرات</a>
            <a class="oc-btn oc-btn-quiet" href="<?php echo e(route($sg . '.schedule', $offlineCourse)); ?>"><i class="fas fa-calendar-alt text-xs"></i> التقويم</a>
            <a class="oc-btn oc-btn-quiet" href="<?php echo e(route($sg . '.show', $offlineCourse)); ?>">صفحة الكورس</a>
        </div>
    </section>

    <div class="oc-pulse" aria-label="إحصائيات المنهج">
        <div>
            <span class="lbl">أقسام المنهج</span>
            <span class="val teal"><?php echo e($stats['sections']); ?></span>
        </div>
        <div>
            <span class="lbl">عناصر مرتبطة</span>
            <span class="val"><?php echo e($stats['items']); ?></span>
        </div>
        <div>
            <span class="lbl">القناة</span>
        ...
        <div class="oc-cur-main">
            <?php if(filled($offlineCourse->description)): ?>
                <section class="oc-panel" aria-labelledby="course-desc-heading">
                    <p class="oc-label" id="course-desc-heading">وصف الكورس</p>
            ...
            <?php if(filled($offlineCourse->notes)): ?>
                <section class="oc-panel" aria-labelledby="course-notes-heading">
                    <p class="oc-label" id="course-notes-heading">ملاحظات إضافية</p>
                    <div class="oc-note"><?php echo e($offlineCourse->notes); ?></div>
                </section>
            <?php endif; ?>

            <section aria-labelledby="curriculum-structure-heading">
                <p class="oc-section-title" id="curriculum-structure-heading">هيكل المنهج</p>
                ...
                <?php else: ?>
                    <div class="oc-empty">
                        ...
                        <h3>لا يوجد منهج منشور</h3>
                        <p>سيظهر هيكل الأقسام والعناصر هنا بعد نشره من الإدارة.</p>
                    </div>
                <?php endif; ?>
            </section>
        </div>
        ...
        <aside class="oc-cur-aside">
            <div class="oc-panel oc-cur-aside-sticky">
                ...
                <div class="oc-instructor">
                    ...
                    <?php else: ?>
                        <div class="av" aria-hidden="true"><?php echo e(mb_substr($offlineCourse->instructor->name ?? 'م', 0, 1)); ?></div>
                    <?php endif; ?>
                    ...
                    <?php else: ?>
                        <p>لم يُضف نبذة تعريفية بعد.</p>
                    <?php endif; ?>
                </div>
            </div>

            <div class="oc-panel oc-quick">
                <p class="oc-label">انتقال سريع</p>
                <div style="display:flex;flex-direction:column;gap:8px">
                    <a href="<?php echo e(route($sg . '.resources', $offlineCourse)); ?>">
                        <span><i class="fas fa-file-alt lead"></i> الموارد</span>
                        <i class="fas fa-chevron-left chev"></i>
                    </a>
                    <a href="<?php echo e(route($sg . '.lectures', $offlineCourse)); ?>">
                        <span><i class="fas fa-chalkboard-teacher lead"></i> المحاضرات</span>
                        <i class="fas fa-chevron-left chev"></i>
                    </a>
                    <a href="<?php echo e(route($sg . '.schedule', $offlineCourse)); ?>">
                        <span><i class="fas fa-calendar-alt lead"></i> التقويم</span>
                        <i class="fas fa-chevron-left chev"></i>
                    </a>
                    <a href="<?php echo e(route('student.exams.index')); ?>">
                        <span><i class="fas fa-clipboard-check lead"></i> الاختبارات</span>
                        <i class="fas fa-chevron-left chev"></i>
                    </a>
                </div>
            </div>
