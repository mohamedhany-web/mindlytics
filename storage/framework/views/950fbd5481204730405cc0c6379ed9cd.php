<?php $__env->startSection('title', 'طلب تصميم جديد'); ?>
<?php $__env->startSection('header', 'طلب تصميم جديد'); ?>
...
<div class="w-full max-w-none space-y-6">
    ...
    <div class="relative overflow-hidden rounded-2xl border border-fuchsia-200/60 bg-gradient-to-br from-fuchsia-600 via-violet-600 to-indigo-700 p-6 sm:p-8 text-white shadow-xl">
        ...
        <div class="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div class="flex items-start gap-4">
                ...
                <div>
                    <a href="<?php echo e(route('employee.design-cycles.index')); ?>" class="inline-flex items-center gap-2 text-sm font-semibold text-white/90 hover:text-white mb-2 transition-colors">
    ...
    <form method="post" action="<?php echo e(route('employee.design-cycles.store')); ?>" class="w-full">
        <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <p class="mt-1.5 text-xs font-semibold text-red-600"><?php echo e($message); ?></p>
                            <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3" placeholder="سطر أو اثنان لسياق الطلب..."
                                      class="w-full rounded-xl border border-gray-200 py-3 px-4 text-sm text-gray-900 placeholder:text-gray-400 shadow-sm transition focus:border-fuchsia-500 focus:outline-none focus:ring-2 focus:ring-fuchsia-500/30 resize-y min-h-[5rem]"><?php echo e(old('description')); ?></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="specifications" name="specifications" rows="16" required
                                      ...
                                      class="w-full rounded-xl border border-gray-200 py-4 px-4 text-sm text-gray-900 placeholder:text-gray-400 shadow-sm transition focus:border-fuchsia-500 focus:outline-none focus:ring-2 focus:ring-fuchsia-500/30 resize-y min-h-[20rem] leading-relaxed"><?php echo e(old('specifications')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="xl:hidden">
                    <button type="submit"
                            ...
                            <?php echo e($designers->isEmpty() ? 'disabled' : ''); ?>>
                                ...
                                <div class="relative">
                                    ...
                                    <select id="designer_employee_id" name="designer_employee_id" required
                                        ...
                                        <?php $__currentLoopData = $designers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($d->id); ?>" <?php if(old('designer_employee_id') == $d->id): echo 'selected'; endif; ?>>
                                                <?php echo e($d->name); ?><?php if($d->employeeJob): ?> — <?php echo e($d->employeeJob->name); ?><?php endif; ?>
                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <?php $__errorArgs = ['designer_employee_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="datetime-local" id="deadline_at" name="deadline_at" value="<?php echo e(old('deadline_at')); ?>" required
                                       class="w-full rounded-xl border border-gray-200 bg-gray-50/50 py-3 px-4 text-sm font-medium text-gray-900 shadow-sm transition focus:border-fuchsia-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-fuchsia-500/30">
...
<?php echo $__env->make('layouts.employee', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/employee/design-cycles/create.blade.php ENDPATH**/ ?>