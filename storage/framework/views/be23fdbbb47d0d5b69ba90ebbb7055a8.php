...
<?php $__env->startSection('title', 'كورسات أوفلاين — الفرع'); ?>
<?php $__env->startSection('header', 'كورسات أوفلاين — ' . $branch->name); ?>
...
<div class="p-6 lg:p-8 max-w-[1400px] mx-auto space-y-6">
    <form method="GET" class="flex flex-wrap gap-3 items-end">
        <div>
            ...
            <input type="text" name="q" value="<?php echo e(request('q')); ?>" placeholder="عنوان الدورة"
                ...
                <tbody class="divide-y divide-slate-100">
                    <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="px-4 py-3 font-medium"><?php echo e($c->title); ?></td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/branch-office/courses-offline.blade.php ENDPATH**/ ?>