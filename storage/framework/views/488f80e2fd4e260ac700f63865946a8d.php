...
<?php $__env->startSection('title', 'حساب التحويل - Mindlytics'); ?>
<?php $__env->startSection('header', 'حساب التحويل'); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="notes" id="notes" rows="2" class="w-full px-4 py-2.5 border border-slate-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                          placeholder="أي تفاصيل إضافية للتحويل"><?php echo e(old('notes', $detail->notes)); ?></textarea>
