...
<?php $__env->startSection('title', 'تقارير المبيعات (Excel)'); ?>
<?php $__env->startSection('header', 'تقارير المبيعات'); ?>
...
<div class="space-y-6">
    <div class="flex flex-wrap items-start justify-between gap-3">
        <div class="space-y-1">
            ...
            <a href="<?php echo e(route('employee.sales.leads.index')); ?>" class="text-sm text-emerald-700 font-semibold hover:underline">← العملاء المحتملون</a>
        </div>
    </div>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white shadow-sm p-5 md:p-6">
        <form method="get" action="<?php echo e(route('employee.sales.reports.index')); ?>" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
            <div>
            ...
            <div class="flex flex-wrap gap-2 md:col-span-2 lg:col-span-2">
                ...
                <a href="<?php echo e(route('employee.sales.reports.export', request()->query())); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-l from-emerald-600 to-teal-600 text-white rounded-xl text-sm font-bold shadow-lg border border-emerald-400/40">
    ...
    <?php if($start && $end && !$error): ?>
        <div class="rounded-2xl border border-emerald-200 bg-gradient-to-br from-emerald-50 to-white p-5 shadow-sm">
            ...
            <div class="mt-3 text-xs text-gray-600">
                Leads محولة/منشأة من الإدارة ومُسندة إليك (داخل الفترة): <span class="font-bold"><?php echo e($counts['leads_assigned_to_me_created_by_admin'] ?? 0); ?></span>
            </div>
...
<?php echo $__env->make('layouts.employee', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/employee/sales/reports/index.blade.php ENDPATH**/ ?>