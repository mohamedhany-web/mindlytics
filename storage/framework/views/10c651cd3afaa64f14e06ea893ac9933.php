...
<?php $__env->startSection('title', 'خطة الفروع والتوسع'); ?>

<?php $__env->startSection('content'); ?>
<div class="p-6 lg:p-8 max-w-4xl mx-auto">
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <a href="<?php echo e(route('admin.branches.index')); ?>" class="text-sm text-blue-600 hover:underline">← فروع المنصة</a>
    ...
    <article class="rollout-markdown max-w-none bg-white rounded-2xl border border-slate-200 p-6 lg:p-8 text-slate-800 leading-relaxed space-y-4
        ...
        <?php echo $rolloutHtml; ?>

    </article>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/all Mindlytics Project/Mindlytics/resources/views/admin/branches/rollout-plan.blade.php ENDPATH**/ ?>