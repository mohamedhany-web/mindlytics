        ...
        return [
            [
                ...
                'items' => [
                    ...
                    ['label' => 'التحليل المالي الشامل', 'route' => 'admin.accounting.financial-analysis', 'icon' => 'fa-chart-line', 'hint' => 'قائمة دخل، مركز مالي، نسب، تحليل أفقي ورأسي'],
                    ['label' => 'المديونية والذمم', 'route' => 'admin.accounting.receivables', 'icon' => 'fa-hand-holding-usd', 'hint' => 'ذمم مدينة، مستحقات، رأس مال المؤسسين'],
