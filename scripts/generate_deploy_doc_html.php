<?php
/**
 * Generate deployment guide as HTML (English, formatted).
 * Open in Microsoft Word and Save As → Word (.docx) to get a Word document.
 *
 * Run: php scripts/generate_deploy_doc_html.php
 */

$outputDir = dirname(__DIR__);
$outputFile = $outputDir . '/Mindlytics_Deploy_Guide.html';
...
if (file_put_contents($outputFile, $html) !== false) {
    ...
    echo "Open in Word and use File → Save As → Word (.docx) if you need a .docx file.\n";
} else {
