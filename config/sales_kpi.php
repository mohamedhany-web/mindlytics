 ...
 *
 * القمع اليومي للمحاسبة (بدون اجتماعات — حسب طلب الإدارة):
 * 50 محاولة → 20 رد → 8 مؤهل → 2 عرض → 1 تسجيل مدفوع.
 *
...
return [
    ...
    'rationale' => [
        'title' => 'أساس المحاسبة اليومية (بدون اجتماعات)',
        'points' => [
            'المحاسبة اليومية على قمع CRM الموثّق فقط: محاولات اتصال → رد → مؤهل → عرض سعر → تسجيل مدفوع.',
            'الاجتماعات/الجلسات غير مطلوبة للمحاسبة (الهدف = 0 ولا تدخل في الخصم).',
            '50 محاولة/يوم ≈ 5–6 مكالمات في الساعة خلال شيفت فعّال.',
